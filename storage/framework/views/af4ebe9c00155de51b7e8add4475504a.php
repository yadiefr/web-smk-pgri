            ...
            <nav class="flex mt-4 sm:mt-0" aria-label="Breadcrumb">
                <ol class="flex items-center space-x-4">
                    ...
                    <li class="flex items-center">
                        ...
                        <a href="<?php echo e(route('admin.jadwal.index')); ?>" class="text-sm font-medium text-gray-500 hover:text-gray-700">Jadwal</a>
                    </li>
                    <li class="flex items-center">
                        <i class="fas fa-chevron-right text-gray-300 mr-4"></i>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <input type="text" id="filter_tahun" value="<?php echo e($tahun_ajaran_aktif ?? ''); ?>" 
            ...
            <div class="p-6">
                <div class="overflow-x-auto">
                    <table class="min-w-full border border-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200" id="scheduleBody<?php echo e($hari); ?>">
...
<?php echo $__env->make('admin.jadwal._modal_jadwal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                ...
                if (success) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = "<?php echo e(route('admin.settings.jadwal.index')); ?>";
                        }
                    });
                }
            });
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\admin\jadwal\create-table.blade.php ENDPATH**/ ?>