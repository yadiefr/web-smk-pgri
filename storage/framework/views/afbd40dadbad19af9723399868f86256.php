        ...
        <div class="bg-white rounded-lg shadow-sm">
            ...
            <div class="p-3 sm:p-6">
                <div class="grid grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3">
                    ...
                    <a href="<?php echo e(route('guru.wali-kelas.keterlambatan.index')); ?>" class="flex flex-col items-center justify-center p-2 sm:p-4 bg-red-50 hover:bg-red-100 rounded-lg border border-red-200 text-red-700 hover:text-red-800 transition-colors">
