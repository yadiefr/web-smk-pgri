...
<?php $__env->startSection('title', 'Jadwal Per Guru'); ?>
...
<div class="w-full px-3 py-4">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <form action="<?php echo e(route('admin.jadwal.by-teacher')); ?>" method="GET" class="max-w-xl">
                ...
                <div class="flex-1">
                    ...
                    <select name="guru" id="guru_id" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <?php $__currentLoopData = $guru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($g->id); ?>" <?php echo e($selectedGuru && $selectedGuru->id == $g->id ? 'selected' : ''); ?>>
                                <?php echo e($g->nama); ?> <?php echo e($g->nip ? '(' . $g->nip . ')' : ''); ?>
                ...
                <div class="flex justify-between items-center">
                    <div>
                        <h2 class="text-lg font-bold text-gray-800">
                            Jadwal Mengajar <?php echo e($selectedGuru->nama); ?>

                        </h2>
                        <?php if($selectedGuru->nip): ?>
                            <p class="text-sm text-gray-600 mt-1">NIP: <?php echo e($selectedGuru->nip); ?></p>
                        <?php endif; ?>
                    </div>
                    <div>
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800">
                            Total: <?php echo e($jadwal->count()); ?> Jadwal
                        </span>
                    </div>
                </div>
            </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $jadwal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <?php if($j->kelas->jurusan): ?>
                                        <div class="text-xs text-gray-500"><?php echo e($j->kelas->jurusan->nama_jurusan); ?></div>
                                    <?php endif; ?>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="text-sm font-medium text-gray-900">
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-4 text-center text-gray-500">
                                    <div class="flex flex-col items-center justify-center py-8">
                                        ...
                                        <a href="<?php echo e(route('admin.jadwal.create', ['guru_id' => $selectedGuru->id])); ?>" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\admin\jadwal\by-teacher.blade.php ENDPATH**/ ?>