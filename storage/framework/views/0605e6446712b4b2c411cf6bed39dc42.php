...
<?php $__env->startSection('title', 'Tambah Pelanggaran Siswa'); ?>
...
<div class="space-y-6">
    ...
    <!-- Form -->
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form action="<?php echo e(route('kesiswaan.pelanggaran.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
            <?php echo csrf_field(); ?>
                            ...
                            <div class="flex flex-col sm:flex-row gap-3">
                                ...
                                <div class="w-full sm:w-48">
                                    <select id="filter_kelas" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 text-sm">
                                        ...
                                        ?>
                                        <?php $__currentLoopData = $uniqueKelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $namaKelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($namaKelas); ?>"><?php echo e($namaKelas); ?></option>
                        ...
                        <div id="siswa-container" class="border border-gray-300 rounded-lg bg-white max-h-80 overflow-y-auto">
                            ...
                            <div id="siswa-list">
                                <?php if($siswa && $siswa->count() > 0): ?>
                                    ...
                                    <?php $__currentLoopData = $siswaGrouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $namaKelas => $siswaList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <!-- Header Kelas -->
                                        <div class="siswa-kelas-header px-3 py-2 bg-gray-100 border-b border-gray-200" data-kelas="<?php echo e($namaKelas); ?>">
                                            <div class="flex items-center justify-between">
                                                <h4 class="text-sm font-semibold text-gray-700"><?php echo e($namaKelas); ?></h4>
                                                <span class="text-xs text-gray-500"><?php echo e($siswaList->count()); ?> siswa</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex items-center p-3 border-b border-gray-100 hover:bg-red-50 transition-colors cursor-pointer siswa-item" 
                                             ...
                                             data-siswa-name="<?php echo e($s->nama_lengkap); ?>"
                                             data-siswa-nis="<?php echo e($s->nis); ?>"
                                             data-siswa-kelas="<?php echo e(optional($s->kelas)->nama_kelas ?? ''); ?>"
                                             data-siswa-kelas-sort="<?php echo e(optional($s->kelas)->nama_kelas ?? 'ZZZ'); ?>">
                                            <div class="flex-1 min-w-0">
                                                <div class="flex items-center justify-between">
                                                    <div class="flex-1 min-w-0">
                                                        <div class="text-sm font-medium text-gray-900 truncate"><?php echo e($s->nama_lengkap); ?></div>
                                                    ...
                                                    <div class="ml-3 flex-shrink-0">
                                                        <button type="button" class="select-btn px-3 py-1 text-xs font-medium rounded-full transition-colors bg-red-100 text-red-700 hover:bg-red-200" 
                                                                data-siswa-id="<?php echo e($s->id); ?>"
                                                                data-siswa-nama="<?php echo e($s->nama_lengkap); ?>"
                                                                data-siswa-nis="<?php echo e($s->nis); ?>"
                                                                data-siswa-kelas="<?php echo e(optional($s->kelas)->nama_kelas ?? ''); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <select name="jenis_pelanggaran_id" id="jenis_pelanggaran_id" required
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 <?php $__errorArgs = ['jenis_pelanggaran_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                                ...
                                <optgroup label="<?php echo e(ucfirst($kategori)); ?>">
                                    <?php $__currentLoopData = $jenisGroup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($jenis->id); ?>" 
                                                ...
                                                <?php echo e(old('jenis_pelanggaran_id') == $jenis->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_pelanggaran" id="tanggal_pelanggaran" 
                               value="<?php echo e(old('tanggal_pelanggaran', date('Y-m-d'))); ?>" required
                               max="<?php echo e(date('Y-m-d')); ?>"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 <?php $__errorArgs = ['tanggal_pelanggaran'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="time" name="jam_pelanggaran" id="jam_pelanggaran" 
                               value="<?php echo e(old('jam_pelanggaran')); ?>"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 <?php $__errorArgs = ['jam_pelanggaran'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text"
                                   ...
                                   value="<?php echo e(old('guru_id') ? ($guru->firstWhere('id', old('guru_id'))->nama ?? '') : ''); ?>"
                                   onkeyup="searchGuru(this.value)"
                                   onfocus="showAllGuru()">

                            
                            <input type="hidden" name="guru_id" id="guru_id" value="<?php echo e(old('guru_id')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="tingkat_urgensi" id="tingkat_urgensi" required
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 <?php $__errorArgs = ['tingkat_urgensi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="rendah" <?php echo e(old('tingkat_urgensi') == 'rendah' ? 'selected' : ''); ?>>Rendah</option>
                            <option value="sedang" <?php echo e(old('tingkat_urgensi') == 'sedang' ? 'selected' : ''); ?>>Sedang</option>
                            <option value="tinggi" <?php echo e(old('tingkat_urgensi') == 'tinggi' ? 'selected' : ''); ?>>Tinggi</option>
                            <option value="sangat_tinggi" <?php echo e(old('tingkat_urgensi') == 'sangat_tinggi' ? 'selected' : ''); ?>>Sangat Tinggi</option>
                        </select>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi_kejadian" id="deskripsi_kejadian" rows="4" required
                                  ...
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 resize-none <?php $__errorArgs = ['deskripsi_kejadian'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('deskripsi_kejadian')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="file" name="bukti_foto" id="bukti_foto" 
                               ...
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 <?php $__errorArgs = ['bukti_foto'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="sanksi_diberikan" id="sanksi_diberikan" rows="3" required
                                  ...
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 resize-none <?php $__errorArgs = ['sanksi_diberikan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('sanksi_diberikan')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_selesai_sanksi" id="tanggal_selesai_sanksi" 
                               value="<?php echo e(old('tanggal_selesai_sanksi')); ?>"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 <?php $__errorArgs = ['tanggal_selesai_sanksi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="catatan_tambahan" id="catatan_tambahan" rows="3"
                                  ...
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 resize-none <?php $__errorArgs = ['catatan_tambahan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('catatan_tambahan')); ?></textarea>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="sudah_dihubungi_ortu" id="sudah_dihubungi_ortu" value="1"
                               <?php echo e(old('sudah_dihubungi_ortu') ? 'checked' : ''); ?>
                    ...
                    <div id="respon_ortu_container" style="display: none;">
                        ...
                        <textarea name="respon_ortu" id="respon_ortu" rows="3"
                                  ...
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 resize-none <?php $__errorArgs = ['respon_ortu'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('respon_ortu')); ?></textarea>
...
// Fungsi untuk toggle select siswa berdasarkan ID (multiple selection) - Defined at top for accessibility
window.toggleSelectSiswaById = function(button) {
...
// Fungsi untuk toggle select siswa (backward compatibility)
function toggleSelectSiswa(studentData, button) {
    // Redirect ke fungsi baru
    toggleSelectSiswaById(button);
}
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.kesiswaan', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\kesiswaan\pelanggaran\create.blade.php ENDPATH**/ ?>