...
<?php $__env->startSection('title', 'Edit Jadwal Ujian'); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div class="lg:col-span-4">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                ...
                <form action="<?php echo e(route('admin.ujian.jadwal.update', $jadwal->id)); ?>" method="POST" class="p-6">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="text" name="nama_ujian" required
                                   value="<?php echo e(old('nama_ujian', $jadwal->nama_ujian)); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="jenis_ujian" required
                                ...
                                <option value="uts" <?php echo e(old('jenis_ujian', $jadwal->jenis_ujian) == 'uts' ? 'selected' : ''); ?>>Ujian Tengah Semester</option>
                                <option value="uas" <?php echo e(old('jenis_ujian', $jadwal->jenis_ujian) == 'uas' ? 'selected' : ''); ?>>Ujian Akhir Semester</option>
                                <option value="quiz" <?php echo e(old('jenis_ujian', $jadwal->jenis_ujian) == 'quiz' ? 'selected' : ''); ?>>Quiz/Kuis</option>
                                <option value="tugas" <?php echo e(old('jenis_ujian', $jadwal->jenis_ujian) == 'tugas' ? 'selected' : ''); ?>>Tugas</option>
                                <option value="praktek" <?php echo e(old('jenis_ujian', $jadwal->jenis_ujian) == 'praktek' ? 'selected' : ''); ?>>Ujian Praktek</option>
                            </select>
                        ...
                        <div>
                            ...
                            <select name="kelas_id" required
                                ...
                                <?php $__currentLoopData = $kelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelasItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($kelasItem->id); ?>" <?php echo e(old('kelas_id', $jadwal->kelas_id) == $kelasItem->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" name="durasi" required min="1" max="480"
                                       value="<?php echo e($jadwal->durasi); ?>"
                                       class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                       placeholder="60">
                    ...
                    <div class="border-t border-gray-200 pt-6 mb-6">
                        ...
                        <div>
                            ...
                            <select name="status" required
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option value="draft" <?php echo e($jadwal->status == 'draft' ? 'selected' : ''); ?>>Draft</option>
                                <option value="scheduled" <?php echo e($jadwal->status == 'scheduled' ? 'selected' : ''); ?>>Terjadwal</option>
                                <option value="active" <?php echo e($jadwal->status == 'active' ? 'selected' : ''); ?>>Aktif</option>
                                <option value="completed" <?php echo e($jadwal->status == 'completed' ? 'selected' : ''); ?>>Selesai</option>
                                <option value="cancelled" <?php echo e($jadwal->status == 'cancelled' ? 'selected' : ''); ?>>Dibatalkan</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="border-t border-gray-200 pt-6 mb-6">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center">
                                <input type="checkbox" name="acak_soal" id="acak_soal" value="1" <?php echo e($jadwal->acak_soal ? 'checked' : ''); ?>
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" name="acak_jawaban" id="acak_jawaban" value="1" <?php echo e($jadwal->acak_jawaban ? 'checked' : ''); ?>
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" name="tampilkan_hasil" id="tampilkan_hasil" value="1" <?php echo e($jadwal->tampilkan_hasil ? 'checked' : ''); ?>
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" rows="4"
                                  class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                  placeholder="Tambahkan catatan atau instruksi khusus untuk ujian ini..."><?php echo e($jadwal->deskripsi); ?></textarea>
...
<?php echo $__env->make('layouts.ujian', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\admin\ujian\jadwal\edit.blade.php ENDPATH**/ ?>