...
<body>
    <table border="0" cellpadding="0" cellspacing="0" class="gridlines sheet0">
        ...
        <tr>
            <td colspan="4" class="subtitle" style="text-align: center; padding: 10px 0;">TAHUN AJARAN <?php echo e(date('Y')); ?>-<?php echo e(date('Y') + 1); ?></td>
        </tr>
        <tr>
            <td colspan="4">&nbsp;</td>
        </tr>
        ...
        <tr>
            <td>&nbsp;</td>
            <td class="info-label" colspan="3" style="text-align: left; padding: 4px;">PERIODE : <?php echo e(\Carbon\Carbon::parse($tanggalMulai)->locale('id')->translatedFormat('d F Y')); ?> s/d <?php echo e(\Carbon\Carbon::parse($tanggalAkhir)->locale('id')->translatedFormat('d F Y')); ?></td>
        </tr>
        <tr>
            <td colspan="4">&nbsp;</td>
        </tr>
        
        <?php if($summaryData->count() > 0): ?>
        <!-- Table Header -->
        ...
        <!-- Table Data -->
        <?php $__currentLoopData = $summaryData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            ...
            <td class="table-data-left" style="width: 250px; text-align: left; vertical-align: middle; border: 1px solid #000000 !important; padding: 4px; padding-left: 8px;"><?php echo e($data->siswa->nama_lengkap); ?></td>
            ...
            <td class="table-data-center" style="width: 150px; text-align: center; vertical-align: middle; border: 1px solid #000000 !important; padding: 4px; font-weight: bold;"><?php echo e($data->total_terlambat); ?> KALI</td>
        </tr>
        ...
        <tr>
            <td>&nbsp;</td>
            <td class="footer-text" colspan="3" style="text-align: left; padding: 4px;">KETERANGAN : Data keterlambatan periode <?php echo e(\Carbon\Carbon::parse($tanggalMulai)->locale('id')->translatedFormat('d F Y')); ?> - <?php echo e(\Carbon\Carbon::parse($tanggalAkhir)->locale('id')->translatedFormat('d F Y')); ?></td>
        </tr>
        <tr>
            <td colspan="4">&nbsp;</td>
        </tr>
...
</html><?php /**PATH C:\wamp64\www\website-smk3\resources\views\kesiswaan\keterlambatan\export-summary.blade.php ENDPATH**/ ?>