...
<?php $__env->startSection('title', 'Rekap Keterlambatan Siswa - ' . $kelas->nama_kelas); ?>
...
<div class="p-6">
    ...
    <div class="mb-6">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                ...
                <p class="text-gray-600 mt-1">Rekap data keterlambatan siswa dengan export Excel - Kelas <?php echo e($kelas->nama_kelas); ?></p>
            </div>
            <div class="flex gap-3">
                <a href="<?php echo e(route('guru.wali-kelas.keterlambatan.index')); ?>" 
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-4">
        <div class="p-4">
            <form method="GET" action="<?php echo e(route('guru.wali-kelas.keterlambatan.rekap')); ?>" id="filterForm">
    ...
    <?php if($hasFilter): ?>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
            <div class="p-6">
                <h3 class="text-lg font-semibold text-gray-800 mb-4">Rekap Kelas <?php echo e($kelas->nama_kelas); ?></h3>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-center text-gray-900">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                                        <?php echo e($data['jumlah_siswa']); ?> siswa
                                    </span>
                                </td>
                                <td class="px-4 py-3 text-center text-gray-900">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">
                                        <?php echo e($data['total_keterlambatan']); ?> kali
                                    </span>
                                </td>
                            </tr>
            ...
            <div class="p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <span class="text-sm text-gray-600">
                        Periode: <?php echo e(\Carbon\Carbon::parse($tanggalMulai)->format('d M Y')); ?> - <?php echo e(\Carbon\Carbon::parse($tanggalAkhir)->format('d M Y')); ?>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <?php $__currentLoopData = $rekapData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3">
                                    <div>
                                        <div class="font-medium text-gray-900"><?php echo e($item->siswa->nama_lengkap); ?></div>
                                        <div class="text-xs text-gray-500"><?php echo e($item->siswa->nis); ?></div>
                                    </div>
                                </td>
                                <td class="px-4 py-3 text-gray-900"><?php echo e($item->jam_terlambat); ?></td>
                                <td class="px-4 py-3 text-gray-900"><?php echo e($item->alasan_terlambat ?? '-'); ?></td>
...
<div id="exportModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            ...
            <form id="exportForm" method="POST" action="<?php echo e(route('guru.wali-kelas.keterlambatan.export')); ?>">
                <?php echo csrf_field(); ?>
                <div class="mb-4">
...
<?php echo $__env->make('layouts.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\guru\wali-kelas\keterlambatan\rekap.blade.php ENDPATH**/ ?>