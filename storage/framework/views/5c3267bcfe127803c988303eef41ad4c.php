...
<?php $__env->startSection('title', 'Edit Materi - SMK PGRI CIKAMPEK'); ?>
...
<div class="px-3 py-4">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 mb-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Edit materi pembelajaran untuk siswa</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        <form action="<?php echo e(route('guru.materi.update-materi', $materi->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                ...
                <div class="grid lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="judul" name="judul" value="<?php echo e(old('judul', $materi->judul)); ?>" required
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__currentLoopData = $kelasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($kelas->id); ?>" <?php echo e((old('kelas_id', $materi->kelas_id) == $kelas->id) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__currentLoopData = $mapelList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mapel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($mapel->id); ?>" <?php echo e((old('mapel_id', $materi->mapel_id) == $mapel->id) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="url" id="link_video" name="link_video" value="<?php echo e(old('link_video', $materi->link_video)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                      placeholder="Jelaskan tentang materi pembelajaran ini..."><?php echo e(old('deskripsi', $materi->deskripsi)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            ...
                            <div class="flex items-center justify-between">
                                <span class="text-sm text-blue-700"><?php echo e($materi->file_name ?? basename($materi->file_path)); ?></span>
                                <a href="<?php echo e(asset('storage/' . $materi->file_path)); ?>" target="_blank" 
                        ...
                        <div>
                            <label for="file" class="block text-sm font-medium text-gray-700 mb-2">
                                <?php echo e($materi->file_path ? 'Ganti File Materi (Opsional)' : 'File Materi (Opsional)'); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="bg-blue-50 rounded-lg p-4">
                            <h4 class="text-sm font-medium text-blue-800 mb-2">
                                <i class="fas fa-info-circle mr-1"></i> Panduan Edit Materi
                            </h4>
...
<?php echo $__env->make('layouts.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\guru\materi\edit-materi.blade.php ENDPATH**/ ?>