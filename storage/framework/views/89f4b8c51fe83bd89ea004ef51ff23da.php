...
<?php $__env->startSection('title', 'Master Jadwal Ujian'); ?>
...
<div class="container-fluid px-4 py-6">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-3 header-buttons">
            <a href="<?php echo e(route('admin.ujian.jadwal.create')); ?>" 
            ...
            <a href="<?php echo e(route('admin.ujian.jadwal.create-table')); ?>"
            ...
            <div>
                ...
                <select name="mata_pelajaran" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <?php $__currentLoopData = $mataPelajaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mapel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($mapel->id); ?>" <?php echo e(request('mata_pelajaran') == $mapel->id ? 'selected' : ''); ?>>
            ...
            <div>
                ...
                <select name="kelas" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <?php $__currentLoopData = $kelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelasItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($kelasItem->id); ?>" <?php echo e(request('kelas') == $kelasItem->id ? 'selected' : ''); ?>>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <input type="checkbox" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500" value="<?php echo e($item->id); ?>">
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900"><?php echo e($item->nama_ujian); ?></div>
                            <div class="text-sm text-gray-500"><?php echo e(ucfirst($item->jenis_ujian)); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900"><?php echo e($item->mataPelajaran->nama ?? '-'); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900"><?php echo e($item->kelas->nama_kelas ?? '-'); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900"><?php echo e($item->tanggal_formatted); ?></div>
                            <div class="text-sm text-gray-500"><?php echo e($item->waktu_mulai_formatted); ?> - <?php echo e($item->waktu_selesai_formatted); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900"><?php echo e($item->durasi); ?> menit</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 py-1 text-xs font-medium bg-<?php echo e($item->status_color); ?>-100 text-<?php echo e($item->status_color); ?>-800 rounded-full">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                <?php if($item->canBeEdited()): ?>
                                    <a href="<?php echo e(route('admin.ujian.jadwal.edit', $item->id)); ?>" class="text-blue-600 hover:text-blue-700" title="Edit">
                                ...
                                <?php if($item->canBeDeleted()): ?>
                                    <form action="<?php echo e(route('admin.ujian.jadwal.destroy', $item->id)); ?>" method="POST" class="inline" 
        ...
        <div class="bg-white px-6 py-3 border-t border-gray-200">
            <div class="flex justify-between items-center">
                <div class="text-sm text-gray-700">
                    Menampilkan <span class="font-medium"><?php echo e($jadwal->firstItem()); ?></span> sampai <span class="font-medium"><?php echo e($jadwal->lastItem()); ?></span> dari <span class="font-medium"><?php echo e($jadwal->total()); ?></span> hasil
                </div>
                <div>
                    <?php echo e($jadwal->appends(request()->query())->links()); ?>
...
function generateBatchTable() {
    ...
    try {
        ...
        const mataPelajaran = <?php echo json_encode($mataPelajaran ?? [], 15, 512) ?>;
...
function initializeBatchForm() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (submitBtn) {
            ...
            fetch('<?php echo e(route("admin.ujian.jadwal.store")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
...
<?php echo $__env->make('layouts.ujian', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\admin\ujian\jadwal\index.blade.php ENDPATH**/ ?>