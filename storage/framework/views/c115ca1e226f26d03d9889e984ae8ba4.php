...
<?php $__env->startSection('title', 'Manajemen Jadwal Pelajaran'); ?>
...
<div class="w-full px-3 py-4">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-2">
            ...
            <a href="<?php echo e(route('admin.settings.jadwal.index')); ?>" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg transition-colors">
                <i class="fas fa-cog mr-2"></i>Pengaturan Jadwal
            </a>
            <a href="<?php echo e(route('admin.jadwal.create-table')); ?>" class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg transition-colors">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900"><?php echo e($stats['total_jadwal'] ?? 0); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900"><?php echo e($stats['total_kelas'] ?? 0); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900"><?php echo e($stats['total_guru'] ?? 0); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900"><?php echo e($stats['total_mapel'] ?? 0); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <form action="<?php echo e(route('admin.jadwal.index')); ?>" method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-4">
            <div>
                ...
                <select name="kelas_id" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
                    ...
                    <?php $__currentLoopData = $kelas_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div>
                ...
                <select name="hari" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
                    ...
                    <?php $__currentLoopData = $hari_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hari): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($hari); ?>" <?php echo e($selectedHari == $hari ? 'selected' : ''); ?>>
                            <?php echo e($hari); ?>
            ...
            <div>
                ...
                <select name="guru_id" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
                    ...
                    <?php $__currentLoopData = $guru_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guru): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($guru->id); ?>" <?php echo e(request('guru_id') == $guru->id ? 'selected' : ''); ?>>
            ...
            <div>
                ...
                <select name="tahun_ajaran" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
                    <?php $__currentLoopData = $tahun_ajaran_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tahun): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($tahun); ?>" <?php echo e(request('tahun_ajaran', $filter_tahun_ajaran) == $tahun ? 'selected' : ''); ?>>
                            <?php echo e($tahun); ?>
            ...
            <div>
                ...
                <select name="semester" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
                    <?php $__currentLoopData = $semester_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $semester): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($semester); ?>" <?php echo e(request('semester', $filter_semester) == $semester ? 'selected' : ''); ?>>
                            <?php echo e($semester); ?>
            ...
            <div class="md:col-span-5 flex space-x-2">
                ...
                <a href="<?php echo e(route('admin.jadwal.index')); ?>" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg transition-colors">
    ...
    <div id="weeklyScheduleSection" class="space-y-6">
        <?php if($kelas_list->isNotEmpty()): ?>
            <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                        ...
                        <div>
                            ...
                            <p class="text-indigo-100 text-sm">
                                <?php if($settingsJadwal->isNotEmpty()): ?>
                                    ...
                                    ?>
                                    Hari Aktif: <?php echo e(implode(', ', $displayDays)); ?>

                                <?php else: ?>
                                    Semua Kelas - <?php echo e($kelas_list->pluck('nama_kelas')->join(', ')); ?>
                            ...
                            <div class="text-indigo-100 text-xs mt-2 flex flex-wrap gap-2">
                                ...
                                <?php endif; ?>
                                <span class="px-2 py-1 bg-white bg-opacity-20 rounded">
                                    <i class="fas fa-clock mr-1"></i> Durasi per Jam: <?php echo e($daySettings->durasi_per_jam); ?> menit
                                </span>
                            </div>
                            <?php endif; ?>
                        </div>
                    ...
                    <table class="w-full schedule-table">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <?php $__currentLoopData = $orderedActiveDays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hari): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <th class="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider border-r border-gray-200<?php echo e($loop->last ? '' : ''); ?>"><?php echo e($hari); ?></th>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <?php if(count($jam_slots) > 0): ?>
                                ...
                                <tr class="hover:bg-gray-50 <?php echo e($isBreakTime ? 'bg-amber-50' : ''); ?>">
                                    <td class="px-2 py-2 text-sm font-bold text-gray-900 border-r border-gray-200 bg-gray-50 sticky left-0 <?php echo e($isBreakTime ? 'bg-amber-100' : ''); ?>">
                                        <div class="flex items-center justify-center" data-time-slot="<?php echo e($jam_key); ?>" data-jam-ke="<?php echo e($all_time_slots[$jam_key]['jam_ke'] ?? ''); ?>" data-is-break="<?php echo e(isset($all_time_slots[$jam_key]['is_break']) && $all_time_slots[$jam_key]['is_break'] ? 'true' : 'false'); ?>">
                                            <?php if($isBreakTime): ?>
                                                <span class="text-amber-600 font-medium"><i class="fas fa-coffee mr-1"></i><?php echo e($breakLabel); ?> (<?php echo e($jam_key); ?>)</span>
                                            <?php else: ?>
                                                <span class="text-sm font-semibold">
                                                    <?php
                                                        ...
                                                        if (isset($all_time_slots[$jam_key]['jam_ke']) && $all_time_slots[$jam_key]['jam_ke']) {
                                                            $jam_ke_info = 'Jam ke-' . $all_time_slots[$jam_key]['jam_ke'] . ' (' . $jam_key . ')';
                                                        } else {
                                                            // Fallback: get from any schedule in this time slot
                                                            $sample_jadwal = collect($hari_jadwal)->flatten()->first();
                                                            $jam_ke_info = $sample_jadwal ? 'Jam ke-' . $sample_jadwal->jam_ke . ' (' . $jam_key . ')' : $jam_key;
                                                        }
                                                        echo $jam_ke_info;
                                                    ?>
                                                </span>
                                    ...
                                    <?php $__currentLoopData = $hari_list_table; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hari): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <td class="px-2 py-3 text-sm border-r border-gray-200 text-center min-w-[250px] align-top">
                                        <?php if(isset($all_time_slots[$jam_key]['is_break']) && $all_time_slots[$jam_key]['is_break']): ?>
                                            <div class="break-time-cell">
                                                <i class="fas <?php echo e($all_time_slots[$jam_key]['break_label'] == 'Istirahat 1' ? 'fa-coffee' : 'fa-utensils'); ?>"></i>
                                                <span class="break-time-label"><?php echo e($all_time_slots[$jam_key]['break_label']); ?></span>
                                            </div>
                                        <?php elseif(isset($hari_jadwal[$hari]) && count($hari_jadwal[$hari]) > 0): ?>
                                            <div class="space-y-1 max-h-48 overflow-y-auto">
                                                <?php $__currentLoopData = $hari_jadwal[$hari]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jadwal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                    ...
                                                    ?>
                                                    <div class="schedule-cell <?php echo e($color_class); ?> border rounded-lg p-2 mb-1 hover:shadow-md transition-all cursor-pointer group relative" onclick="editJadwal(<?php echo e($jadwal->id); ?>)" title="Mata Pelajaran: <?php echo e($jadwal->mapel->nama ?? 'Mapel tidak ditemukan'); ?>">
                                                        <div class="flex justify-between items-start mb-1">
                                                            <span class="class-badge"><?php echo e($jadwal->kelas->nama_kelas ?? 'Kelas tidak ditemukan'); ?></span>
                                                            <div class="flex space-x-1 opacity-90 group-hover:opacity-100">
                                                                <button onclick="event.stopPropagation(); editJadwal(<?php echo e($jadwal->id); ?>)" class="action-btn text-blue-600 hover:text-blue-800 bg-white hover:bg-blue-50" title="Edit Jadwal">
                                                                    <i class="fas fa-edit text-xs"></i>
                                                                </button>
                                                                <button onclick="event.stopPropagation(); deleteJadwal(<?php echo e($jadwal->id); ?>)" class="action-btn text-red-600 hover:text-red-800 bg-white hover:bg-red-50" title="Hapus Jadwal">
                                                                    <i class="fas fa-trash text-xs"></i>
                                                                </button>
                                                            </div>
                                                        </div>
                                                        <div class="text-xs font-medium mb-1 truncate" title="<?php echo e($jadwal->mapel->nama ?? 'Mapel tidak ditemukan'); ?>">
                                                            <i class="fas fa-book text-xs mr-1 opacity-75"></i><?php echo e($jadwal->mapel->nama ?? 'Mapel tidak ditemukan'); ?>

                                                        </div>
                                                        <div class="text-xs text-gray-600 truncate" title="<?php echo e($jadwal->guru->nama ?? 'Guru tidak ditemukan'); ?>">
                                                            <i class="fas fa-user text-xs mr-1 opacity-75"></i><?php echo e($jadwal->guru->nama ?? 'Guru tidak ditemukan'); ?>

                                                        </div>
                                                        <?php if($jadwal->keterangan): ?>
                                                            <div class="text-xs text-gray-500 mt-1 italic truncate" title="<?php echo e($jadwal->keterangan); ?>">
                                                                <i class="fas fa-info-circle text-xs mr-1 opacity-75"></i><?php echo e(Str::limit($jadwal->keterangan, 30)); ?>
                                                        ...
                                                        <div class="absolute invisible group-hover:visible bg-gray-800 text-white text-xs rounded py-1 px-2 -top-8 left-1/2 transform -translate-x-1/2 z-50 whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
                                                            <?php echo e($jadwal->mapel->nama ?? 'Mapel tidak ditemukan'); ?>
                                        ...
                                        <?php else: ?>
                                            <div class="schedule-cell-empty h-16 bg-gray-50 border-2 border-dashed border-gray-200 rounded-lg flex items-center justify-center cursor-pointer hover:bg-gray-100 hover:border-gray-300 transition-colors group" onclick="addJadwalForSlot('<?php echo e($hari); ?>', '<?php echo e($jam_key); ?>')">
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="<?php echo e(count($hari_list_table) + 1); ?>" class="px-4 py-12 text-center text-gray-500">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <button onclick="openCreateModal('<?php echo e(request("kelas_id") ?? ""); ?>' || null, '<?php echo e($selectedHari ?? ""); ?>' || null)" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg text-sm transition-colors">
                ...
                <?php if(count($mapel_colors) > 0): ?>
                <div class="px-6 py-4 bg-white border-t border-gray-200">
                    <div class="flex justify-between items-center mb-3">
                        <h4 class="text-sm font-semibold text-gray-700">
                            <i class="fas fa-palette mr-2"></i>Legend Warna Mata Pelajaran (<?php echo e(count($mapel_colors)); ?> mapel)
                        </h4>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3">
                        ...
                        ?>
                        <?php $__currentLoopData = $sortedMapelColors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mapelNama => $colorClass): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center space-x-2 p-2 bg-gray-50 rounded-lg">
                                <div class="w-6 h-6 rounded border-2 <?php echo e($colorClass); ?> flex-shrink-0"></div>
                                <span class="text-xs text-gray-700 truncate flex-1" title="<?php echo e($mapelNama); ?>">
                                    <?php echo e(Str::limit($mapelNama, 18)); ?>
                    ...
                    <?php if(config('app.debug')): ?>
                        <details class="mt-4">
                            ...
                            <div class="mt-2 text-xs text-gray-500 bg-gray-100 p-2 rounded">
                                <div>Total Mata Pelajaran: <?php echo e(count($mapel_colors)); ?></div>
                                <div>Total Warna Berbeda: <?php echo e(count(array_unique(array_values($mapel_colors)))); ?></div>
                                <div>Warna Digunakan: <?php echo e(count($used_colors)); ?></div>
                                <?php if(count($mapel_colors) > count(array_unique(array_values($mapel_colors)))): ?>
                                    <div class="text-red-600">⚠️ Ada <?php echo e(count($mapel_colors) - count(array_unique(array_values($mapel_colors)))); ?> collision terdeteksi</div>
                                <?php else: ?>
        ...
        <?php else: ?>
            <div class="bg-white rounded-lg shadow-sm p-8 text-center">
                ...
                <a href="<?php echo e(route('admin.kelas.index')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition-colors">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <select id="mapel_id" name="mapel_id" required class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
                            ...
                            <?php $__currentLoopData = $mapel_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mapel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div>
                        ...
                        <select id="jam_ke" name="jam_ke" required class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
                            ...
                            <?php
                                ...
                                if($settingsJadwal->isNotEmpty()) {
                                    $daySettings = $settingsJadwal->first();
                                    $numPeriods = (int)($daySettings->jumlah_jam_pelajaran ?? 10);
                            ...
                            <?php $__currentLoopData = $jamKeOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jamKe => $timeRange): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($jamKe); ?>">Jam ke-<?php echo e($jamKe); ?> (<?php echo e($timeRange); ?>)</option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="jumlah_jam" name="jumlah_jam" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
                            ...
                            <?php for($i = 1; $i <= $maxPeriods; $i++): ?>
                                <option value="<?php echo e($i); ?>" <?php echo e($i == 1 ? 'selected' : ''); ?>>
                                    <?php echo e($i); ?> <?php echo e($i == 1 ? 'Jam Pelajaran' : 'Jam Pelajaran'); ?>
                    ...
                    <div>
                        ...
                        <select id="semester" name="semester" required class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
                            <?php $__currentLoopData = $semester_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $semester): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($semester); ?>" <?php echo e($semester == $filter_semester ? 'selected' : ''); ?>><?php echo e($semester); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="tahun_ajaran" name="tahun_ajaran" required class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
                            <?php $__currentLoopData = $tahun_ajaran_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tahun): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($tahun); ?>" <?php echo e($tahun == $filter_tahun_ajaran ? 'selected' : ''); ?>><?php echo e($tahun); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
...
<div id="importJadwalModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
    <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-md bg-white">
        ...
        <div class="p-6">
            <!-- Import Form -->
            <form id="importJadwalForm" action="<?php echo e(route('admin.jadwal.import')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="bg-green-50 p-4 rounded-lg border border-green-200 mb-6">
                    ...
                    <div class="flex space-x-2">
                        <a href="<?php echo e(route('admin.jadwal.template', ['format' => 'excel'])); ?>" 
                        ...
                        <a href="<?php echo e(route('admin.jadwal.template', ['format' => 'csv'])); ?>" 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (btnCreateJadwal) {
        btnCreateJadwal.addEventListener('click', function() {
            ...
            const currentKelasId = '<?php echo e(request("kelas_id") ?? ""); ?>';
            const currentHari = '<?php echo e($selectedHari ?? ""); ?>';
...
// Function to open create modal, with optional preselected kelas, hari, jam_ke, and jam_key
function openCreateModal(preselectedKelas = null, preselectedHari = null, preselectedJamKe = null, preselectedJamKey = null) {
    console.log('openCreateModal called with:', {
        preselectedKelas, 
        preselectedHari, 
        preselectedJamKe, 
        preselectedJamKey
    ...
    if (semesterSelect) semesterSelect.value = '<?php echo e($filter_semester ?? 1); ?>';

    const tahunInput = document.getElementById('tahun_ajaran');
    if (tahunInput) tahunInput.value = '<?php echo e($filter_tahun_ajaran ?? date("Y")."/".(date("Y")+1)); ?>';
    ...
    // Set preselected values with a slight delay to ensure DOM is ready
    setTimeout(async () => {
        console.log('Setting preselected values after timeout');
        
        // Set kelas from filter or preselected
        if (preselectedKelas) {
            const kelasSelect = document.getElementById('kelas_id');
            console.log('Found kelasSelect:', kelasSelect);
            if (kelasSelect) {
                kelasSelect.value = preselectedKelas;
                console.log('Set kelas to:', preselectedKelas);
                
                // Trigger onKelasChange to filter guru and mapel based on selected kelas
                await onKelasChange();
            }
        }
        
        // Set hari from parameter
        if (preselectedHari) {
            const hariSelect = document.getElementById('hari');
            console.log('Found hariSelect:', hariSelect);
            if (hariSelect) {
                hariSelect.value = preselectedHari;
                console.log('Set hari to:', preselectedHari);
            }
        }
        
        // Set jam_ke from parameter
        if (preselectedJamKe) {
            const jamKeSelect = document.getElementById('jam_ke');
            console.log('Found jamKeSelect:', jamKeSelect);
            if (jamKeSelect) {
                jamKeSelect.value = preselectedJamKe;
                console.log('Set jam_ke to:', preselectedJamKe);
                
                // Trigger change event to update jumlah_jam options
                jamKeSelect.dispatchEvent(new Event('change'));
            }
        }
        
        // Additional: if we have jam_key, we can parse it for jam_mulai and jam_selesai
        if (preselectedJamKey) {
            const timeParts = preselectedJamKey.split(' - ');
            if (timeParts.length === 2) {
                const jamMulaiInput = document.getElementById('jam_mulai');
                const jamSelesaiInput = document.getElementById('jam_selesai');
                
                if (jamMulaiInput) {
                    jamMulaiInput.value = timeParts[0];
                    console.log('Set jam_mulai to:', timeParts[0]);
                }
                if (jamSelesaiInput) {
                    jamSelesaiInput.value = timeParts[1];
                    console.log('Set jam_selesai to:', timeParts[1]);
                }
            }
        }
        
    }, 150); // Increased timeout to ensure all DOM elements are ready
}
...
function updateJumlahJamOptions() {
    ...
    // Get max periods from actual settings
    const maxPeriods = <?php echo e($settingsJadwal->isNotEmpty() ? ($settingsJadwal->first()->jumlah_jam_pelajaran ?? 10) : 10); ?>;
...
async function onMapelChange() {
    ...
    try {
        ...
        if (data.success) {
            ...
            // Auto-select if only one guru available
            else if (data.data.length === 1) {
                guruSelect.value = data.data[0].id;
                console.log('Auto-selected guru:', data.data[0].nama, 'for mapel with only one teacher');
            }
...
async function onGuruChange() {
    ...
    try {
        ...
        if (data.success) {
            ...
            // Auto-select if only one mapel available
            else if (data.data.length === 1) {
                mapelSelect.value = data.data[0].id;
                console.log('Auto-selected mapel:', data.data[0].nama, 'for guru with only one subject');
            }
...
async function loadAllGurus() {
    ...
    <?php $__currentLoopData = $guru_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guru): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        const option<?php echo e($guru->id); ?> = document.createElement('option');
        option<?php echo e($guru->id); ?>.value = '<?php echo e($guru->id); ?>';
        option<?php echo e($guru->id); ?>.textContent = '<?php echo e($guru->nama); ?>';
        guruSelect.appendChild(option<?php echo e($guru->id); ?>);
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
}
...
async function loadAllMapel() {
    ...
    <?php $__currentLoopData = $mapel_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mapel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        const option<?php echo e($mapel->id); ?> = document.createElement('option');
        option<?php echo e($mapel->id); ?>.value = '<?php echo e($mapel->id); ?>';
        option<?php echo e($mapel->id); ?>.textContent = '<?php echo e($mapel->nama); ?>';
        mapelSelect.appendChild(option<?php echo e($mapel->id); ?>);
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
}
...
async function onKelasChange() {
    ...
    try {
        ...
        if (data.success) {
            ...
            // Auto-select if only one mapel available for this kelas
            if (data.data.mapel.length === 1 && !currentMapelId) {
                mapelSelect.value = data.data.mapel[0].id;
                console.log('Auto-selected mapel:', data.data.mapel[0].nama, 'for kelas with only one subject');
            }
            ...
            // Auto-select if only one guru available for this kelas
            if (data.data.guru.length === 1 && !currentGuruId) {
                guruSelect.value = data.data.guru[0].id;
                console.log('Auto-selected guru:', data.data.guru[0].nama, 'for kelas with only one teacher');
            }
...
async function submitJadwal(event) {
    ...
    let url = '<?php echo e(route("admin.jadwal.store")); ?>';
    let method = 'POST';
    ...
    try {
        ...
        if (data.success) {
            ...
            showAlert('success', isEditMode ? 'Jadwal berhasil diperbarui!' : 'Jadwal berhasil ditambahkan!');
...
async function refreshScheduleTable() {
    try {
        ...
        const url = `/admin/jadwal${queryString ? '?' + queryString : ''}`;
        ...
        if (response.ok) {
            ...
            // Find the weekly schedule section in the response
            const newScheduleSection = doc.querySelector('#weeklyScheduleSection');
            const currentScheduleSection = document.querySelector('#weeklyScheduleSection');
            
            if (newScheduleSection && currentScheduleSection) {
                currentScheduleSection.replaceWith(newScheduleSection);
                console.log('Schedule section refreshed successfully');
            } else {
                console.warn('Could not find schedule section to refresh');
            }
        } else {
            console.error('Failed to refresh schedule table:', response.status);
        }
    } catch (error) {
...
function showAlert(type, message) {
    ...
    alertDiv.className = `alert-message fixed top-4 right-4 px-6 py-4 rounded-lg shadow-lg z-50 transition-all duration-300`;
    
    // Set alert type styles
    if (type === 'success') {
        alertDiv.className += ' bg-green-500 text-white border border-green-600';
        alertDiv.innerHTML = `
            <div class="flex items-center">
        ...
        alertDiv.className += ' bg-red-500 text-white border border-red-600';
        alertDiv.innerHTML = `
            <div class="flex items-center">
...
async function editJadwal(jadwalId) {
    ...
    try {
        // Fetch jadwal data
        const response = await fetch(`/admin/jadwal/${jadwalId}/edit`);
        const data = await response.json();
        ...
        if (data.success) {
            ...
            // Filter guru and mapel based on kelas, then set the values
            setTimeout(async () => {
                try {
                    await onKelasChange();
                    // After filtering is complete, set mapel and guru
                    document.getElementById('mapel_id').value = jadwal.mapel_id;
                    document.getElementById('guru_id').value = jadwal.guru_id;
                } catch (error) {
                    console.error('Error filtering data by kelas:', error);
                    // Fallback: set values without filtering
                    document.getElementById('mapel_id').value = jadwal.mapel_id;
                    document.getElementById('guru_id').value = jadwal.guru_id;
                }
            }, 100);
...
async function deleteJadwal(jadwalId) {
    if (confirm('Apakah Anda yakin ingin menghapus jadwal ini?')) {
        try {
            const response = await fetch(`/admin/jadwal/${jadwalId}`, {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]')?.getAttribute('content') || '<?php echo e(csrf_token()); ?>',
                    'Content-Type': 'application/json',
            ...
            if (data.success) {
                ...
                showAlert('error', 'Gagal menghapus jadwal: ' + (data.message || 'Terjadi kesalahan'));
            }
        } catch (error) {
            console.error('Error:', error);
...
function addJadwalForSlot(hari, jamKey) {
    ...
    // Get current filter values
    const currentKelasId = '<?php echo e(request("kelas_id")); ?>' || null;
    const selectedHari = hari;
    
    // Get jam_ke from time slot data
    let selectedJamKe = null;
    if (timeSlotData && timeSlotData.dataset.jamKe) {
        selectedJamKe = timeSlotData.dataset.jamKe;
    }
    
    console.log('addJadwalForSlot called with:', {
        hari: selectedHari,
        jamKey: jamKey,
        currentKelasId: currentKelasId,
        selectedJamKe: selectedJamKe
    });
    
    // Open modal with preselected values
    openCreateModal(currentKelasId, selectedHari, selectedJamKe, jamKey);
}
...
async function loadDeletePreview() {
    ...
    try {
        ...
        const response = await fetch(`<?php echo e(route('admin.jadwal.get-schedule')); ?>?${params.toString()}`, {
            method: 'GET',
            headers: {
                'X-Requested-With': 'XMLHttpRequest',
                'Accept': 'application/json',
...
async function confirmBatchDelete() {
    ...
    try {
        ...
        const response = await fetch('<?php echo e(route("admin.jadwal.batch-delete-by-day")); ?>', {
            method: 'POST',
            body: formData,
            headers: {
                'X-Requested-With': 'XMLHttpRequest',
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\admin\jadwal\index.blade.php ENDPATH**/ ?>