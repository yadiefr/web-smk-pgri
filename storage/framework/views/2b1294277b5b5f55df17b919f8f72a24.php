...
<div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-8">
    <form method="GET" action="<?php echo e(route('tata-usaha.siswa.index')); ?>" class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div>
...
<div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
    <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-sm p-6 text-white">
        <div class="flex items-center justify-between">
            ...
            <div class="text-right">
                <p class="text-3xl font-bold"><?php echo e($siswa->total()); ?></p>
    ...
    <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-sm p-6 text-white">
        <div class="flex items-center justify-between">
            ...
            <div class="text-right">
                <p class="text-3xl font-bold"><?php echo e($siswa->where('status', 'aktif')->count()); ?></p>
    ...
    <div class="bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-xl shadow-sm p-6 text-white">
        <div class="flex items-center justify-between">
            ...
            <div class="text-right">
                <p class="text-3xl font-bold"><?php echo e($siswa->where('status', 'lulus')->count()); ?></p>
    ...
    <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-sm p-6 text-white">
        <div class="flex items-center justify-between">
            ...
            <div class="text-right">
                <p class="text-3xl font-bold"><?php echo e($siswa->where('jenis_kelamin', 'L')->count()); ?>/<?php echo e($siswa->where('jenis_kelamin', 'P')->count()); ?></p>
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-200">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                            <div class="h-10 w-10 bg-gradient-to-br from-green-500 to-green-600 rounded-full flex items-center justify-center mr-3 text-white font-semibold text-sm">
                                <?php echo e(strtoupper(substr($s->nama_lengkap, 0, 2))); ?>

                            </div>
                            <div>
                                <div class="text-sm font-medium text-gray-900 dark:text-gray-100"><?php echo e($s->nama_lengkap); ?></div>
                                <div class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($s->email ?? 'Email belum diisi'); ?></div>
                            </div>
                        </div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900 dark:text-gray-100 font-mono">
                            <div><?php echo e($s->nis ?? '-'); ?></div>
                            <div class="text-xs text-gray-500"><?php echo e($s->nisn ?? '-'); ?></div>
                        </div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300">
                            <?php echo e($s->kelas->nama_kelas ?? 'Belum ada kelas'); ?>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-center">
                        <div class="flex items-center justify-center space-x-2">
                            <a href="<?php echo e(route('tata-usaha.siswa.show', $s)); ?>" 
                            ...
                            <a href="<?php echo e(route('tata-usaha.siswa.edit', $s)); ?>" 
                            ...
                            <button onclick="confirmDelete('<?php echo e(route('tata-usaha.siswa.destroy', $s)); ?>')"
                ...
                <tr>
                    <td colspan="7" class="px-6 py-12 text-center">
                        <div class="flex flex-col items-center justify-center text-gray-500">
                            ...
                            <a href="<?php echo e(route('tata-usaha.siswa.create')); ?>" 
...
<?php echo $__env->make('layouts.tata_usaha', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\tata_usaha\siswa\index.blade.php ENDPATH**/ ?>