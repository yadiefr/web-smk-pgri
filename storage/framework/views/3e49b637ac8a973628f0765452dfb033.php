          ...
          <div class="bg-white rounded-lg shadow p-4 md:p-6">
            <div class="flex items-center">
                ...
                <div class="ml-3 md:ml-4">
                    ...
                    <p class="text-lg md:text-2xl font-semibold text-gray-900"><?php echo e($totalMapel ?? $jadwal->pluck('mapel_id')->unique()->count()); ?></p>
                </div>
            </div>
        </div>spacing: 0;
    }
        ...
        <div class="bg-white rounded-lg shadow p-4 md:p-6">
            <div class="flex items-center">
                ...
                <div class="ml-3 md:ml-3">
                    ...
                    <p class="text-lg md:text-2xl font-semibold text-gray-900"><?php echo e($totalJadwal ?? $jadwal->count()); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-4 md:p-6">
            <div class="flex items-center">
                ...
                <div class="ml-3 md:ml-4">
                    ...
                    <p class="text-lg md:text-2xl font-semibold text-gray-900"><?php echo e($totalKelas ?? $jadwal->pluck('kelas_id')->unique()->count()); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-4 md:p-6">
            <div class="flex items-center">
                ...
                <div class="ml-3 md:ml-4">
                    ...
                    <p class="text-lg md:text-2xl font-semibold text-gray-900"><?php echo e($totalJam); ?> JPL</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 mb-6">
            <div class="p-6 text-center">
                ...
                <?php if(isset($debugInfo)): ?>
                    <?php if($debugInfo['assignments'] > 0 && $debugInfo['scheduled'] == 0): ?>
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                            <div class="text-sm text-blue-800">
                                <strong>Status:</strong> Admin telah mengassign <?php echo e($debugInfo['assignments']); ?> mata pelajaran kepada Anda, 
                                namun belum membuat jadwal waktu yang spesifik. Silahkan hubungi admin untuk membuat jadwal waktu mengajar.
                            </div>
                        </div>
                    <?php elseif($debugInfo['total_entries'] == 0): ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 mb-6">
            <div class="p-4 border-b border-gray-100">
                <h3 class="font-semibold text-gray-800">
                    ...
                    Jadwal Hari Ini (<?php echo e(\Carbon\Carbon::now()->locale('id')->isoFormat('dddd, D MMMM Y')); ?>)
                </h3>
            </div>
            <div class="p-4">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div class="bg-blue-50 border-l-4 border-blue-500 rounded-lg p-4">
                        <div class="flex items-start justify-between mb-2">
                            <h4 class="font-medium text-blue-800"><?php echo e($j->mapel->nama ?? 'Mata Pelajaran tidak tersedia'); ?></h4>
                            <?php if($j->jam_mulai && $j->jam_selesai): ?>
                        ...
                        <p class="text-sm text-gray-600 mb-1">
                            <i class="fas fa-users mr-1"></i><?php echo e($j->kelas->nama_kelas ?? 'Kelas tidak tersedia'); ?>

                        </p>
                        <?php if($j->ruang): ?>
                        <p class="text-sm text-gray-600">
                            <i class="fas fa-map-marker-alt mr-1"></i><?php echo e($j->ruang); ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100">
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-4 rounded-t-xl">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-blue-100 text-sm mt-1"><?php echo e(auth()->guard('guru')->user()->nama_lengkap); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full schedule-table text-sm">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <?php $__currentLoopData = ['Senin', 'Selasa', 'Rabu', 'Kamis', 'Jumat']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hari): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <th class="px-1 py-2 text-center text-xs font-medium text-gray-500 uppercase tracking-wider border-r border-gray-200"><?php echo e($hari); ?></th>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <?php $__currentLoopData = $timeSlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 <?php echo e($slot['isBreak'] ?? false ? 'bg-amber-50' : ''); ?>">
                                <td class="px-2 py-2 text-xs font-bold text-gray-900 border-r border-gray-200 sticky-jam-column <?php echo e($slot['isBreak'] ?? false ? 'bg-amber-100' : ''); ?>">
                                    <div class="flex flex-col">
                                        <span class="text-xs font-semibold"><?php echo e($slot['time']); ?></span>
                                        <span class="text-xs text-gray-500">
                                            <?php if($slot['isBreak'] ?? false): ?>
                                                <span class="text-amber-600 font-medium text-xs"><i class="fas fa-coffee mr-1"></i><?php echo e($slot['label'] ?? 'Istirahat'); ?></span>
                                            <?php else: ?>
                                                <span class="text-gray-500">Jam ke-<?php echo e($slot['jam_ke'] ?? ($index + 1)); ?></span>
                                            <?php endif; ?>
                                        </span>
                                    </div>
                                </td>
                                    ...
                                    <td class="px-1 py-2 text-xs border-r border-gray-200 text-center min-w-[140px] align-top">
                                        <?php if($slot['isBreak'] ?? false): ?>
                                            <div class="break-time-cell">
                                                ...
                                                <span class="break-time-label text-xs"><?php echo e($slot['label'] ?? 'Istirahat'); ?></span>
                                            </div>
                                        <?php elseif(isset($scheduleMatrix[$dayKey][$timeKey])): ?>
                                            <?php 
                                            ...
                                            ?>
                                            <div class="schedule-cell <?php echo e($color_class); ?> border rounded-lg p-1 mb-1 hover:shadow-md transition-all cursor-pointer group relative <?php echo e($isMultiSlot ? 'border-l-4' : ''); ?>" title="Mata Pelajaran: <?php echo e($mapelNama); ?>">
                                                <div class="flex justify-between items-start mb-1">
                                                    <span class="class-badge"><?php echo e($jadwalItem->kelas->nama_kelas ?? 'Kelas tidak ditemukan'); ?></span>
                                                    <?php if($isMultiSlot): ?>
                                                        <span class="text-xs bg-blue-600 text-white px-1 py-0.5 rounded text-[9px]">
                                                            <?php echo e(\Carbon\Carbon::parse($jadwalItem->jam_mulai)->format('H:i')); ?>-<?php echo e(\Carbon\Carbon::parse($jadwalItem->jam_selesai)->format('H:i')); ?>

                                                        </span>
                                                    <?php endif; ?>
                                                </div>
                                                <div class="text-xs font-medium mb-1 truncate" title="<?php echo e($mapelNama); ?>">
                                                    <i class="fas fa-book text-xs mr-1 opacity-75"></i><?php echo e($mapelNama); ?>

                                                    <?php if($isMultiSlot): ?>
                                                        <span class="text-[9px] text-gray-500 ml-1">(<?php echo e($jadwalEnd->diffInMinutes($jadwalStart)); ?> mnt)</span>
                                                    <?php endif; ?>
                                                </div>
                                                <div class="text-xs text-gray-600 truncate hidden md:block" title="<?php echo e(auth()->guard('guru')->user()->nama_lengkap); ?>">
                                                    <i class="fas fa-user text-xs mr-1 opacity-75"></i><?php echo e(auth()->guard('guru')->user()->nama_lengkap); ?>

                                                </div>
                                                <?php if($jadwalItem->ruang): ?>
                                                    <div class="text-xs text-gray-500 mt-1 italic truncate hidden md:block" title="<?php echo e($jadwalItem->ruang); ?>">
                                                        <i class="fas fa-map-marker-alt text-xs mr-1 opacity-75"></i><?php echo e($jadwalItem->ruang); ?>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                    <div class="bg-white p-3 rounded-lg shadow-sm">
                        <div class="text-2xl font-bold text-blue-600"><?php echo e($jadwal->count()); ?></div>
                        <div class="text-xs text-gray-500">Total Jadwal</div>
                    </div>
                    <div class="bg-white p-3 rounded-lg shadow-sm">
                        <div class="text-2xl font-bold text-green-600"><?php echo e($jadwal->count()); ?></div>
                        <div class="text-xs text-gray-500">Jadwal Aktif</div>
                    </div>
                    <div class="bg-white p-3 rounded-lg shadow-sm">
                        <div class="text-2xl font-bold text-purple-600"><?php echo e($jadwal->pluck('kelas_id')->unique()->count()); ?></div>
                        <div class="text-xs text-gray-500">Total Kelas</div>
                    </div>
                    <div class="bg-white p-3 rounded-lg shadow-sm">
                        <div class="text-2xl font-bold text-orange-600"><?php echo e($jadwal->pluck('mapel_id')->unique()->count()); ?></div>
            ...
            <div class="px-6 py-4 bg-white border-t border-gray-200">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3">
                    ...
                    ?>
                    <?php $__currentLoopData = $sortedMapelColors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mapelName => $colorClass): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center space-x-2 p-2 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                            <div class="w-4 h-4 rounded border-2 <?php echo e($colorClass); ?> flex-shrink-0"></div>
                            <span class="text-xs text-gray-700 truncate" title="<?php echo e($mapelName); ?>"><?php echo e($mapelName); ?></span>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
...
<?php echo $__env->make('layouts.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\guru\jadwal\index.blade.php ENDPATH**/ ?>