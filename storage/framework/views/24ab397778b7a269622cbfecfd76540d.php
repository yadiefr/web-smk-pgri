...
<?php $__env->startSection('title', 'Kas Masuk Harian - Bendahara'); ?>
...
<div class="w-full h-full">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-6">
        ...
        <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-lg shadow-sm p-3 sm:p-4 lg:p-6 border border-emerald-200 hover:shadow-md transition-all h-full">
            <div class="flex flex-col h-full">
                ...
                <div class="flex-1 flex flex-col justify-center">
                    <p class="text-base sm:text-lg lg:text-2xl font-bold text-emerald-800 truncate">Rp <?php echo e(number_format($totalKasMasukBulan, 0, ',', '.')); ?></p>
                    <p class="text-emerald-600 text-xs mt-1"><?php echo e($tanggalAwal->locale('id')->monthName); ?> <?php echo e($tahun); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-sky-50 to-sky-100 rounded-lg shadow-sm p-3 sm:p-4 lg:p-6 border border-sky-200 hover:shadow-md transition-all h-full">
            <div class="flex flex-col h-full">
                ...
                <div class="flex-1 flex flex-col justify-center">
                    <p class="text-base sm:text-lg lg:text-2xl font-bold text-sky-800"><?php echo e($totalTransaksiBulan); ?></p>
                    <p class="text-sky-600 text-xs mt-1"><?php echo e($tanggalAwal->locale('id')->monthName); ?> <?php echo e($tahun); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-violet-50 to-violet-100 rounded-lg shadow-sm p-3 sm:p-4 lg:p-6 border border-violet-200 hover:shadow-md transition-all h-full">
            <div class="flex flex-col h-full">
                ...
                <div class="flex-1 flex flex-col justify-center">
                    <p class="text-base sm:text-lg lg:text-2xl font-bold text-violet-800 truncate">Rp <?php echo e(number_format($totalKasMasukKeseluruhan, 0, ',', '.')); ?></p>
        ...
        <div class="bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg shadow-sm p-3 sm:p-4 lg:p-6 border border-amber-200 hover:shadow-md transition-all h-full">
            <div class="flex flex-col h-full">
                ...
                <div class="flex-1 flex flex-col justify-center">
                    <p class="text-base sm:text-lg lg:text-2xl font-bold text-amber-800"><?php echo e($totalTransaksiKeseluruhan); ?></p>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6">
        <div class="flex items-center justify-between">
            <a href="<?php echo e(route('siswa.bendahara.kas-masuk', ['bulan' => $bulanSebelumnya->month, 'tahun' => $bulanSebelumnya->year])); ?>" 
            ...
            <a href="<?php echo e(route('siswa.bendahara.kas-masuk', ['bulan' => $bulanSelanjutnya->month, 'tahun' => $bulanSelanjutnya->year])); ?>" 
               class="flex items-center text-gray-600 hover:text-blue-600 transition duration-200">
                    ...
                    <tr class="hover:bg-gray-50 <?php echo e($hari['total'] > 0 ? 'bg-green-50' : ''); ?>">
                        ...
                        <td class="px-4 py-4 whitespace-nowrap text-center">
                            <div class="flex space-x-2 justify-center">
                                <?php if($hari['jumlah_transaksi'] > 0): ?>
                                    <a href="<?php echo e(route('siswa.bendahara.edit-kas-masuk', ['tanggal' => $hari['tanggal']])); ?>"
                                       class="bg-blue-100 hover:bg-blue-200 text-blue-700 px-3 py-1 rounded text-xs transition duration-200">
                                        <i class="fas fa-edit mr-1"></i>Edit
                                    </a>
                                <?php else: ?>
                                    <a href="<?php echo e(route('siswa.bendahara.input-kas-masuk', ['tanggal' => $hari['tanggal']])); ?>"
...
<?php echo $__env->make('layouts.siswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\siswa\bendahara\kas-masuk.blade.php ENDPATH**/ ?>