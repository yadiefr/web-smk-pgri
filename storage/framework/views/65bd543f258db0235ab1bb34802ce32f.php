...
<?php $__env->startSection('title', 'Detail Keuangan Siswa'); ?>
...
<div class="container-responsive">
                ...
                <div class="flex mobile-student-info md:flex-row items-start md:items-center space-y-4 md:space-y-0 md:space-x-8">
                    ...
                    <div class="flex-shrink-0">
                        <div class="student-avatar w-16 h-16 md:w-20 md:h-20 rounded-full border-4 border-blue-200 overflow-hidden bg-gray-100">
                            ...
                            <?php else: ?>
                                <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($siswa->nama_lengkap)); ?>&background=3b82f6&color=ffffff&size=80"
                                     alt="Foto <?php echo e($siswa->nama_lengkap); ?>"
                                     class="w-full h-full object-cover">
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="grid mobile-student-grid md:grid-cols-3 gap-3 md:gap-4 flex-1">
                        <div>
                            ...
                            <p class="text-sm md:text-lg font-semibold text-gray-900"><?php echo e($siswa->nama_lengkap); ?></p>
                        </div>
                        <div>
                            <p class="text-xs md:text-sm font-medium text-gray-500">NISN</p>
                            <p class="text-sm md:text-lg font-semibold text-gray-900"><?php echo e($siswa->nisn ?? $siswa->nis ?? '-'); ?></p>
                        </div>
                        <div>
                            <p class="text-xs md:text-sm font-medium text-gray-500">Kelas</p>
                            <p class="text-sm md:text-lg font-semibold text-gray-900"><?php echo e($kelas->nama_kelas); ?> - <?php echo e($kelas->jurusan->nama_jurusan ?? ''); ?></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="grid mobile-stats md:grid-cols-4 gap-3 md:gap-4 mb-4 md:mb-6">
        <div class="stat-card bg-white rounded-lg shadow-sm border border-blue-200 p-3 md:p-6 text-center">
            ...
            <h4 class="text-lg md:text-2xl font-bold text-blue-600 mb-1">Rp <?php echo e(number_format($totalTagihan, 0, ',', '.')); ?></h4>
        ...
        <div class="stat-card bg-white rounded-lg shadow-sm border border-green-200 p-3 md:p-6 text-center">
            ...
            <h4 class="text-lg md:text-2xl font-bold text-green-600 mb-1">Rp <?php echo e(number_format($totalDibayar, 0, ',', '.')); ?></h4>
        ...
        <div class="stat-card bg-white rounded-lg shadow-sm border border-red-200 p-3 md:p-6 text-center">
            ...
            <h4 class="text-lg md:text-2xl font-bold text-red-600 mb-1">Rp <?php echo e(number_format($totalSisa, 0, ',', '.')); ?></h4>
        ...
        <div class="stat-card bg-white rounded-lg shadow-sm border border-purple-200 p-3 md:p-6 text-center">
            ...
            <h4 class="text-lg md:text-2xl font-bold text-purple-600 mb-1"><?php echo e($lunas); ?>/<?php echo e($totalItem); ?></h4>
    ...
    <div class="bg-white rounded-lg shadow-sm border">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900"><?php echo e($tagihan['nama_tagihan']); ?></div>
                                <?php if($tagihan['keterangan']): ?>
                                    <div class="text-sm text-gray-500"><?php echo e($tagihan['keterangan']); ?></div>
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium <?php echo e($tagihan['sisa'] > 0 ? 'text-red-600' : 'text-gray-500'); ?>">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <?php echo e($tagihan['tanggal_jatuh_tempo'] ? \Carbon\Carbon::parse($tagihan['tanggal_jatuh_tempo'])->format('d/m/Y') : '-'); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <button onclick="toggleRiwayat('riwayat-<?php echo e($tagihan['id']); ?>')" 
                        ...
                        <tr id="riwayat-<?php echo e($tagihan['id']); ?>" class="hidden">
                            <td colspan="7" class="px-6 py-4 bg-gray-50">
                                <?php if($tagihan['pembayaran']->count() > 0): ?>
                                    <div class="mb-3">
                                        <h6 class="font-medium text-gray-700 mb-2">Riwayat Pembayaran:</h6>
                                        <div class="space-y-2">
                                            <?php $__currentLoopData = $tagihan['pembayaran']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pembayaran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="flex justify-between items-center bg-white p-3 rounded border">
                                                    <div>
                                                        <div class="font-medium text-sm">Rp <?php echo e(number_format($pembayaran->jumlah, 0, ',', '.')); ?></div>
                                                        <div class="text-xs text-gray-500"><?php echo e(\Carbon\Carbon::parse($pembayaran->tanggal)->format('d/m/Y H:i')); ?></div>
                                                    </div>
                                                    <div>
                                                        <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full <?php echo e($pembayaran->status == 'Lunas' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>">
        ...
        <div class="mobile-cards p-3">
            <?php $__empty_1 = true; $__currentLoopData = $detailTagihan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tagihan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="mobile-financial-card">
                <div class="financial-header">
                    <div>
                        <div class="financial-title"><?php echo e($tagihan['nama_tagihan']); ?></div>
                        <?php if($tagihan['keterangan']): ?>
                            <div class="text-xs text-gray-500 mt-1"><?php echo e($tagihan['keterangan']); ?></div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="financial-details">
                    ...
                    <div class="financial-detail-item">
                        ...
                        <span class="financial-detail-value <?php echo e($tagihan['sisa'] > 0 ? 'text-red-600' : 'text-gray-500'); ?>">
                            Rp <?php echo e(number_format($tagihan['sisa'], 0, ',', '.')); ?>
                ...
                <div class="financial-actions">
                    <button onclick="toggleRiwayatMobile('riwayat-mobile-<?php echo e($tagihan['id']); ?>')"
                ...
                <div id="riwayat-mobile-<?php echo e($tagihan['id']); ?>" class="hidden mt-3 pt-3 border-t border-gray-200">
                    <?php if($tagihan['pembayaran']->count() > 0): ?>
                            ...
                            <?php $__currentLoopData = $tagihan['pembayaran']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pembayaran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="bg-gray-50 p-2 rounded border">
                                    <div class="flex justify-between items-center">
                                        <div>
                                            <div class="text-xs font-medium">Rp <?php echo e(number_format($pembayaran->jumlah, 0, ',', '.')); ?></div>
                                            <div class="text-xs text-gray-500"><?php echo e(\Carbon\Carbon::parse($pembayaran->tanggal)->format('d/m/Y H:i')); ?></div>
                                        </div>
                                        <span class="text-xs px-2 py-1 rounded-full <?php echo e($pembayaran->status == 'Lunas' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>">
                                            <?php echo e($pembayaran->status); ?>
...
<?php echo $__env->make('layouts.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\guru\wali-kelas\detail-keuangan.blade.php ENDPATH**/ ?>