            ...
            <div>
                ...
                <div class="mb-4">
                    ...
                    <select name="kategori" class="form-input w-full" required>
                        ...
                        <option value="aktivitas" <?php echo e(old('kategori') == 'aktivitas' ? 'selected' : ''); ?>>Kegiatan</option>
                        <option value="kompetisi" <?php echo e(old('kategori') == 'kompetisi' ? 'selected' : ''); ?>>Kompetisi</option>
            ...
            if (xhr.status === 200) {
                try {
                    ...
                    if (response.success) {
                        ...
                        setTimeout(() => {
                            window.location.href = '<?php echo e(route("admin.galeri.index")); ?>';
                        }, 1000);
                    } else {
