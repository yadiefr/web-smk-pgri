    ...
    <div class="w-full h-full">
        ...
        <nav class="mb-6">
            <ol class="flex items-center space-x-2 text-sm text-gray-600">
                ...
                <li><a href="<?php echo e(route('siswa.pengumuman.index')); ?>" class="hover:text-blue-600">Pengumuman</a></li>
                <li><i class="fas fa-chevron-right text-xs text-gray-400"></i></li>
...
<?php echo $__env->make('layouts.siswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\siswa\pengumuman\show.blade.php ENDPATH**/ ?>