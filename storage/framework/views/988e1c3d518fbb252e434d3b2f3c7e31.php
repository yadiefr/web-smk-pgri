                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 mapel-card">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900"><?php echo e($m->nama); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($m->kode_mapel ?? $m->kode ?? '-'); ?></td>
                    ...
                    <div class="flex items-center flex-1 min-w-0">
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            <p class="text-xs text-gray-500">
                                Kode: <?php echo e($m->kode_mapel ?? $m->kode ?? '-'); ?>
