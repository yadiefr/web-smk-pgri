    ...
    <div class="bg-white rounded-xl shadow-sm p-3 md:p-6 border border-gray-100 mb-4 md:mb-6">
        <div class="flex mobile-header md:items-center md:justify-between">
            ...
            <div class="mobile-header-actions md:flex md:space-x-3">
                <a href="<?php echo e(route('guru.materi.create-tugas')); ?>"
                ...
                <a href="<?php echo e(route('guru.materi.create-materi')); ?>"
        ...
        <div class="mobile-stat-card bg-white rounded-xl p-3 md:p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow content-card">
            <div class="flex items-center">
                ...
                <div class="ml-3 md:ml-4">
                    ...
                    <div class="flex items-center">
                        <h3 class="text-lg md:text-2xl font-bold text-gray-800"><?php echo e($materi->total() ?? 0); ?></h3>
        ...
        <div class="mobile-stat-card bg-white rounded-xl p-3 md:p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow content-card">
            <div class="flex items-center">
                ...
                <div class="ml-3 md:ml-4">
                    ...
                    <div class="flex items-center">
                        <h3 class="text-lg md:text-2xl font-bold text-gray-800"><?php echo e($tugas->total() ?? 0); ?></h3>
        ...
        <div class="mobile-stat-card bg-white rounded-xl p-3 md:p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow content-card">
            <div class="flex items-center">
                ...
                <div class="ml-3 md:ml-4">
                    ...
                    <div class="flex items-center">
                        <h3 class="text-lg md:text-2xl font-bold text-gray-800"><?php echo e($kelasList->count() ?? 0); ?></h3>
        ...
        <div class="mobile-stat-card bg-white rounded-xl p-3 md:p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow content-card">
            <div class="flex items-center">
                ...
                <div class="ml-3 md:ml-4">
                    ...
                    <div class="flex items-center">
                        <h3 class="text-lg md:text-2xl font-bold text-gray-800"><?php echo e($mapelList->count() ?? 0); ?></h3>
                                ...
                                <div class="flex mobile-content-header md:items-start md:justify-between">
                                    <div class="flex-1">
                                        <div class="flex items-start md:items-center mb-2 mobile-content-badges">
                                            <h3 class="mobile-content-title text-base md:text-lg font-semibold text-gray-900 mr-2"><?php echo e($item->judul); ?></h3>
                                        ...
                                        <p class="text-sm md:text-base text-gray-600 mb-3"><?php echo e(Str::limit($item->deskripsi, 150)); ?></p>
                                        <div class="flex mobile-content-meta md:items-center text-sm text-gray-500 md:space-x-4">
                                            <span><i class="fas fa-users mr-1"></i> <?php echo e($item->kelas->nama_kelas ?? '-'); ?></span>
                                            <span><i class="fas fa-book mr-1"></i> <?php echo e($item->mapel->nama ?? '-'); ?></span>
                                            <span><i class="fas fa-calendar mr-1"></i> <?php echo e($item->created_at->format('d M Y')); ?></span>
                                        </div>
                                    </div>
                                    <div class="mobile-content-actions">
                                        <!-- Essential actions always visible -->
                                        <a href="<?php echo e(route('guru.materi.show-materi', $item->id)); ?>"
                                        ...
                                        <a href="<?php echo e(route('guru.materi.edit-materi', $item->id)); ?>"
                                        ...
                                        <?php if($item->link_video): ?>
                                            <a href="<?php echo e($item->link_video); ?>" target="_blank"
                                        ...
                                        <form action="<?php echo e(route('guru.materi.delete-materi', $item->id)); ?>" method="POST" class="mobile-essential">
                                            <?php echo csrf_field(); ?>
                                ...
                                <div class="flex mobile-content-header md:items-start md:justify-between">
                                    <div class="flex-1">
                                        ...
                                        <div class="flex mobile-content-meta md:items-center text-sm text-gray-500 md:space-x-4">
                                            <span><i class="fas fa-users mr-1"></i> <?php echo e($item->kelas->nama_kelas ?? '-'); ?></span>
                                            <span><i class="fas fa-book mr-1"></i> <?php echo e($item->mapel->nama ?? '-'); ?></span>
                                            <span><i class="fas fa-calendar-alt mr-1"></i> <span class="hidden sm:inline">Deadline: </span><?php echo e($deadline->format('d M Y')); ?></span>
                                        </div>
                                    </div>
                                    <div class="mobile-content-actions">
                                        <!-- Essential actions for mobile -->
                                        <a href="<?php echo e(route('guru.materi.show-tugas', $item->id)); ?>"
                                           class="mobile-essential action-btn px-2 md:px-3 py-1 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 transition-colors text-xs md:text-sm">
                                            <i class="fas fa-info-circle"></i><span class="hidden md:inline ml-1">Detail</span>
                                        </a>
                                        <a href="<?php echo e(route('guru.materi.tugas-submissions', $item->id)); ?>"
                                           class="mobile-essential action-btn px-2 md:px-3 py-1 bg-green-100 text-green-700 rounded-lg hover:bg-green-200 transition-colors text-xs md:text-sm">
                                            <i class="fas fa-eye"></i><span class="hidden md:inline ml-1">Jawaban</span>
                                        </a>
                                        <a href="<?php echo e(route('guru.materi.edit-tugas', $item->id)); ?>"
                                           class="mobile-essential action-btn px-2 md:px-3 py-1 bg-yellow-100 text-yellow-700 rounded-lg hover:bg-yellow-200 transition-colors text-xs md:text-sm">
                                            <i class="fas fa-edit"></i><span class="hidden md:inline ml-1">Edit</span>
                                        </a>
                                        ...
                                        <!-- Delete button - always visible -->
                                        <form action="<?php echo e(route('guru.materi.delete-tugas', $item->id)); ?>" method="POST" class="mobile-essential">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
...
<?php echo $__env->make('layouts.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\guru\materi\index.blade.php ENDPATH**/ ?>