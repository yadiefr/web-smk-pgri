...
<?php $__env->startSection('title', 'Pendaftaran Ditutup - SMK PGRI CIKAMPEK'); ?>
...
<div class="ppdb-card">
    ...
    <?php if($ppdb_start_date && $ppdb_end_date): ?>
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body p-4 text-center">
                <span class="badge bg-primary px-4 py-3 rounded-pill fs-6 d-inline-flex align-items-center">
                    ...
                    <?php echo e(\Carbon\Carbon::parse($ppdb_start_date)->format('d F Y')); ?> - <?php echo e(\Carbon\Carbon::parse($ppdb_end_date)->format('d F Y')); ?>
    ...
    <div class="help-section mt-4">
        ...
        <div class="d-flex flex-column flex-md-row gap-3">
            <a href="<?php echo e(route('pendaftaran.check')); ?>" class="btn btn-ppdb flex-grow-1">
...
<?php echo $__env->make('layouts.app-ppdb', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\ppdb\closed.blade.php ENDPATH**/ ?>