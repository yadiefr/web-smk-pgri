                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <?php if(count($jam_slots) > 0): ?>
                                ...
                                <tr class="hover:bg-gray-50 <?php echo e($isBreakTime ? 'bg-amber-50' : ''); ?>">
                                    <td class="px-3 py-3 text-sm font-bold text-gray-900 border-r border-gray-200 bg-gray-50 sticky left-0 <?php echo e($isBreakTime ? 'bg-amber-100' : ''); ?>">
                                        <div class="flex flex-col" data-time-slot="<?php echo e($jam_key); ?>" data-jam-ke="<?php echo e($all_time_slots[$jam_key]['jam_ke'] ?? ''); ?>" data-is-break="<?php echo e(isset($all_time_slots[$jam_key]['is_break']) && $all_time_slots[$jam_key]['is_break'] ? 'true' : 'false'); ?>">
                                            <span class="text-sm font-semibold"><?php echo e($jam_key); ?></span>
                                            <span class="text-xs text-gray-500">
                                                <?php if($isBreakTime): ?>
                                                    <span class="text-amber-600 font-medium"><i class="fas fa-coffee mr-1"></i><?php echo e($breakLabel); ?></span>
                                                <?php else: ?>
                                                    <?php
                ...
                <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                        <div class="bg-white p-3 rounded-lg shadow-sm">
                            <div class="text-2xl font-bold text-blue-600"><?php echo e($jadwal_pelajaran->count()); ?></div>
                            <div class="text-xs text-gray-500">Total Jadwal</div>
                        </div>
                        <div class="bg-white p-3 rounded-lg shadow-sm">
                            <div class="text-2xl font-bold text-green-600"><?php echo e($jadwal_pelajaran->where('is_active', true)->count()); ?></div>
                            <div class="text-xs text-gray-500">Jadwal Aktif</div>
                        </div>
                        <div class="bg-white p-3 rounded-lg shadow-sm">
                            <div class="text-2xl font-bold text-purple-600"><?php echo e($kelas_list->count()); ?></div>
                            <div class="text-xs text-gray-500">Total Kelas</div>
                        </div>
                        <div class="bg-white p-3 rounded-lg shadow-sm">
                            <div class="text-2xl font-bold text-orange-600"><?php echo e($jadwal_pelajaran->pluck('mapel_id')->unique()->count()); ?></div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\admin\jadwal\backup index.blade.php ENDPATH**/ ?>