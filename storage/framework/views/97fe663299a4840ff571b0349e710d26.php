...
<head>
    ...
    <link href="<?php echo e(asset('css/guru-layout.css')); ?>?v=<?php echo e(time()); ?>" rel="stylesheet">
    ...
    <script src="<?php echo e(asset('js/guru-layout.js')); ?>?v=<?php echo e(time()); ?>"></script>
                            ...
                            <button @click="open = !open" class="flex items-center space-x-1 sm:space-x-2 focus:outline-none p-1" id="user-menu-button">
                                <div class="hidden md:block">
                                    <div class="flex flex-col items-end">
                                        <span class="text-xs sm:text-sm font-medium text-gray-800 truncate max-w-16 sm:max-w-24 lg:max-w-none"><?php echo e(auth()->user()->name ?? 'Guru'); ?></span>
