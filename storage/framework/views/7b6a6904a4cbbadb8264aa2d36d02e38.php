...
<?php $__env->startSection('title', 'Pengaturan Ujian'); ?>
    ...
    <div class="mt-8 bg-white rounded-lg shadow-md">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <a href="<?php echo e(route('admin.ujian.bank-soal.index')); ?>" 
...
<?php echo $__env->make('layouts.ujian', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\admin\ujian\pengaturan.blade.php ENDPATH**/ ?>