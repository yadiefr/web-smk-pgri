        ...
        <div class="bg-gradient-to-r from-blue-500 to-blue-600 p-6 rounded-xl text-white shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold mt-1"><?php echo e($tagihan->total() ?? 0); ?></p>
                </div>
        ...
        <div class="bg-gradient-to-r from-green-500 to-green-600 p-6 rounded-xl text-white shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold mt-1"><?php echo e($tagihan->where('status_pembayaran', 'lunas')->count() ?? 0); ?></p>
                </div>
        ...
        <div class="bg-gradient-to-r from-yellow-500 to-yellow-600 p-6 rounded-xl text-white shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold mt-1"><?php echo e($tagihan->where('status_pembayaran', 'belum_bayar')->count() ?? 0); ?></p>
                </div>
        ...
        <div class="bg-gradient-to-r from-red-500 to-red-600 p-6 rounded-xl text-white shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold mt-1"><?php echo e($tagihan->where('status_pembayaran', 'terlambat')->count() ?? 0); ?></p>
                </div>
        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2 text-sm text-gray-600">
                    <span>Menampilkan <?php echo e($tagihan->firstItem() ?? 0); ?> - <?php echo e($tagihan->lastItem() ?? 0); ?> dari <?php echo e($tagihan->total() ?? 0); ?> data</span>
                </div>
            </div>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $tagihan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <?php echo e(($tagihan->currentPage() - 1) * $tagihan->perPage() + $loop->iteration); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <?php echo e(\Carbon\Carbon::parse($item->tanggal_jatuh_tempo ?? now()->addDays(30))->format('d/m/Y')); ?>
...
<?php echo $__env->make('layouts.tata_usaha', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\tata_usaha\keuangan\tagihan.blade.php ENDPATH**/ ?>