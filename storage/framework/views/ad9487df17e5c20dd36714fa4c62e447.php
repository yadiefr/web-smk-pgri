...
<body>
    <table border="0" cellpadding="0" cellspacing="0" class="gridlines sheet0">
        ...
        <tr>
            ...
            <td class="info-label" colspan="3"><?php echo e(\Carbon\Carbon::parse($tanggalMulai)->locale('id')->translatedFormat('l, d F Y')); ?><?php echo e($tanggalMulai != $tanggalAkhir ? ' - ' . \Carbon\Carbon::parse($tanggalAkhir)->locale('id')->translatedFormat('l, d F Y') : ''); ?></td>
        </tr>
        <tr>
            <td colspan="5">&nbsp;</td>
        </tr>
        ...
        <tr>
            <td class="table-data" style="width: 40px; text-align: center; padding: 5px 0; border: 1px solid #000000 !important;"><?php echo e($index + 1); ?></td>
            <td class="table-data-left" style="width: 180px; text-align: left; padding: 5px 0; border: 1px solid #000000 !important;"><?php echo e($data->siswa->nama_lengkap); ?></td>
            <td class="table-data" style="width: 80px; text-align: center; padding: 5px 0; border: 1px solid #000000 !important;"><?php echo e($data->kelas->nama_kelas); ?></td>
            <td class="table-data" style="width: 60px; text-align: center; padding: 5px 0; border: 1px solid #000000 !important;"><?php echo e($data->jam_terlambat); ?></td>
            <td class="table-data-left" style="width: 200px; text-align: center; padding: 5px 0; border: 1px solid #000000 !important;"><?php echo e($data->alasan_terlambat ?? '-'); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        
        <!-- Fill empty rows if less than 10 (more reasonable minimum) -->
        <?php for($i = count($rekapData); $i < 10; $i++): ?>
        <tr>
...
</html><?php /**PATH C:\wamp64\www\website-smk3\resources\views\kesiswaan\keterlambatan\export.blade.php ENDPATH**/ ?>