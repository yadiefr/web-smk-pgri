                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <select id="modal_mapel_id" name="mapel_id" required 
                                        ...
                                        <?php $__currentLoopData = $mapel_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($m->id); ?>">
                                                <?php echo e($m->nama); ?> <?php echo e($m->jurusan ? '(' . $m->jurusan->nama . ')' : ''); ?>
                                ...
                                <div>
                                    ...
                                    <select id="modal_guru_id" name="guru_id" required
                                        ...
                                        <?php $__currentLoopData = $guru_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</div><?php /**PATH C:\wamp64\www\website-smk3\resources\views\admin\jadwal\_modal_jadwal.blade.php ENDPATH**/ ?>