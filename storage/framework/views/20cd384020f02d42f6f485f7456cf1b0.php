    ...
    <div class="bg-white shadow rounded-lg p-4 sm:p-6 mb-6">
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
            ...
            <div class="w-full lg:w-auto">
                <form method="GET" action="<?php echo e(route('siswa.bendahara.laporan-kas')); ?>" class="flex flex-col sm:flex-row flex-wrap gap-2">
        ...
        <div class="mt-4 text-xs sm:text-sm text-gray-600">
            ...
            <span class="block sm:inline mt-1 sm:mt-0"><?php echo e($tanggalMulai->locale('id')->format('d F Y')); ?> - <?php echo e($tanggalSelesai->locale('id')->format('d F Y')); ?></span>
        </div>
    </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-3 sm:ml-4 min-w-0 flex-1">
                    ...
                    <p class="text-lg sm:text-2xl font-semibold text-green-900 truncate">
                        Rp <?php echo e(number_format($totalKasMasukPeriode, 0, ',', '.')); ?>

                    </p>
                    <p class="text-xs text-green-600 truncate"><?php echo e($kasMasuk->count()); ?> transaksi</p>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-3 sm:ml-4 min-w-0 flex-1">
                    ...
                    <p class="text-lg sm:text-2xl font-semibold text-red-900 truncate">
                        Rp <?php echo e(number_format($totalKasKeluarPeriode, 0, ',', '.')); ?>

                    </p>
                    <p class="text-xs text-red-600 truncate"><?php echo e($kasKeluar->count()); ?> transaksi</p>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-3 sm:ml-4 min-w-0 flex-1">
                    ...
                    <p class="text-lg sm:text-2xl font-semibold text-blue-900 truncate">
                        Rp <?php echo e(number_format($saldoKeseluruhan, 0, ',', '.')); ?>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                <div class="flex-1 min-w-0">
                                    <p class="font-medium text-gray-900 text-sm sm:text-base truncate"><?php echo e($data['kategori']); ?></p>
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                ...
                                <span class="font-semibold text-gray-900 text-sm sm:text-base">Rp <?php echo e(number_format($saldoAwal, 0, ',', '.')); ?></span>
                            </div>
                            <div class="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                                <span class="font-medium text-green-700 text-sm sm:text-base">Total Kas Masuk</span>
                                <span class="font-semibold text-green-900 text-sm sm:text-base">Rp <?php echo e(number_format($totalKasMasukPeriode, 0, ',', '.')); ?></span>
                            </div>
                            <div class="flex justify-between items-center p-3 bg-red-50 rounded-lg">
                                <span class="font-medium text-red-700 text-sm sm:text-base">Total Kas Keluar</span>
                                <span class="font-semibold text-red-900 text-sm sm:text-base">Rp <?php echo e(number_format($totalKasKeluarPeriode, 0, ',', '.')); ?></span>
                            </div>
                            <div class="flex justify-between items-center p-3 bg-blue-50 rounded-lg border-t-2 border-blue-200">
                                ...
                                <span class="font-semibold <?php echo e($saldoPeriode >= 0 ? 'text-green-900' : 'text-red-900'); ?> text-sm sm:text-base">
...
<?php echo $__env->make('layouts.siswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\siswa\bendahara\laporan-kas.blade.php ENDPATH**/ ?>