...
<body>
    <table border="0" cellpadding="0" cellspacing="0" class="gridlines sheet0">
        ...
        <tr>
            <td colspan="6" class="subtitle" style="text-align: center; padding: 10px 0;">TAHUN AJARAN <?php echo e(date('Y')); ?>-<?php echo e(date('Y') + 1); ?></td>
        </tr>
        <tr>
            <td colspan="6">&nbsp;</td>
        </tr>
        ...
        <tr>
            <td>&nbsp;</td>
            <td class="info-label" colspan="5" style="text-align: left; padding: 4px;">PERIODE : <?php echo e(\Carbon\Carbon::parse($tanggalMulai)->locale('id')->translatedFormat('d F Y')); ?> s/d <?php echo e(\Carbon\Carbon::parse($tanggalAkhir)->locale('id')->translatedFormat('d F Y')); ?></td>
        </tr>
        <tr>
            <td colspan="6">&nbsp;</td>
        </tr>
        ...
        <tr>
            ...
            <td class="table-data-center" style="width: 100px; text-align: center; vertical-align: middle; border: 1px solid #000000 !important; padding: 4px;"><?php echo e(\Carbon\Carbon::parse($data->tanggal)->format('d/m/Y')); ?></td>
...
</html><?php /**PATH C:\wamp64\www\website-smk3\resources\views\kesiswaan\keterlambatan\export-periode.blade.php ENDPATH**/ ?>