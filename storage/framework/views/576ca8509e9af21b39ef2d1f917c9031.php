...
<div id="assign-subjects-app" class="w-full px-3 py-4">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100">
            ...
            <div class="p-6">
                <form id="assignment-form" action="<?php echo e(route('admin.guru.store-subject-assignment', $guru)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="mapel_id" id="mapel_id" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                            ...
                            <?php $__currentLoopData = $availableSubjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($subject->id); ?>" <?php echo e(old('mapel_id') == $subject->id ? 'selected' : ''); ?>>
                        ...
                        <div class="border border-gray-300 rounded-lg p-3 max-h-80 overflow-y-auto">
                            <?php $__currentLoopData = $availableClasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="flex items-center mb-2 cursor-pointer hover:bg-gray-50 p-2 rounded transition-all">
                                    <input type="checkbox" name="kelas_id[]" value="<?php echo e($class->id); ?>" 
                                        <?php echo e(in_array($class->id, old('kelas_id', [])) ? 'checked' : ''); ?>

                                        class="class-checkbox mr-3 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                    <span class="text-sm text-gray-700">
                                        <?php echo e($class->nama_kelas ?? 'Kelas tidak diketahui'); ?> - <?php echo e($class->jurusan->nama_jurusan ?? $class->jurusan->nama ?? 'Jurusan tidak diketahui'); ?>
                ...
                <div id="assignments-container">
                    <?php if($assignedSubjects->count() > 0): ?>
                        <div class="space-y-4" id="assignments-list">
                            <?php $__currentLoopData = $assignedSubjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jadwal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($jadwal->mapel && $jadwal->kelas): ?>
                                <div class="bg-gray-50 rounded-lg border border-gray-200 p-4 assignment-item" data-id="<?php echo e($jadwal->id); ?>">
                                    <div class="flex justify-between items-start">
                                        <div class="flex-1">
                                            <div class="flex items-center gap-2 mb-1">
                                                <h4 class="font-medium text-gray-800">
                                                    <?php echo e($jadwal->mapel->nama ?? 'Mata pelajaran tidak diketahui'); ?>

                                                </h4>
                                                <?php if($jadwal->hari && $jadwal->jam_ke): ?>
                                            ...
                                            <p class="text-sm text-gray-600 mb-2">
                                                ...
                                                <?php echo e($jadwal->kelas->nama_kelas ?? 'Kelas tidak diketahui'); ?> - <?php echo e($jadwal->kelas->jurusan->nama_jurusan ?? $jadwal->kelas->jurusan->nama ?? 'Jurusan tidak diketahui'); ?>

                                            </p>
                                            <?php if($jadwal->hari && $jadwal->jam_ke): ?>
                                                <p class="text-sm text-gray-600 mb-1">
                                                    <i class="fas fa-calendar mr-1"></i>
                                                    <?php echo e($jadwal->hari); ?>, Jam ke-<?php echo e($jadwal->jam_ke); ?>
                                        ...
                                        <button type="button" onclick="removeAssignment(<?php echo e($jadwal->id); ?>)" class="text-red-600 hover:text-red-800 p-2 rounded-lg hover:bg-red-50 transition-all ml-4 delete-btn">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.removeAssignment = function(assignmentId) {
        ...
        fetch(`<?php echo e(route('admin.guru.remove-subject-assignment', [$guru->id, ':id'])); ?>`.replace(':id', assignmentId), {
            method: 'DELETE',
            headers: {
                'X-Requested-With': 'XMLHttpRequest',
                'X-CSRF-TOKEN': csrfToken,
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\admin\guru\assign-subjects.blade.php ENDPATH**/ ?>