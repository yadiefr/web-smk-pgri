...
<?php $__env->startSection('title', 'Edit Jenis Ujian'); ?>
...
<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">Perbarui informasi jenis ujian: <?php echo e($jenisUjian->nama); ?></p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-md">
        ...
        <form action="<?php echo e(route('admin.ujian.pengaturan.jenis-ujian.update', $jenisUjian)); ?>" method="POST" class="p-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-1">
                    ...
                    <input type="text" 
                           id="nama" 
                           name="nama" 
                           value="<?php echo e(old('nama', $jenisUjian->nama)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="md:col-span-1">
                    ...
                    <input type="text" 
                           id="kode" 
                           name="kode" 
                           value="<?php echo e(old('kode', $jenisUjian->kode)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                              placeholder="Deskripsi singkat tentang jenis ujian ini..."><?php echo e(old('deskripsi', $jenisUjian->deskripsi)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="md:col-span-1">
                    ...
                    <input type="number" 
                           id="durasi_default" 
                           name="durasi_default" 
                           value="<?php echo e(old('durasi_default', $jenisUjian->durasi_default)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="md:col-span-1">
                    ...
                    <input type="number" 
                           id="urutan" 
                           name="urutan" 
                           value="<?php echo e(old('urutan', $jenisUjian->urutan)); ?>"
                ...
                <div class="md:col-span-2">
                    <div class="flex items-center">
                        ...
                        <input type="checkbox" 
                               ...
                               name="is_active" 
                               value="1"
                               <?php echo e(old('is_active', $jenisUjian->is_active) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.ujian', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\admin\ujian\pengaturan\jenis-ujian\edit.blade.php ENDPATH**/ ?>