...
<div class="w-full px-6 py-6">
        ...
        <div class="text-sm breadcrumbs">
            <ul class="flex items-center space-x-2 text-gray-500">
                ...
                <li class="flex items-center space-x-2">
                    ...
                    <a href="<?php echo e(route('siswa.absensi')); ?>" class="hover:text-blue-600">Kehadiran</a>
                </li>
                <li class="flex items-center space-x-2">
                    <span class="text-gray-400">/</span>
                    <span>Detail</span>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        ...
        <div class="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-blue-100">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="text-xl font-semibold text-gray-800"><?php echo e($absensi->mapel->nama ?? 'Mata Pelajaran Tidak Ditemukan'); ?></h2>
                        <p class="text-sm text-gray-600"><?php echo e(\Carbon\Carbon::parse($absensi->tanggal)->locale('id')->translatedFormat('l, d F Y')); ?></p>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    <div class="bg-gray-50 rounded-lg p-4">
                        <div class="flex justify-between items-center border-b border-gray-200 pb-2 mb-2">
                            ...
                            <span class="font-semibold"><?php echo e($absensi->mapel->nama ?? 'Mata Pelajaran Tidak Ditemukan'); ?></span>
                        </div>
                        <div class="flex justify-between items-center border-b border-gray-200 pb-2 mb-2">
                            <span class="font-medium text-gray-600">Guru Pengajar:</span>
                            <span class="font-semibold"><?php echo e($absensi->guru->nama ?? 'Guru Tidak Ditemukan'); ?></span>
                        </div>
                        <div class="flex justify-between items-center border-b border-gray-200 pb-2 mb-2">
                            <span class="font-medium text-gray-600">Kelas:</span>
                            <span class="font-semibold"><?php echo e($absensi->kelas->nama_kelas ?? 'Tidak ada kelas'); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="font-medium text-gray-600">Tanggal:</span>
                            <span class="font-semibold"><?php echo e(\Carbon\Carbon::parse($absensi->tanggal)->locale('id')->translatedFormat('l, d F Y')); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-4">
                    <div class="bg-gray-50 rounded-lg p-4">
                        ...
                        <div class="border-b border-gray-200 pb-2 mb-2">
                            ...
                            <span class="text-gray-800 bg-yellow-50 p-2 rounded border-l-4 border-yellow-400 block"><?php echo e($absensi->keterangan); ?></span>
                        </div>
                        <?php endif; ?>
                        <div class="flex justify-between items-center border-b border-gray-200 pb-2 mb-2">
                            <span class="font-medium text-gray-600">Waktu Input:</span>
                            <span class="font-semibold"><?php echo e($absensi->created_at->locale('id')->translatedFormat('d/m/Y H:i')); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="font-medium text-gray-600">Terakhir Update:</span>
                            <span class="font-semibold"><?php echo e($absensi->updated_at->locale('id')->translatedFormat('d/m/Y H:i')); ?></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="px-6 py-4 bg-gray-50 border-t border-gray-100 rounded-b-xl">
            <div class="flex justify-between items-center">
                <a href="<?php echo e(route('siswa.absensi')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors">
...
function printDetail() {
    ...
    const content = `
        <html>
            <head>
                <title>Detail Kehadiran - <?php echo e($absensi->mapel->nama ?? 'Mata Pelajaran Tidak Ditemukan'); ?></title>
                <style>
            ...
            <body>
                ...
                <div class="info-grid">
                    <div class="info-box">
                        ...
                        <div class="info-row">
                            ...
                            <span class="value"><?php echo e(Auth::guard('siswa')->user()->nama_lengkap); ?></span>
                        </div>
                        <div class="info-row">
                            <span class="label">Kelas:</span>
                            <span class="value"><?php echo e(Auth::guard('siswa')->user()->kelas->nama_kelas ?? 'Tidak ada kelas'); ?></span>
                        </div>
                        <div class="info-row">
                            <span class="label">NIS:</span>
                            <span class="value"><?php echo e(Auth::guard('siswa')->user()->nis); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="info-box">
                        ...
                        <div class="info-row">
                            ...
                            <span class="value"><?php echo e($absensi->mapel->nama ?? 'Mata Pelajaran Tidak Ditemukan'); ?></span>
                        </div>
                        <div class="info-row">
                            <span class="label">Guru Pengajar:</span>
                            <span class="value"><?php echo e($absensi->guru->nama ?? 'Guru Tidak Ditemukan'); ?></span>
                        </div>
                        <div class="info-row">
                            <span class="label">Tanggal:</span>
                            <span class="value"><?php echo e(\Carbon\Carbon::parse($absensi->tanggal)->locale('id')->translatedFormat('l, d F Y')); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-row">
                        ...
                        <span class="status status-<?php echo e($absensi->status); ?>"><?php echo e(ucfirst($absensi->status)); ?></span>
                    </div>
                    <?php if($absensi->keterangan): ?>
                    <div class="info-row">
                        <span class="label">Keterangan:</span>
                        <span class="value"><?php echo e($absensi->keterangan); ?></span>
                    </div>
                    <?php endif; ?>
                    <div class="info-row">
                        <span class="label">Waktu Input:</span>
                        <span class="value"><?php echo e($absensi->created_at->locale('id')->translatedFormat('d/m/Y H:i')); ?></span>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.siswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\siswa\absensi\show.blade.php ENDPATH**/ ?>