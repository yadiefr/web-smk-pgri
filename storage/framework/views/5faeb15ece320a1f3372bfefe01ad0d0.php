...
<?php $__env->startSection('title', 'Edit Data Siswa - SMK PGRI CIKAMPEK'); ?>
...
<div class="bg-white rounded-xl shadow-md p-6 mb-6">
    <div class="flex flex-col space-y-6">
            ...
            <div class="relative z-10">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Edit data siswa: <span class="font-medium"><?php echo e($siswa->nama_lengkap); ?></span></p>
                    </div>
                    <div class="mt-4 md:mt-0 flex space-x-3">
                        <a href="<?php echo e(route('admin.siswa.show', $siswa->id)); ?>" class="bg-blue-100 hover:bg-blue-200 text-blue-700 px-5 py-2.5 rounded-lg shadow-sm hover:shadow-md transition-all flex items-center">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden p-6">
            ...
            <form action="<?php echo e(route('admin.siswa.update', $siswa->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="border-b pb-4 mb-4">
                            <h2 class="text-lg font-semibold text-gray-800 mb-5">Data Pribadi</h2>
                              ...
                              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">                                <div>
                                    ...
                                    <input type="text" name="nis" id="nis" value="<?php echo e(old('nis', $siswa->nis)); ?>" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm <?php echo e($errors->has('nis') ? 'border-red-300' : 'border-gray-300'); ?> rounded-md" placeholder="Masukkan NIS">
                                    <?php $__errorArgs = ['nis'];
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="nisn" id="nisn" value="<?php echo e(old('nisn', $siswa->nisn)); ?>" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm <?php echo e($errors->has('nisn') ? 'border-red-300' : 'border-gray-300'); ?> rounded-md" placeholder="Masukkan NISN">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">                                <div>
                                    ...
                                    <input type="text" name="nama_lengkap" id="nama_lengkap" value="<?php echo e(old('nama_lengkap', $siswa->nama_lengkap)); ?>" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm <?php echo e($errors->has('nama_lengkap') ? 'border-red-300' : 'border-gray-300'); ?> rounded-md" placeholder="Masukkan nama lengkap">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <select name="jenis_kelamin" id="jenis_kelamin" class="mt-1 block w-full py-2 px-3 <?php echo e($errors->has('jenis_kelamin') ? 'border-red-300' : 'border-gray-300'); ?> bg-white rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                <div>
                                    ...
                                    <input type="text" name="tempat_lahir" id="tempat_lahir" value="<?php echo e($siswa->tempat_lahir); ?>" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Tempat lahir">
                                </div>
                                
                                <div>
                                    <label for="tanggal_lahir" class="block text-sm font-medium text-gray-700 mb-1">Tanggal Lahir</label>
                                    <input type="date" name="tanggal_lahir" id="tanggal_lahir" value="<?php echo e($siswa->tanggal_lahir); ?>" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                </div>
                            </div>

                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">                                <div>
                                    <label for="email" class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                                    <input type="email" name="email" id="email" value="<?php echo e(old('email', $siswa->email)); ?>" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm <?php echo e($errors->has('email') ? 'border-red-300' : 'border-gray-300'); ?> rounded-md" placeholder="contoh@email.com">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <select name="agama" id="agama" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        ...
                                        <option value="Katolik" <?php echo e($siswa->agama == 'Katolik' ? 'selected' : ''); ?>>Katolik</option>
                                        <option value="Hindu" <?php echo e($siswa->agama == 'Hindu' ? 'selected' : ''); ?>>Hindu</option>
                                        <option value="Buddha" <?php echo e($siswa->agama == 'Buddha' ? 'selected' : ''); ?>>Buddha</option>
                                        <option value="Konghucu" <?php echo e($siswa->agama == 'Konghucu' ? 'selected' : ''); ?>>Konghucu</option>
                                    </select>
                                </div>
                            </div>                            <div class="mt-4">
                                <label for="telepon" class="block text-sm font-medium text-gray-700 mb-1">Nomor Telepon</label>
                                <input type="tel" name="telepon" id="telepon" value="<?php echo e($siswa->telepon); ?>" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="08xxxxxxxxxx">
                            </div>
                            
                            <div class="mt-4">
                                <label for="alamat" class="block text-sm font-medium text-gray-700 mb-1">Alamat</label>
                                <textarea name="alamat" id="alamat" rows="3" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Alamat lengkap"><?php echo e($siswa->alamat); ?></textarea>
                            </div>
                        </div>
                            ...
                            <h2 class="text-lg font-semibold text-gray-800 mb-5">Data Orang Tua</h2>
                              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="nama_ayah" id="nama_ayah" value="<?php echo e($siswa->nama_ayah); ?>" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Nama ayah">
                                </div>
                                
                                <div>
                                    <label for="pekerjaan_ayah" class="block text-sm font-medium text-gray-700 mb-1">Pekerjaan Ayah</label>
                                    <input type="text" name="pekerjaan_ayah" id="pekerjaan_ayah" value="<?php echo e($siswa->pekerjaan_ayah); ?>" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Pekerjaan ayah">
                                </div>
                            </div>
                            
                            <div class="mt-4">
                                <label for="no_telp_ayah" class="block text-sm font-medium text-gray-700 mb-1">No. Telepon Ayah</label>
                                <input type="tel" name="no_telp_ayah" id="no_telp_ayah" value="<?php echo e($siswa->no_telp_ayah); ?>" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="08xxxxxxxxxx">
                            </div>
                            
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                <div>
                                    <label for="nama_ibu" class="block text-sm font-medium text-gray-700 mb-1">Nama Ibu</label>
                                    <input type="text" name="nama_ibu" id="nama_ibu" value="<?php echo e($siswa->nama_ibu); ?>" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Nama ibu">
                                </div>
                                
                                <div>
                                    <label for="pekerjaan_ibu" class="block text-sm font-medium text-gray-700 mb-1">Pekerjaan Ibu</label>
                                    <input type="text" name="pekerjaan_ibu" id="pekerjaan_ibu" value="<?php echo e($siswa->pekerjaan_ibu); ?>" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Pekerjaan ibu">
                                </div>
                            </div>
                            
                            <div class="mt-4">
                                <label for="no_telp_ibu" class="block text-sm font-medium text-gray-700 mb-1">No. Telepon Ibu</label>
                                <input type="tel" name="no_telp_ibu" id="no_telp_ibu" value="<?php echo e($siswa->no_telp_ibu); ?>" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="08xxxxxxxxxx">
                            </div>

                            <div class="mt-4">
                                <label for="alamat_orangtua" class="block text-sm font-medium text-gray-700 mb-1">Alamat Orang Tua</label>
                                <textarea name="alamat_orangtua" id="alamat_orangtua" rows="2" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Alamat orang tua"><?php echo e($siswa->alamat_orangtua); ?></textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="border-b pb-4 mb-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">                                
                                ...
                                <div>
                                    ...
                                    <select name="kelas_id" id="kelas" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" required>
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $kelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <option value="<?php echo e($k->id); ?>" <?php echo e(old('kelas_id', $siswa->kelas_id) == $k->id ? 'selected' : ''); ?>><?php echo e($k->nama_kelas); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="tahun_masuk" id="tahun_masuk" value="<?php echo e($siswa->tahun_masuk); ?>" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="2023">
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="status" id="status" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        <option value="aktif" <?php echo e($siswa->status == 'aktif' ? 'selected' : ''); ?>>Aktif</option>
                                        <option value="tidak_aktif" <?php echo e($siswa->status == 'tidak_aktif' ? 'selected' : ''); ?>>Tidak Aktif</option>
                                        <option value="lulus" <?php echo e($siswa->status == 'lulus' ? 'selected' : ''); ?>>Lulus</option>
                                        <option value="pindah" <?php echo e($siswa->status == 'pindah' ? 'selected' : ''); ?>>Pindah</option>
                                    </select>
                                </div>                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\admin\siswa\edit.blade.php ENDPATH**/ ?>