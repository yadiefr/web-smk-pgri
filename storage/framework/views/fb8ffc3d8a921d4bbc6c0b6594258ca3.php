...
<?php $__env->startSection('title', 'Manajemen Jurusan - SMK PGRI CIKAMPEK'); ?>
...
<div class="p-6">
    ...
    <div class="flex justify-end mb-4">
        <a href="<?php echo e(route('admin.jurusan.create')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors shadow">
        ...
        <div class="bg-white/80 backdrop-blur-lg border border-blue-200 rounded-xl p-4 text-blue-600 shadow-sm hover:shadow-lg transition-all relative group overflow-hidden">
            ...
            <div class="relative flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold"><?php echo e($jurusan->count()); ?></p>
                </div>
        ...
        <div class="bg-white/80 backdrop-blur-lg border border-red-200 rounded-xl p-4 text-red-600 shadow-sm hover:shadow-lg transition-all relative group overflow-hidden">
            ...
            <div class="relative flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold"><?php echo e($jurusan->sum(function($j) { return $j->siswa ? $j->siswa->count() : 0; })); ?></p>
                </div>
        ...
        <div class="bg-white/80 backdrop-blur-lg border border-green-200 rounded-xl p-4 text-green-600 shadow-sm hover:shadow-lg transition-all relative group overflow-hidden">
            ...
            <div class="relative flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold"><?php echo e($jurusan->sum(function($j) { return $j->kelas ? $j->kelas->count() : 0; })); ?></p>
                </div>
        ...
        <div class="bg-white/80 backdrop-blur-lg border border-amber-200 rounded-xl p-4 text-amber-600 shadow-sm hover:shadow-lg transition-all relative group overflow-hidden">
            ...
            <div class="relative flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold"><?php echo e($jurusan->where('is_active', true)->count()); ?></p>
                </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $jurusan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">
                            <?php echo e($jurusan->firstItem() + $i); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($item->nama_jurusan); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">
                                <?php echo e($item->kode_jurusan); ?>
                            ...
                            <?php if($item->kepala): ?>
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-8 w-8">
                                        <?php if($item->kepala->foto): ?>
                                            <img class="h-8 w-8 rounded-full" src="<?php echo e(asset('storage/'.$item->kepala->foto)); ?>" alt="">
                                        <?php else: ?>
                                    ...
                                    <div class="ml-3">
                                        <div class="text-sm font-medium text-gray-900"><?php echo e($item->kepala->nama); ?></div>
                                    </div>
                                </div>
                            <?php else: ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">
                                <?php echo e($item->kelas ? $item->kelas->count() : 0); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                                <?php echo e($item->siswa ? $item->siswa->count() : 0); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            <div class="flex space-x-2">
                                <a href="<?php echo e(route('admin.jurusan.edit', $item->id)); ?>" 
                                   class="text-amber-600 hover:text-amber-900">
                                    <i class="fas fa-edit"></i>
                                    <span class="ml-1">Edit</span>
                                </a>
                                <form action="<?php echo e(route('admin.jurusan.destroy', $item->id)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
                    ...
                    <tr>
                        <td colspan="8" class="px-6 py-10 text-center">
                            <div class="flex flex-col items-center justify-center">
                                <img src="<?php echo e(asset('images/empty.svg')); ?>" alt="Data Kosong" class="w-32 h-32 mb-4">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\admin\jurusan\index.blade.php ENDPATH**/ ?>