    ...
    <div class="bg-white rounded-xl shadow-sm mobile-spacing md:p-6 border border-gray-100 mobile-section-spacing md:mb-6">
        <div class="flex mobile-header md:items-center md:justify-between">
            ...
            <div class="mobile-header-actions md:flex md:space-x-3">
                <a href="<?php echo e(route('guru.materi.edit-tugas', $tugas->id)); ?>"
            ...
            <div class="border-b border-gray-200 pb-4 md:pb-6 mobile-section-spacing md:mb-6">
                <div class="flex mobile-content-header md:items-start md:justify-between">
                    <div class="flex-1 w-full">
                        <h2 class="mobile-title md:text-3xl font-bold text-gray-800 mb-3 md:mb-4"><?php echo e($tugas->judul); ?></h2>
                        ...
                        <?php if($isOverdue): ?>
                            <div class="mobile-deadline-alert md:hidden bg-red-100 border border-red-200 rounded-lg p-3 mb-3 deadline-alert">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium text-red-800">Deadline Terlewat: <?php echo e($deadline->format('d M Y')); ?></span>
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="mobile-info-grid md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 w-full">
                            <div class="mobile-info-item info-item">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm md:text-base font-semibold"><?php echo e($tugas->kelas->nama_kelas ?? '-'); ?></p>
                                </div>
                            </div>
                            <div class="mobile-info-item info-item">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm md:text-base font-semibold"><?php echo e($tugas->mapel->nama ?? '-'); ?></p>
                                </div>
                            </div>
                            <div class="mobile-info-item info-item">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm md:text-base font-semibold <?php echo e($isOverdue ? 'text-red-600' : 'text-gray-800'); ?>">
                            ...
                            <div class="mobile-info-item info-item">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm md:text-base font-semibold"><?php echo e($tugas->created_at->format('d M Y')); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mobile-stat-card bg-blue-50 rounded-xl p-3 md:p-6 border border-blue-200">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <h3 class="text-lg md:text-2xl font-bold text-blue-800"><?php echo e($totalStudents); ?></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="mobile-stat-card bg-green-50 rounded-xl p-3 md:p-6 border border-green-200">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <h3 class="text-lg md:text-2xl font-bold text-green-800"><?php echo e($submissionCount); ?></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="mobile-stat-card bg-red-50 rounded-xl p-3 md:p-6 border border-red-200">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <h3 class="text-lg md:text-2xl font-bold text-red-800"><?php echo e($totalStudents - $submissionCount); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="flex mobile-file-content md:items-center md:justify-between bg-white rounded-lg p-3 md:p-4 border border-blue-200">
                        <div class="mobile-file-info flex items-center">
                            <div class="bg-blue-100 p-2 md:p-3 rounded-lg mr-3 md:mr-4">
                                ...
                                ?>
                                <i class="<?php echo e($iconClass); ?> text-xl md:text-2xl"></i>
                            </div>
                            <div>
                                <p class="text-sm md:text-base font-semibold text-gray-800"><?php echo e($tugas->file_name ?? basename($tugas->file_path)); ?></p>
                                <p class="text-xs md:text-sm text-gray-500"><?php echo e(strtoupper($extension)); ?> File</p>
                            </div>
                        </div>
                        <a href="<?php echo e(asset('storage/' . $tugas->file_path)); ?>" target="_blank"
            ...
            <div class="border-t border-gray-200 pt-4 md:pt-6">
                <div class="flex mobile-actions md:justify-between md:items-center">
                    <div class="text-xs md:text-sm text-gray-500 mb-3 md:mb-0">
                        ...
                        Terakhir diupdate: <?php echo e($tugas->updated_at->format('d M Y, H:i')); ?>

                    </div>
                    <div class="mobile-actions-group md:flex md:space-x-3">
                        <a href="<?php echo e(route('guru.materi.tugas-submissions', $tugas->id)); ?>"
                        ...
                        <form action="<?php echo e(route('guru.materi.delete-tugas', $tugas->id)); ?>" method="POST" class="inline">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\guru\materi\show-tugas.blade.php ENDPATH**/ ?>