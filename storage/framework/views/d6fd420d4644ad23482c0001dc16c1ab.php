    ...
    <div class="w-full h-full">
        ...
        <nav class="mb-6">
            <ol class="flex items-center space-x-2 text-sm text-gray-600">
                ...
                <li><a href="<?php echo e(route('guru.pengumuman.index')); ?>" class="hover:text-blue-600">Pengumuman</a></li>
                <li><i class="fas fa-chevron-right text-xs text-gray-400"></i></li>
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-6 text-white">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        ...
                        <h1 class="text-2xl md:text-3xl font-bold mb-3"><?php echo e($pengumuman->judul); ?></h1>
                        <div class="flex flex-wrap items-center gap-4 text-blue-100">
                            <span class="flex items-center">
                                <i class="fas fa-calendar-alt mr-2"></i>
                                <span class="text-sm"><?php echo e(\Carbon\Carbon::parse($pengumuman->tanggal_mulai)->format('d F Y')); ?></span>
                            </span>
                            <?php if($pengumuman->tanggal_selesai): ?>
                            <span class="flex items-center">
                                <i class="fas fa-calendar-times mr-2"></i>
                                <span class="text-sm">Berlaku sampai <?php echo e(\Carbon\Carbon::parse($pengumuman->tanggal_selesai)->format('d F Y')); ?></span>
                            </span>
                            <?php endif; ?>
                            <span class="flex items-center bg-white bg-opacity-20 px-3 py-1 rounded-lg">
                                <i class="fas fa-users mr-2"></i>
                                <span class="text-sm capitalize"><?php echo e($pengumuman->target_role == 'all' ? 'Semua' : ucfirst($pengumuman->target_role)); ?></span>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="p-6">
                ...
                <?php if($pengumuman->file_lampiran): ?>
                <div class="mt-6 p-4 bg-gray-50 rounded-lg">
                    <h3 class="text-lg font-semibold text-gray-900 mb-3 flex items-center">
                        <i class="fas fa-paperclip text-gray-500 mr-2"></i>
                        Lampiran
                    </h3>
                    <a href="<?php echo e(asset('storage/' . $pengumuman->file_lampiran)); ?>" 
                       target="_blank"
                ...
                <div class="mt-6 pt-6 border-t border-gray-200">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
                        <div>
                            ...
                            <?php echo e(\Carbon\Carbon::parse($pengumuman->created_at)->format('d F Y, H:i')); ?> WIB
                        </div>
                        <?php if($pengumuman->updated_at != $pengumuman->created_at): ?>
                        <div>
                            <span class="font-medium">Terakhir diupdate:</span>
                            <?php echo e(\Carbon\Carbon::parse($pengumuman->updated_at)->format('d F Y, H:i')); ?> WIB
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <div class="mt-6 flex flex-col sm:flex-row gap-3">
            <a href="<?php echo e(route('guru.pengumuman.index')); ?>" 
...
<?php echo $__env->make('layouts.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\guru\pengumuman\show.blade.php ENDPATH**/ ?>