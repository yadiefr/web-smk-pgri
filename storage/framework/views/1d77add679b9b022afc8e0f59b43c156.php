...
<div class="bg-white rounded-xl shadow-md p-6 mb-6">
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex items-center space-x-2">
            ...
            <span class="px-2 py-1 text-xs font-semibold rounded-full <?php echo e(config('midtrans.is_production') ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>">
                <?php echo e(config('midtrans.is_production') ? 'Production' : 'Sandbox'); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <div class="mt-1 p-3 bg-white border border-gray-300 rounded-md text-sm text-gray-900">
                        <?php echo e(config('midtrans.merchant_id') ?: 'Not configured'); ?>
                ...
                <div>
                    ...
                    <div class="mt-1 p-3 bg-white border border-gray-300 rounded-md text-sm text-gray-900">
                        <?php echo e(config('midtrans.client_key') ? str_repeat('*', 20) . substr(config('midtrans.client_key'), -4) : 'Not configured'); ?>
                ...
                <div>
                    ...
                    <div class="mt-1 p-3 bg-white border border-gray-300 rounded-md text-sm text-gray-900">
                        <?php echo e(config('midtrans.server_key') ? str_repeat('*', 20) . substr(config('midtrans.server_key'), -4) : 'Not configured'); ?>
        ...
        <div class="bg-gray-50 rounded-lg p-6">
            ...
            <div class="grid grid-cols-2 gap-3">
                <?php $__currentLoopData = config('midtrans.snap.enabled_payments', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-center p-2 bg-white rounded border border-gray-200">
                        <div class="w-2 h-2 bg-green-400 rounded-full mr-2"></div>
                        <span class="text-sm text-gray-700 capitalize"><?php echo e(str_replace('_', ' ', $method)); ?></span>
                    </div>
            ...
            <div class="flex items-start">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-blue-700">
                        ...
                        <p class="mt-3">Set notification URL in Midtrans Dashboard to: <code class="bg-blue-100 px-1 rounded"><?php echo e(route('midtrans.notification')); ?></code></p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    <?php $__currentLoopData = $recentTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="px-3 py-2 text-sm font-mono text-gray-900"><?php echo e($transaction->order_id); ?></td>
                                            <td class="px-3 py-2 text-sm text-gray-900"><?php echo e($transaction->siswa->nama_lengkap ?? 'N/A'); ?></td>
                                            <td class="px-3 py-2 text-sm text-gray-900">Rp <?php echo e(number_format($transaction->gross_amount, 0, ',', '.')); ?></td>
                                            <td class="px-3 py-2 text-sm">
                                                <span class="px-2 py-1 text-xs rounded-full <?php echo e($transaction->isSuccess() ? 'bg-green-100 text-green-800' : 
                                                    ($transaction->isPending() ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800')); ?>">
                                                    <?php echo e(ucfirst($transaction->transaction_status)); ?>

                                                </span>
                                            </td>
                                            <td class="px-3 py-2 text-sm text-gray-500"><?php echo e($transaction->created_at->format('d/m/Y H:i')); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\admin\midtrans\settings.blade.php ENDPATH**/ ?>