...
<?php $__env->startSection('title', 'Rekap Keterlambatan Siswa'); ?>
...
<div class="p-6">
    ...
    <div class="mb-6">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                ...
                <p class="text-gray-600 mt-1">Rekap data keterlambatan siswa dengan export Excel</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-4">
        <div class="p-4">
            <form method="GET" action="<?php echo e(route('kesiswaan.keterlambatan.rekap')); ?>" id="filterForm">
    ...
    <?php if($hasFilter): ?>
        ...
        <!-- Rekap Per Kelas -->
    <?php if($rekapPerKelas->count() > 0): ?>
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
        <div class="p-6">
            <h3 class="text-lg font-semibold text-gray-800 mb-4">Rekap Per Kelas</h3>
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <?php $__currentLoopData = $rekapPerKelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $namaKelas => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3 text-center text-gray-900"><?php echo e($loop->iteration); ?></td>
                            <td class="px-4 py-3 font-medium text-gray-900"><?php echo e($namaKelas); ?></td>
                            <td class="px-4 py-3 text-center text-gray-900">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                                    <?php echo e($data['jumlah_siswa']); ?>

                                </span>
                            </td>
                            <td class="px-4 py-3 text-center text-gray-900">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">
                                    <?php echo e($data['total_keterlambatan']); ?>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
        <div class="p-6">
            <h3 class="text-lg font-semibold text-gray-800 mb-4">Detail Data Keterlambatan</h3>
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider hidden md:table-cell">Kelas</th>
                            <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Durasi Terlambat</th>
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider hidden md:table-cell">Keterangan</th>
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider hidden md:table-cell">Petugas</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200">
                        <?php $__currentLoopData = $rekapData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3 text-center text-gray-900"><?php echo e($loop->iteration); ?></td>
                            <td class="px-4 py-3 text-gray-900"><?php echo e(\Carbon\Carbon::parse($data->tanggal)->format('d/m/Y')); ?></td>
                            <td class="px-4 py-3">
                                <div class="font-medium text-gray-900"><?php echo e($data->siswa->nama_lengkap); ?></div>
                                <div class="text-xs text-gray-500 md:hidden">
                                    <?php echo e($data->siswa->nis); ?> | <?php echo e($data->kelas->nama_kelas); ?>

                                </div>
                                <?php if($data->catatan_petugas): ?>
                                <div class="text-xs text-blue-600 md:hidden mt-1">
                                    <i class="fas fa-info-circle"></i> <?php echo e($data->catatan_petugas); ?>

                                </div>
                                <?php endif; ?>
                            </td>
                            <td class="px-4 py-3 text-gray-900 hidden md:table-cell"><?php echo e($data->kelas->nama_kelas); ?></td>
                            <td class="px-4 py-3 text-center">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                                    <?php echo e($data->jam_terlambat); ?>

                                </span>
                            </td>
                            <td class="px-4 py-3 text-gray-900 hidden md:table-cell">
                                <?php echo e($data->catatan_petugas ?? '-'); ?>

                            </td>
                            <td class="px-4 py-3 text-gray-900 hidden md:table-cell"><?php echo e($data->petugas->name ?? '-'); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
            ...
            <p class="text-gray-600">Tidak ada data keterlambatan pada periode yang dipilih.</p>
        </div>
        <?php endif; ?>
    <?php else: ?>
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
...
<div id="exportModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            ...
            <form id="exportForm" method="POST" action="<?php echo e(route('kesiswaan.keterlambatan.export')); ?>">
                <?php echo csrf_field(); ?>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    <label for="export_kelas_id" class="block text-sm font-medium text-gray-700 mb-2">Kelas (Opsional)</label>
                    <select id="export_kelas_id" 
                            name="kelas_id" 
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        <option value="">Semua Kelas</option>
                        <?php $__currentLoopData = $kelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <label for="export_rekap_total" class="text-sm font-medium text-gray-700 cursor-pointer">
                                    <i class="fas fa-chart-bar text-blue-500 mr-2"></i>Export Rekap Total
                                </label>
                                <p class="text-xs text-gray-500 mt-1">Single-sheet: Hanya berisi rekap total keterlambatan per siswa</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-3">
                        <div class="flex items-center">
                            ...
                            <p class="text-sm text-blue-700">
                                Pilih jenis export yang sesuai dengan kebutuhan laporan Anda
                            </p>
                        </div>
                    </div>
                </div>
...
function showExportModal() {
    ...
    if (kelasId) {
        document.getElementById('export_kelas_id').value = kelasId;
    }
...
<?php echo $__env->make('layouts.kesiswaan', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views/kesiswaan/keterlambatan/rekap.blade.php ENDPATH**/ ?>