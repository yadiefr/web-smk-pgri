...
<?php $__env->startSection('page-header'); ?>
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Selamat datang, <?php echo e(auth()->user()->name); ?>. Berikut adalah ringkasan data terkini.</p>
        </div>
        <div class="flex items-center space-x-3">
            <div class="text-sm text-gray-500 dark:text-gray-400">
                <div class="font-medium"><?php echo e(\Carbon\Carbon::now()->format('l, d F Y')); ?></div>
                <div class="text-xs"><?php echo e(\Carbon\Carbon::now()->format('H:i')); ?> WIB</div>
            </div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <!-- Laporan Keuangan -->
    <a href="<?php echo e(route('tata-usaha.laporan')); ?>" class="group block">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center">
                ...
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Trend Pembayaran (<?php echo e(date('Y')); ?>)</h3>
            </div>
        </div>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-200">
                        <td class="px-2 py-3 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                            <?php echo e(\Carbon\Carbon::parse($transaksi->tanggal)->format('d M')); ?>

                        </td>
                        <td class="px-2 py-3 text-sm">
                            <div class="font-medium text-gray-900 dark:text-gray-100"><?php echo e($transaksi->siswa->nama_lengkap ?? 'Tidak ada data'); ?></div>
                            <div class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($transaksi->keterangan); ?></div>
                        </td>
                        <td class="px-2 py-3 whitespace-nowrap text-sm text-right">
                            <span class="font-semibold text-green-600 dark:text-green-400">Rp <?php echo e(number_format($transaksi->jumlah, 0, ',', '.')); ?></span>
                        </td>
                    </tr>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    <?php $__empty_1 = true; $__currentLoopData = $siswaWithTunggakan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $siswa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-200">
                        <td class="px-2 py-3 text-sm">
                            <div class="font-medium text-gray-900 dark:text-gray-100"><?php echo e($siswa->nama_lengkap); ?></div>
                            <div class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($siswa->nis); ?></div>
                        </td>
                        <td class="px-2 py-3 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                            <?php echo e($siswa->kelas->nama_kelas ?? 'Tidak ada kelas'); ?>

                        </td>
                        <td class="px-2 py-3 whitespace-nowrap text-sm text-right">
                            <span class="font-semibold text-red-600 dark:text-red-400">Rp <?php echo e(number_format($siswa->tunggakan, 0, ',', '.')); ?></span>
                        </td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const monthlyData = {
        labels: <?php echo json_encode($dataBulan, 15, 512) ?>,
        datasets: [{
...
<?php echo $__env->make('layouts.tata_usaha', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\tata_usaha\index.blade.php ENDPATH**/ ?>