<?php $__env->startSection('title', 'Tambah Tagihan Baru'); ?>
...
<div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden max-w-4xl mx-auto">
    ...
    <form action="<?php echo e(route('admin.keuangan.tagihan.store')); ?>" method="POST" class="p-8">
        <?php echo csrf_field(); ?>
        ...
        <div class="mb-8">
            ...
            <div class="mb-6 hidden" id="tahun-select-wrapper">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="relative">
                        <input type="radio" name="tahun_masuk" value="<?php echo e($year['year']); ?>" id="tahun-<?php echo e($year['year']); ?>" class="sr-only peer tahun-radio">
        ...
        <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
            ...
            <a href="<?php echo e(route('admin.keuangan.index')); ?>" class="flex-1 inline-flex items-center justify-center px-6 py-3 bg-gray-100 text-gray-700 font-semibold rounded-xl hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-all duration-200">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadAllSiswa() {        
        ...
        <?php if(isset($siswaList) && $siswaList->count() > 0): ?>
            const siswaData = <?php echo json_encode($siswaList, 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\admin\keuangan\create_tagihan.blade.php ENDPATH**/ ?>