...
<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-3">
            <a href="<?php echo e(route('admin.absensi.rekap')); ?>" class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg flex items-center transition-colors">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($absensi->total()); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e(collect($absensi)->where('tanggal', date('Y-m-d'))->sum('counts.hadir') ?? 0); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e(collect($absensi)->where('tanggal', date('Y-m-d'))->sum('counts.alpha') ?? 0); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e((collect($absensi)->where('tanggal', date('Y-m-d'))->sum('counts.izin') ?? 0) + (collect($absensi)->where('tanggal', date('Y-m-d'))->sum('counts.sakit') ?? 0)); ?></p>
                </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-6">
        ...
        <div class="p-6">
            <form action="<?php echo e(route('admin.absensi.index')); ?>" method="GET" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                <div>
                ...
                <div class="flex flex-col justify-end">
                    <div class="flex gap-2">
                        ...
                        <a href="<?php echo e(route('admin.absensi.index')); ?>" class="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-lg flex items-center justify-center transition-colors">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <?php echo e($data->tanggal->format('d/m/Y')); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <?php echo e(optional($data->kelas)->nama_kelas ?? '-'); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <?php echo e(optional($data->mapel)->nama ?? '-'); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <?php echo e(optional($data->guru)->nama ?? optional($data->guru)->name ?? '-'); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                            <span class="px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800">
                                <?php echo e($data->counts['hadir'] ?? 0); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                            <span class="px-2 py-1 text-xs font-semibold rounded-full bg-yellow-100 text-yellow-800">
                                <?php echo e($data->counts['izin'] ?? 0); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                            <span class="px-2 py-1 text-xs font-semibold rounded-full bg-orange-100 text-orange-800">
                                <?php echo e($data->counts['sakit'] ?? 0); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                            <span class="px-2 py-1 text-xs font-semibold rounded-full bg-red-100 text-red-800">
                                <?php echo e($data->counts['alpha'] ?? 0); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                            <div class="flex items-center justify-center space-x-3">
                                <?php if($data->id): ?>
                                <a href="<?php echo e(route('admin.absensi.show', $data->id)); ?>" 
                                   class="p-1 text-blue-600 hover:text-white hover:bg-blue-600 rounded-lg transition-colors"
                                   title="Lihat Detail">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <form action="<?php echo e(route('admin.absensi.destroy', $data->composite_key)); ?>" 
                                      method="POST" 
                                      class="inline-block">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <button type="submit" 
                                            ...
                                            title="Hapus Data"
                                            onclick="return confirm('Apakah Anda yakin ingin menghapus data absensi tanggal <?php echo e(\Carbon\Carbon::parse($data->tanggal)->format('d/m/Y')); ?> untuk <?php echo e($data->mapel->nama ?? 'mata pelajaran'); ?>?')">
    ...
    <div id="exportModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-xl shadow-xl p-6 w-full max-w-md mx-4">
            ...
            <form action="<?php echo e(route('admin.absensi.rekap.export')); ?>" method="GET" class="space-y-4">
                <div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\admin\absensi\index.blade.php ENDPATH**/ ?>