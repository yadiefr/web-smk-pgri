...
<?php $__env->startSection('title', 'Detail Ruangan Ujian'); ?>
...
<div x-data="ruanganDetailManager()" class="min-h-screen bg-gray-50 px-2 py-3">
    <div class="max-w-full mx-auto">
        ...
        <nav class="flex items-center space-x-2 text-sm bg-white rounded-lg px-4 py-3 mb-3 shadow-sm border border-gray-200" aria-label="Breadcrumb">
            ...
            <span class="text-gray-900 font-medium"><?php echo e($ruangan->nama_ruangan); ?></span>
        </nav>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-3">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                <div class="flex items-center mb-4 lg:mb-0">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-gray-900 mb-1"><?php echo e($ruangan->nama_ruangan); ?></h1>
                        <div class="flex flex-wrap items-center space-x-3">
                            ...
                            <span class="px-3 py-1 rounded-lg text-sm font-medium <?php echo e($ruangan->status === 'tersedia' ? 'bg-green-100 text-green-800 border border-green-300' : ($ruangan->status === 'terpakai' ? 'bg-yellow-100 text-yellow-800 border border-yellow-300' : 'bg-red-100 text-red-800 border border-red-300')); ?>">
                ...
                <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                    ...
                    <a href="<?php echo e(route('admin.ujian.pengaturan.ruangan.manage-kelas', $ruangan)); ?>" 
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-6 p-6">
                ...
                <div class="lg:col-span-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between py-3 border-b border-gray-200">
                                ...
                                <span class="text-gray-900 font-semibold"><?php echo e($ruangan->nama_ruangan); ?></span>
                            </div>
                            <div class="flex items-center justify-between py-3 border-b border-gray-200">
                                ...
                                <span class="bg-blue-100 text-blue-800 px-3 py-1 rounded-lg text-sm font-medium flex items-center">
                                    <i class="fas fa-users mr-2"></i>
                                    <?php echo e($ruangan->formatted_kapasitas ?? $ruangan->kapasitas . ' orang'); ?>
                            ...
                            <div class="flex items-center justify-between py-3 border-b border-gray-200">
                                ...
                                <span class="text-gray-900 flex items-center font-medium">
                                    ...
                                    <?php echo e($ruangan->lokasi ?? 'Belum diset'); ?>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center justify-between py-3 border-b border-gray-200">
                                ...
                                <span class="px-3 py-1 rounded-lg text-sm font-medium <?php echo e($ruangan->status === 'tersedia' ? 'bg-green-100 text-green-800' : ($ruangan->status === 'terpakai' ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800')); ?>">
                            ...
                            <div class="flex items-center justify-between py-3 border-b border-gray-200">
                                ...
                                <span class="<?php echo e($ruangan->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?> px-3 py-1 rounded-lg text-sm font-medium flex items-center">
                                    <i class="fas <?php echo e($ruangan->is_active ? 'fa-check-circle' : 'fa-times-circle'); ?> mr-2"></i>
                                    <?php echo e($ruangan->is_active ? 'Aktif' : 'Nonaktif'); ?>
                            ...
                            <div class="flex items-center justify-between py-3 border-b border-gray-200">
                                ...
                                <span class="text-gray-900 flex items-center font-medium">
                                    ...
                                    <?php echo e($ruangan->created_at->format('d/m/Y H:i')); ?>
                            ...
                            <div class="flex items-center justify-between py-3 border-b border-gray-200">
                                ...
                                <span class="text-gray-900 flex items-center font-medium">
                                    ...
                                    <?php echo e($ruangan->updated_at->diffForHumans()); ?>
                    ...
                    <?php if($ruangan->fasilitas && count($ruangan->fasilitas) > 0): ?>
                        <div class="pt-6 border-t border-gray-200 mb-8">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-3">
                                <?php $__currentLoopData = $ruangan->fasilitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fasilitas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="group">
                    ...
                    <?php if($ruangan->deskripsi): ?>
                        <div class="pt-6 border-t border-gray-200 mb-8">
                            ...
                            <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                <p class="text-gray-700 leading-relaxed"><?php echo e($ruangan->deskripsi); ?></p>
                            </div>
                        </div>
                    <?php endif; ?>
                ...
                <div class="lg:col-span-1">
                    <div class="sticky top-6 space-y-4">
                        ...
                        <div class="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-4 shadow-sm">
                            ...
                            <?php if($ruangan->kelas->count() > 0): ?>
                                <div class="space-y-2 mb-3">
                                    <?php $__currentLoopData = $ruangan->kelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center justify-between p-2 bg-white rounded-lg border border-gray-200">
                                            <div>
                                                <h4 class="font-medium text-gray-900 text-sm"><?php echo e($kelas->nama_kelas); ?></h4>
                                                <p class="text-xs text-gray-600">
                                                    Max: <?php echo e($kelas->pivot->kapasitas_maksimal ?? $ruangan->kapasitas); ?> siswa
                                                </p>
                                            </div>
                                            <span class="<?php echo e($kelas->pivot->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-600'); ?> px-2 py-1 rounded text-xs font-medium">
                                                <?php echo e($kelas->pivot->is_active ? 'Aktif' : 'Nonaktif'); ?>
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-lg p-4 shadow-sm">
                            ...
                            <div class="space-y-2">
                                <button type="button" 
                                        @click="toggleActiveStatus(<?php echo e($ruangan->id); ?>)"
                                    ...
                                    <?php echo e($ruangan->is_active ? 'Nonaktifkan' : 'Aktifkan'); ?>
...
<?php echo $__env->make('layouts.ujian', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\admin\ujian\pengaturan\ruangan\show.blade.php ENDPATH**/ ?>