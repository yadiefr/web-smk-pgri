...
<?php $__env->startSection('title', 'Detail Pelanggaran - ' . $pelanggaran->siswa->nama_lengkap); ?>
...
<div class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="text-center">
                <div class="text-3xl font-bold text-red-600 mb-2">
                    <?php echo e($pelanggaran->jenisPelanggaran->poin_pelanggaran); ?>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
                ...
                <p class="text-lg font-semibold text-gray-900"><?php echo e($pelanggaran->siswa->nama_lengkap); ?></p>
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">NIS</label>
                <p class="text-gray-900"><?php echo e($pelanggaran->siswa->nis); ?></p>
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Kelas</label>
                <p class="text-gray-900"><?php echo e($pelanggaran->siswa->kelas->nama_kelas ?? 'N/A'); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
                ...
                <p class="text-gray-900 font-medium"><?php echo e($pelanggaran->jenisPelanggaran->nama_pelanggaran); ?></p>
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Tanggal Pelanggaran</label>
                <p class="text-gray-900"><?php echo e($pelanggaran->tanggal_pelanggaran_formatted); ?></p>
            </div>
            <?php if($pelanggaran->jam_pelanggaran): ?>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Jam Pelanggaran</label>
                <p class="text-gray-900"><?php echo e($pelanggaran->jam_pelanggaran_formatted); ?></p>
            </div>
            <?php endif; ?>
            <?php if($pelanggaran->guru): ?>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Dilaporkan oleh</label>
                <p class="text-gray-900"><?php echo e($pelanggaran->guru->nama); ?></p>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div class="mb-6">
            ...
            <div class="bg-gray-50 rounded-lg p-4">
                <p class="text-gray-900 whitespace-pre-line"><?php echo e($pelanggaran->deskripsi_kejadian); ?></p>
            </div>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    <p class="text-gray-900 whitespace-pre-line"><?php echo e($pelanggaran->sanksi_diberikan); ?></p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <p class="text-gray-900"><?php echo e($pelanggaran->tanggal_selesai_sanksi_formatted); ?></p>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Status Sanksi</label>
                    <?php if($pelanggaran->tanggal_selesai_sanksi < now()->format('Y-m-d')): ?>
            ...
            <!-- Catatan Tambahan -->
            <?php if($pelanggaran->catatan_tambahan): ?>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Catatan Tambahan</label>
                <div class="bg-gray-50 rounded-lg p-4">
                    <p class="text-gray-900 whitespace-pre-line"><?php echo e($pelanggaran->catatan_tambahan); ?></p>
                </div>
            </div>
            <?php endif; ?>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="space-y-4">
            ...
            <?php if($pelanggaran->respon_ortu): ?>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Respon Orang Tua</label>
                <div class="bg-gray-50 rounded-lg p-4">
                    <p class="text-gray-900 whitespace-pre-line"><?php echo e($pelanggaran->respon_ortu); ?></p>
                </div>
            </div>
            <?php endif; ?>
        </div>
    ...
    <div class="bg-gray-50 rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-gray-600">
            <div>
                ...
                <p><?php echo e($pelanggaran->created_at->format('d/m/Y H:i:s')); ?></p>
            </div>
            <div>
                <label class="block font-medium text-gray-700 mb-1">Terakhir diupdate</label>
                <p><?php echo e($pelanggaran->updated_at->format('d/m/Y H:i:s')); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="flex flex-col sm:flex-row gap-4">
        ...
        <?php if($pelanggaran->status === 'aktif'): ?>
        <form action="<?php echo e(route('kesiswaan.pelanggaran.update', $pelanggaran)); ?>" method="POST" class="inline">
            <?php echo csrf_field(); ?>
        ...
        <form action="<?php echo e(route('kesiswaan.pelanggaran.destroy', $pelanggaran)); ?>" method="POST" class="inline">
            <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.kesiswaan', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\kesiswaan\pelanggaran\show.blade.php ENDPATH**/ ?>