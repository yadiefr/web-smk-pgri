...
<?php $__env->startSection('title', 'Dashboard Ketua Kelas'); ?>
...
<div class="h-full bg-gray-50 p-3 sm:p-4 lg:p-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600"><?php echo e($kelas->nama_kelas); ?></p>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-3 sm:p-4 lg:p-6 hover:shadow-md transition-shadow">
            <div class="flex flex-col lg:flex-row lg:items-center">
                ...
                <div class="lg:ml-4 text-center lg:text-left">
                    ...
                    <p class="text-lg sm:text-xl lg:text-2xl font-bold text-gray-800"><?php echo e($totalSiswa); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-3 sm:p-4 lg:p-6 hover:shadow-md transition-shadow">
            <div class="flex flex-col lg:flex-row lg:items-center">
                ...
                <div class="lg:ml-4 text-center lg:text-left">
                    ...
                    <p class="text-lg sm:text-xl lg:text-2xl font-bold text-gray-800"><?php echo e($attendanceToday['hadir']); ?></p>
                    <p class="text-xs text-gray-400"><?php echo e(number_format($attendanceToday['persentase'], 1)); ?>%</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-3 sm:p-4 lg:p-6 hover:shadow-md transition-shadow">
            <div class="flex flex-col lg:flex-row lg:items-center">
                ...
                <div class="lg:ml-4 text-center lg:text-left">
                    ...
                    <p class="text-lg sm:text-xl lg:text-2xl font-bold text-gray-800"><?php echo e($attendanceToday['alpha'] + $attendanceToday['sakit'] + $attendanceToday['izin']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-3 sm:p-4 lg:p-6 hover:shadow-md transition-shadow">
            <div class="flex flex-col lg:flex-row lg:items-center">
                ...
                <div class="lg:ml-4 text-center lg:text-left">
                    ...
                    <p class="text-lg sm:text-xl lg:text-2xl font-bold text-gray-800"><?php echo e($attendanceToday['persentase'] ? number_format($attendanceToday['persentase'], 1) : '0'); ?>%</p>
    ...
    <div class="grid grid-cols-1 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div class="h-64 flex items-end justify-between space-x-2">
                <?php $__currentLoopData = $weeklyAttendance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex flex-col items-center flex-1">
                    <div class="bg-blue-500 rounded-t w-full flex justify-center items-end text-white text-xs font-medium min-h-[20px]" 
                         style="height: <?php echo e(max($day['percentage'], 5)); ?>%;">
                        <?php if($day['hadir'] > 0): ?>
                            <?php echo e($day['hadir']); ?>

                        <?php endif; ?>
                    </div>
                    <div class="mt-2 text-xs text-gray-600 text-center">
                        <?php echo e($day['tanggal']); ?>
    ...
    <div class="mt-6 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="<?php echo e(route('siswa.ketua-kelas.rekap-absensi')); ?>" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                Lihat Semua
            </a>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $todayAttendanceDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900"><?php echo e($attendance->siswa->nama_lengkap); ?></div>
                            <div class="text-sm text-gray-500"><?php echo e($attendance->siswa->nis); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full 
                                <?php if($attendance->status == 'hadir'): ?> bg-green-100 text-green-800
                                <?php elseif($attendance->status == 'izin'): ?> bg-blue-100 text-blue-800
                                <?php elseif($attendance->status == 'sakit'): ?> bg-yellow-100 text-yellow-800
                                <?php elseif($attendance->status == 'alpha'): ?> bg-red-100 text-red-800
                                <?php elseif($attendance->status == 'terlambat'): ?> bg-orange-100 text-orange-800
                                <?php endif; ?>">
    ...
    <div class="mt-6 grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <a href="<?php echo e(route('siswa.ketua-kelas.daftar-siswa')); ?>" 
...
<?php echo $__env->make('layouts.siswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\siswa\ketua-kelas\dashboard.blade.php ENDPATH**/ ?>