...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard Kesiswaan - SMK PGRI CIKAMPEK'); ?></title>
                ...
                <div class="overflow-y-auto h-full">
                    <nav class="p-3 pt-2">
                        <ul class="space-y-0.5">
                            <li>
                                <a href="<?php echo e(route('kesiswaan.dashboard')); ?>" class="flex items-center space-x-3 p-3 rounded-lg <?php echo e(request()->routeIs('kesiswaan.dashboard') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium shadow-sm' : 'hover:bg-gray-50 transition-all duration-300 group'); ?>">
                                    <i class="fas fa-tachometer-alt <?php echo e(request()->routeIs('kesiswaan.dashboard') ? '' : 'text-gray-600 group-hover:text-blue-600'); ?>"></i>
                                    <span>Dashboard</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="<?php echo e(route('kesiswaan.siswa.index')); ?>" class="flex items-center space-x-3 p-3 rounded-lg <?php echo e(request()->routeIs('kesiswaan.siswa.*') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium shadow-sm' : 'hover:bg-gray-50 transition-all duration-300 group'); ?>">
                                    <i class="fas fa-user-graduate <?php echo e(request()->routeIs('kesiswaan.siswa.*') ? '' : 'text-gray-600 group-hover:text-blue-600'); ?>"></i>
                                    <span>Data Siswa</span>
                                </a>
                            </li>
                            
                            <li>
                                <a href="<?php echo e(route('kesiswaan.absensi.index')); ?>" class="flex items-center space-x-3 p-3 rounded-lg <?php echo e(request()->routeIs('kesiswaan.absensi.*') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium shadow-sm' : 'hover:bg-gray-50 transition-all duration-300 group'); ?>">
                                    <i class="fas fa-clipboard-check <?php echo e(request()->routeIs('kesiswaan.absensi.*') ? '' : 'text-gray-600 group-hover:text-blue-600'); ?>"></i>
                                    <span>Kehadiran</span>
                                </a>
                            </li>
                            
                            <li>
                                <a href="<?php echo e(route('kesiswaan.keterlambatan.index')); ?>" class="flex items-center space-x-3 p-3 rounded-lg <?php echo e(request()->routeIs('kesiswaan.keterlambatan.*') ? 'bg-gradient-to-r from-orange-500 to-orange-600 text-white font-medium shadow-sm' : 'hover:bg-gray-50 transition-all duration-300 group'); ?>">
                                    <i class="fas fa-clock <?php echo e(request()->routeIs('kesiswaan.keterlambatan.*') ? '' : 'text-gray-600 group-hover:text-orange-600'); ?>"></i>
                                    <span>Keterlambatan</span>
                                </a>
                            </li>
                            
                            <li>
                                <a href="<?php echo e(route('kesiswaan.kegiatan.index')); ?>" class="flex items-center space-x-3 p-3 rounded-lg <?php echo e(request()->routeIs('kesiswaan.kegiatan.*') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium shadow-sm' : 'hover:bg-gray-50 transition-all duration-300 group'); ?>">
                                    <i class="fas fa-calendar-alt <?php echo e(request()->routeIs('kesiswaan.kegiatan.*') ? '' : 'text-gray-600 group-hover:text-blue-600'); ?>"></i>
                                    <span>Kegiatan Siswa</span>
                                </a>
                            </li>
                            
                            <li>
                                <a href="<?php echo e(route('kesiswaan.pelanggaran.index')); ?>" class="flex items-center space-x-3 p-3 rounded-lg <?php echo e(request()->routeIs('kesiswaan.pelanggaran.*') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium shadow-sm' : 'hover:bg-gray-50 transition-all duration-300 group'); ?>">
                                    <i class="fas fa-exclamation-triangle <?php echo e(request()->routeIs('kesiswaan.pelanggaran.*') ? '' : 'text-gray-600 group-hover:text-blue-600'); ?>"></i>
                            ...
                            <li>
                                <a href="<?php echo e(route('kesiswaan.laporan.index')); ?>" class="flex items-center space-x-3 p-3 rounded-lg <?php echo e(request()->routeIs('kesiswaan.laporan.*') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium shadow-sm' : 'hover:bg-gray-50 transition-all duration-300 group'); ?>">
                                    <i class="fas fa-chart-bar <?php echo e(request()->routeIs('kesiswaan.laporan.*') ? '' : 'text-gray-600 group-hover:text-blue-600'); ?>"></i>
                                    <span>Laporan</span>
                                </a>
                            </li>
                        </ul>
                ...
                <div class="px-6 py-3 flex justify-between items-center h-full">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="hidden sm:flex items-center text-sm px-3 py-1.5 bg-gray-50 rounded-lg">
                            <a href="<?php echo e(route('kesiswaan.dashboard')); ?>" class="text-blue-600 font-medium">Kesiswaan</a>
                        ...
                        <div x-data="{ open: false }" class="relative">
                            <button @click="open = !open" class="flex items-center space-x-2 focus:outline-none" id="user-menu-button">
                                <div class="hidden sm:block">
                                    <div class="flex flex-col items-end">
                                        <span class="text-sm font-medium text-gray-800"><?php echo e(Auth::user()->name ?? 'Kesiswaan'); ?></span>
                                ...
                                <div class="h-10 w-10 rounded-full ring-2 ring-blue-500 p-0.5 bg-white overflow-hidden">
                                    <img src="https://ui-avatars.com/api/?name=<?php echo e(Auth::user()->name ?? 'Kesiswaan'); ?>&background=3b82f6&color=ffffff" 
                            ...
                            <div x-show="open" 
                                ...
                                <div class="px-4 py-3 border-b border-gray-100">
                                    ...
                                    <p class="text-sm font-semibold text-gray-800"><?php echo e(Auth::user()->name ?? 'Kesiswaan'); ?></p>
                                </div>
                                <a href="<?php echo e(route('kesiswaan.profile.index')); ?>" class="block px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 group">
                                    <i class="fas fa-user-circle mr-2 text-blue-500 group-hover:text-blue-600"></i> Profil Saya
                                </a>
                                <a href="<?php echo e(route('kesiswaan.dashboard')); ?>" class="block px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 group">
...
<?php /**PATH C:\wamp64\www\website-smk3\resources\views\layouts\kesiswaan.blade.php ENDPATH**/ ?>