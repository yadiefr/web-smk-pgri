...
<?php $__env->startSection('title', 'Manajemen Mata Pelajaran - SMK PGRI CIKAMPEK'); ?>
    ...
    <div class="flex flex-col space-y-6">
            ...
            <div class="relative z-10">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
                    ...
                    <div class="mt-4 md:mt-0">
                        <a href="<?php echo e(route('admin.matapelajaran.create')); ?>" class="bg-amber-600 hover:bg-amber-700 text-white px-5 py-2.5 rounded-lg shadow-sm hover:shadow-md transition-all flex items-center">                            <i class="fas fa-plus mr-2"></i>
                      ...
                      <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-5 rounded-xl shadow-sm hover:shadow-md transition-all border border-blue-200 relative overflow-hidden group">
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="flex flex-col sm:flex-row gap-2 mb-3">
                                ...
                                <a href="<?php echo e(route('admin.matapelajaran.template')); ?>" 
                 ...
                 <div class="mt-3 bg-gray-50 border border-gray-200 p-3 rounded-lg">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-2">
                        <?php if(isset($kelas_list) && count($kelas_list) > 0): ?>
                            ...
                            <?php $__currentLoopData = $uniqueClassNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $className): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center px-3 py-2 bg-white rounded-lg hover:bg-gray-100 transition-colors shadow-sm">
                                <input type="checkbox" name="filterKelasList[]" id="filter_kelas_<?php echo e(str_replace(' ', '_', $className)); ?>" value="<?php echo e($className); ?>" class="filter-kelas-checkbox rounded border-gray-300 text-amber-600 shadow-sm focus:border-amber-500 focus:ring focus:ring-amber-200 focus:ring-opacity-50">
                                <label for="filter_kelas_<?php echo e(str_replace(' ', '_', $className)); ?>" class="ml-2 text-sm text-gray-700"><?php echo e($className); ?></label>
                            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-5">
            <div class="bg-white p-5 rounded-xl shadow-sm hover:shadow-md transition-all border border-gray-100 relative overflow-hidden">
                ...
                <p class="text-3xl font-bold text-gray-800 mt-2"><?php echo e($totalMapel); ?></p>
            ...
            <div class="bg-white p-5 rounded-xl shadow-sm hover:shadow-md transition-all border border-gray-100 relative overflow-hidden">
                ...
                <p class="text-3xl font-bold text-gray-800 mt-2"><?php echo e($guruPengajar->count()); ?></p>
                <div class="flex items-center text-green-600 text-xs mt-2">
                    <i class="fas fa-arrow-up mr-1"></i>
                    <span>Tersedia</span>
                </div>
            ...
            <div class="bg-white p-5 rounded-xl shadow-sm hover:shadow-md transition-all border border-gray-100 relative overflow-hidden">
                ...
                <p class="text-3xl font-bold text-gray-800 mt-2"><?php echo e($totalMapelWajib); ?></p>
            ...
            <div class="bg-white p-5 rounded-xl shadow-sm hover:shadow-md transition-all border border-gray-100 relative overflow-hidden">
                ...
                <p class="text-3xl font-bold text-gray-800 mt-2"><?php echo e($totalMapelKejuruan); ?></p>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">                    <thead class="bg-gray-50">
                        <tr>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                <div class="flex items-center space-x-1">
                                    ...
                                    <div class="flex flex-col">
                                        <a href="<?php echo e(route('admin.matapelajaran.index', ['sort' => 'kode', 'direction' => 'asc'])); ?>" 
                                           class="text-gray-400 hover:text-gray-600 <?php echo e(request('sort') == 'kode' && request('direction') == 'asc' ? 'text-blue-600' : ''); ?>">
                                            <i class="fas fa-caret-up text-xs"></i>
                                        </a>
                                        <a href="<?php echo e(route('admin.matapelajaran.index', ['sort' => 'kode', 'direction' => 'desc'])); ?>" 
                                           class="text-gray-400 hover:text-gray-600 <?php echo e(request('sort') == 'kode' && request('direction') == 'desc' ? 'text-blue-600' : ''); ?>">
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                <div class="flex items-center space-x-1">
                                    ...
                                    <div class="flex flex-col">
                                        <a href="<?php echo e(route('admin.matapelajaran.index', ['sort' => 'nama', 'direction' => 'asc'])); ?>" 
                                           class="text-gray-400 hover:text-gray-600 <?php echo e(request('sort') == 'nama' && request('direction') == 'asc' ? 'text-blue-600' : ''); ?>">
                                            <i class="fas fa-caret-up text-xs"></i>
                                        </a>
                                        <a href="<?php echo e(route('admin.matapelajaran.index', ['sort' => 'nama', 'direction' => 'desc'])); ?>" 
                                           class="text-gray-400 hover:text-gray-600 <?php echo e(request('sort') == 'nama' && request('direction') == 'desc' ? 'text-blue-600' : ''); ?>">
                                            <i class="fas fa-caret-down text-xs"></i>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                <div class="flex items-center space-x-1">
                                    <span>Jenis</span>
                                    <div class="flex flex-col">
                                        <a href="<?php echo e(route('admin.matapelajaran.index', ['sort' => 'jenis', 'direction' => 'asc'])); ?>" 
                                           class="text-gray-400 hover:text-gray-600 <?php echo e(request('sort') == 'jenis' && request('direction') == 'asc' ? 'text-blue-600' : ''); ?>">
                                            <i class="fas fa-caret-up text-xs"></i>
                                        </a>
                                        <a href="<?php echo e(route('admin.matapelajaran.index', ['sort' => 'jenis', 'direction' => 'desc'])); ?>" 
                                           class="text-gray-400 hover:text-gray-600 <?php echo e(request('sort') == 'jenis' && request('direction') == 'desc' ? 'text-blue-600' : ''); ?>">
                                            <i class="fas fa-caret-down text-xs"></i>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <!-- Mata Pelajaran Items -->                        <?php $__empty_1 = true; $__currentLoopData = $mataPelajaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900"><?php echo e($mp->kode); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900"><?php echo e($mp->nama); ?></div>
                            </td>                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-500">
                                    <?php if(isset($mp->assigned_kelas) && $mp->assigned_kelas->count() > 0): ?>
                                        <?php
                                            $assignedKelasNames = [];
                                        ...
                                        <?php else: ?>
                                            <div class="flex flex-wrap gap-1">
                                                <?php $__currentLoopData = $assignedKelasNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <span class="px-2 py-0.5 bg-blue-100 text-blue-700 rounded-md text-xs"><?php echo e($kelas); ?></span>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
                                        <?php endif; ?>
                                ...
                                ?>
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-<?php echo e($jenisColor); ?>-100 text-<?php echo e($jenisColor); ?>-800">
                                    <?php echo e($mp->jenis); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-500">
                                    <?php if(isset($mp->assigned_guru) && $mp->assigned_guru->count() > 0): ?>
                                        <?php if($mp->assigned_guru->count() == 1): ?>
                                            <?php echo e($mp->assigned_guru->first()->nama); ?>

                                        <?php else: ?>
                                            <div class="flex flex-wrap gap-1">
                                                <?php $__currentLoopData = $mp->assigned_guru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guru): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    ...
                                    <button 
                                        ...
                                        data-id="<?php echo e($mp->kode); ?>" 
                                        data-name="<?php echo e($mp->nama); ?>"
                ...
                <div class="flex-1 flex justify-center">
                    <div>
                        <p class="text-sm text-gray-700">
                            Menampilkan
                            <span class="font-medium"><?php echo e($mataPelajaran->count()); ?></span>
                            mata pelajaran
                        </p>
                    </div>
                </div>
...
<div id="importUploadModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
    <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-2/3 lg:w-1/2 shadow-lg rounded-md bg-white">
        ...
        <div class="p-6">
            <!-- Upload Form -->
            <form id="modalImportForm" action="<?php echo e(route('admin.matapelajaran.import')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="max-h-48 overflow-y-auto border border-gray-300 rounded-lg p-3 bg-gray-50">
                                    <?php $__currentLoopData = $guruPengajar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guru): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center mb-2 p-2 hover:bg-blue-50 rounded">
                                            <input type="checkbox" 
                                                   id="assign_guru_<?php echo e($guru->id); ?>" 
                                                   value="<?php echo e($guru->id); ?>" 
                                                   class="assign-guru-checkbox rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                            <label for="assign_guru_<?php echo e($guru->id); ?>" class="ml-3 text-sm text-gray-700 cursor-pointer flex-1">
                                                <span class="font-medium"><?php echo e($guru->nama); ?></span>
                                                <?php if($guru->nip): ?>
                                                    <span class="text-gray-500 text-xs block">NIP: <?php echo e($guru->nip); ?></span>
                                                <?php endif; ?>
                                            </label>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="max-h-48 overflow-y-auto border border-gray-300 rounded-lg p-3 bg-gray-50">
                                    <?php $__currentLoopData = $kelas_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center mb-2 p-2 hover:bg-green-50 rounded">
                                            <input type="checkbox" 
                                                   id="assign_kelas_<?php echo e($kelas->id); ?>" 
                                                   value="<?php echo e($kelas->id); ?>" 
                                                   class="assign-kelas-checkbox rounded border-gray-300 text-green-600 focus:ring-green-500">
                                            <label for="assign_kelas_<?php echo e($kelas->id); ?>" class="ml-3 text-sm text-gray-700 cursor-pointer"><?php echo e($kelas->nama_kelas ?? 'Kelas tidak ditemukan'); ?></label>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                                <div class="mt-2">
...
<script>
    ...
    async function loadImportInfo() {
        try {
            const response = await fetch('<?php echo e(route("admin.matapelajaran.import-info")); ?>');
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\admin\matapelajaran\index.blade.php ENDPATH**/ ?>