...
<head>
    ...
    <title>Berita - <?php echo e(setting('site_title', 'SMK PGRI CIKAMPEK')); ?></title>
    
    <!-- SEO Meta Tags -->
    <meta name="description" content="Berita terbaru dan informasi terkini dari <?php echo e(setting('nama_sekolah', 'SMK PGRI CIKAMPEK')); ?>">
    <meta name="keywords" content="berita, news, <?php echo e(setting('nama_sekolah', 'SMK PGRI CIKAMPEK')); ?>, pendidikan, sekolah">
    <meta name="author" content="<?php echo e(setting('nama_sekolah', 'SMK PGRI CIKAMPEK')); ?>">
    
    <!-- Open Graph Meta Tags -->
    <meta property="og:title" content="Berita - <?php echo e(setting('site_title', 'SMK PGRI CIKAMPEK')); ?>">
    <meta property="og:description" content="Berita terbaru dan informasi terkini dari <?php echo e(setting('nama_sekolah', 'SMK PGRI CIKAMPEK')); ?>">
    ...
    <section class="page-header">
        <div class="container-custom">
            <div class="text-center" data-aos="fade-up">
                ...
                <p class="page-subtitle">Dapatkan berita terbaru dan informasi terkini dari <?php echo e(setting('nama_sekolah', 'SMK PGRI CIKAMPEK')); ?></p>
    ...
    <section class="berita-section">
        <div class="container-custom">
            ...
            <div class="search-filter-bar" data-aos="fade-up">
                <form class="search-form" method="GET" action="<?php echo e(route('berita.index')); ?>">
            ...
            <?php if($berita->count() > 0): ?>
                <div class="berita-grid">
                    <?php $__currentLoopData = $berita; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="berita-card" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                            ...
                            <div class="berita-content">
                                ...
                                <p class="berita-excerpt"><?php echo e(Str::limit(strip_tags($item->isi), 120)); ?></p>
                                
                                <a href="<?php echo e(route('berita.show', $item->id)); ?>" class="berita-link">
                                    Baca Selengkapnya
            ...
            <?php else: ?>
                ...
                <div class="empty-state" data-aos="fade-up">
                    ...
                    <p><?php echo e(request('search') ? 'Tidak ada berita yang sesuai dengan pencarian "' . request('search') . '"' : 'Belum ada berita yang dipublikasikan. Silakan kembali lagi nanti.'); ?></p>
                    <?php if(request('search')): ?>
                        <a href="<?php echo e(route('berita.index')); ?>" class="btn btn-outline-primary mt-3">
