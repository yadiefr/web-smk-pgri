...
<?php $__env->startSection('title', 'Tambah Mata Pelajaran - SMK PGRI CIKAMPEK'); ?>
...
<div class="w-full bg-gray-100 min-h-screen p-4 md:p-6 font-sans">
    ...
    <div class="mb-6">
        <div class="flex items-center mb-2">
            <a href="<?php echo e(route('admin.matapelajaran.index')); ?>" class="flex items-center justify-center w-10 h-10 rounded-lg bg-white shadow-sm hover:bg-amber-50 mr-3 transition-colors">
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-amber-100 to-amber-50 py-4 px-6 border-b border-amber-200">
          ...
          <form action="<?php echo e(route('admin.matapelajaran.store')); ?>" method="POST" id="mapelForm">
            <?php echo csrf_field(); ?>            <!-- Form Content -->
            <div class="p-6">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="kode" id="kode" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-amber-500 focus:ring focus:ring-amber-200 focus:ring-opacity-50" placeholder="Contoh: MP001" value="<?php echo e(old('kode')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="nama" id="nama" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-amber-500 focus:ring focus:ring-amber-200 focus:ring-opacity-50" placeholder="Contoh: Matematika" value="<?php echo e(old('nama')); ?>" required>
                        ...
                        <div>
                            ...
                            <select name="guru_id" id="guru_id" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-amber-500 focus:ring focus:ring-amber-200 focus:ring-opacity-50" required>
                                ...
                                <?php $__currentLoopData = $guru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($g->id); ?>" <?php echo e(old('guru_id') == $g->id ? 'selected' : ''); ?>><?php echo e($g->nama); ?> <?php echo e(!empty($g->nip) ? '('.$g->nip.')' : ''); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
unset($__errorArgs, $__bag); ?>                        </div>
                        ...
                        <div>
                            <div class="flex items-center p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-100">
                                <input type="checkbox" name="is_jurusan" id="is_jurusan" value="1" class="rounded border-blue-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" <?php echo e(old('is_jurusan') ? 'checked' : ''); ?>>
                        ...
                        <div>
                            ...
                            <select name="tahun_ajaran" id="tahun_ajaran" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-amber-500 focus:ring focus:ring-amber-200 focus:ring-opacity-50" required>
                                ...
                                <?php for($i = $currentYear+1; $i >= $currentYear-2; $i--): ?>
                                    <option value="<?php echo e($i); ?>/<?php echo e($i+1); ?>" <?php echo e(old('tahun_ajaran') == "$i/".($i+1) ? 'selected' : ($i == $currentYear ? 'selected' : '')); ?>><?php echo e($i); ?>/<?php echo e($i+1); ?></option>
                                <?php endfor; ?>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="kkm" id="kkm" min="1" max="100" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-amber-500 focus:ring focus:ring-amber-200 focus:ring-opacity-50" placeholder="Contoh: 75" value="<?php echo e(old('kkm')); ?>" required>
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="deskripsi" id="deskripsi" rows="4" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-amber-500 focus:ring focus:ring-amber-200 focus:ring-opacity-50" placeholder="Deskripsi singkat tentang mata pelajaran ini..."><?php echo e(old('deskripsi')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-8 border-t border-gray-100 pt-6 flex justify-end">
                    <div class="flex items-center space-x-4">
                        <a href="<?php echo e(route('admin.matapelajaran.index')); ?>" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-lg transition-colors flex items-center">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\admin\matapelajaran\create.blade.php ENDPATH**/ ?>