...
<?php $__env->startSection('title', 'Manajemen Keuangan Siswa'); ?>
    ...
    <div class="px-8 py-6">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                <a href="<?php echo e(route('admin.keuangan.tagihan.create')); ?>"
        ...
        <div class="flex items-start">
            ...
            <div class="ml-4">
                <?php if($errors->count() == 1): ?>
                    <p class="text-red-800 font-medium"><?php echo e($errors->first()); ?></p>
                <?php else: ?>
...
<div class="bg-white rounded-2xl shadow-lg p-6 mb-8 border border-gray-100">
    ...
    <form method="GET" class="space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    <select name="tahun_ajaran" class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-gray-50 focus:bg-white appearance-none">
                        ...
                        <option value="2024/2025" <?php echo e(request('tahun_ajaran') == '2024/2025' ? 'selected' : ''); ?>>2024/2025</option>
                        <option value="2023/2024" <?php echo e(request('tahun_ajaran') == '2023/2024' ? 'selected' : ''); ?>>2023/2024</option>
                        <option value="2022/2023" <?php echo e(request('tahun_ajaran') == '2022/2023' ? 'selected' : ''); ?>>2022/2023</option>
                    </select>
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            ...
            <div class="space-y-2">
                ...
                <div class="flex flex-col space-y-2">
                    ...
                    <a href="<?php echo e(route('admin.keuangan.index')); ?>" class="w-full inline-flex items-center justify-center px-4 py-3 bg-gray-100 text-gray-700 font-semibold rounded-xl hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-all duration-200">
        ...
        <input type="hidden" name="sort_by" value="<?php echo e(request('sort_by', 'kelas_id')); ?>">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
                <span class="px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-xs font-medium">
                    <?php echo e($tagihanList->count()); ?> Tagihan
                </span>
            </div>
        </div>
    </div>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-100">
                <?php $__empty_1 = true; $__currentLoopData = $tagihanList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tagihan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="hover:bg-purple-50 transition-colors duration-200 group">
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                <div class="text-sm font-semibold text-gray-900 group-hover:text-purple-600 transition-colors">
                                    <?php echo e($tagihan->nama_tagihan); ?>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-orange-100 text-orange-800">
                            ...
                            <?php echo e($tagihan->tanggal_jatuh_tempo); ?>

                        </span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900">
                            <?php if($tagihan->siswa_id): ?>
                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800">
                                    <i class="fas fa-user mr-1"></i>
                                    <?php echo e($tagihan->siswa->nama_lengkap ?? $tagihan->siswa->nama ?? '-'); ?>

                                </span>
                            <?php elseif($tagihan->kelas_id): ?>
                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                    <i class="fas fa-graduation-cap mr-1"></i>
                                    <?php echo e($tagihan->kelas->nama_kelas ?? '-'); ?>

                                </span>
                                <?php if($tagihan->jumlah_siswa > 1): ?>
                                    <div class="text-xs text-gray-500 mt-1">
                                        <i class="fas fa-users mr-1"></i>
                                        <?php echo e($tagihan->jumlah_siswa); ?> siswa terkena
                                    </div>
                                <?php endif; ?>
                            <?php else: ?>
                                <?php
                    ...
                    <td class="px-6 py-4">
                        <div class="text-sm text-gray-600 max-w-xs truncate" title="<?php echo e($tagihan->keterangan); ?>">
                            <?php echo e($tagihan->keterangan ?: '-'); ?>

                        </div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-center">
                        <div class="flex justify-center space-x-2">
                            <a href="<?php echo e(route('admin.keuangan.tagihan.edit', $tagihan->id)); ?>"
                            ...
                            <form action="<?php echo e(route('admin.keuangan.tagihan.delete', $tagihan->id)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Apakah Anda yakin ingin menghapus tagihan ini?')">
                                <?php echo csrf_field(); ?>
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600">Total <?php echo e($siswaList->count()); ?> siswa ditemukan</p>
                </div>
            </div>
            <div class="flex items-center space-x-2">
                ...
                <tr>
                    ...
                    <th class="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">
                        <button type="button" onclick="sortTable('nama_lengkap')" class="flex items-center space-x-2 hover:text-blue-600 focus:outline-none transition-colors group">
                            ...
                            <?php if(request('sort_by') == 'nama_lengkap'): ?>
                                <i class="fas fa-sort-<?php echo e(request('sort_order') == 'asc' ? 'up' : 'down'); ?> text-blue-600"></i>
                            <?php else: ?>
                    ...
                    <th class="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">
                        <button type="button" onclick="sortTable('kelas_id')" class="flex items-center space-x-2 hover:text-blue-600 focus:outline-none transition-colors group">
                            ...
                            <span>Kelas</span>
                            <?php if(request('sort_by') == 'kelas_id'): ?>
                                <i class="fas fa-sort-<?php echo e(request('sort_order') == 'asc' ? 'up' : 'down'); ?> text-blue-600"></i>
                            <?php else: ?>
                                <i class="fas fa-sort text-gray-400 group-hover:text-blue-600"></i>
                            <?php endif; ?>
                    ...
                    <th class="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">
                        <button type="button" onclick="sortTable('tahun_masuk')" class="flex items-center space-x-2 hover:text-blue-600 focus:outline-none transition-colors group">
                            ...
                            <?php if(request('sort_by') == 'tahun_masuk'): ?>
                                <i class="fas fa-sort-<?php echo e(request('sort_order') == 'asc' ? 'up' : 'down'); ?> text-blue-600"></i>
                            <?php else: ?>
                                <i class="fas fa-sort text-gray-400 group-hover:text-blue-600"></i>
                            <?php endif; ?>
                ...
                <tr class="hover:bg-blue-50 transition-colors duration-200 group">
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                            <div class="w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center mr-3">
                                <span class="text-white font-bold text-sm"><?php echo e(strtoupper(substr($siswa->nama_lengkap ?? $siswa->nama, 0, 1))); ?></span>
                            </div>
                            <div>
                                <div class="text-sm font-semibold text-gray-900 group-hover:text-blue-600 transition-colors">
                                    <?php echo e($siswa->nama_lengkap ?? $siswa->nama); ?>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
                            <i class="fas fa-calendar mr-1"></i>
                            <?php echo e($siswa->tahun_masuk); ?>/<?php echo e($siswa->tahun_masuk + 1); ?>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm font-bold text-purple-700">
                                Rp <?php echo e(number_format($siswa->total_tagihan ?? 0,0,',','.')); ?>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                            <div class="w-2 h-2 bg-green-500 rounded-full mr-2"></div>
                            <span class="text-sm font-bold text-green-700">
                                Rp <?php echo e(number_format($siswa->total_telah_dibayar ?? 0,0,',','.')); ?>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm font-bold text-red-700">
                                Rp <?php echo e(number_format($siswa->tunggakan ?? 0,0,',','.')); ?>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-center">
                        <a href="<?php echo e(route('admin.keuangan.riwayat', $siswa->id)); ?>"
                ...
                <div class="p-6">
                    <div class="flex items-center mb-4">
                        <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center mr-4">
                            <span class="text-white font-bold"><?php echo e(strtoupper(substr($siswa->nama_lengkap ?? $siswa->nama, 0, 1))); ?></span>
                        </div>
                        <div class="flex-1">
                            <h3 class="font-semibold text-gray-900 text-sm"><?php echo e($siswa->nama_lengkap ?? $siswa->nama); ?></h3>
                            <p class="text-xs text-gray-500"><?php echo e($siswa->nis); ?></p>
                        </div>
                        <?php if(($siswa->status_keuangan ?? 'Belum Lunas') == 'Lunas'): ?>
                    ...
                    <div class="space-y-3 mb-4">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-xs font-medium text-blue-600"><?php echo e($siswa->kelas->nama_kelas ?? '-'); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-xs text-gray-600">Total Tagihan:</span>
                            <span class="text-xs font-bold text-purple-600">Rp <?php echo e(number_format($siswa->total_tagihan ?? 0,0,',','.')); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-xs text-gray-600">Dibayar:</span>
                            <span class="text-xs font-bold text-green-600">Rp <?php echo e(number_format($siswa->total_telah_dibayar ?? 0,0,',','.')); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-xs text-gray-600">Tunggakan:</span>
                            <span class="text-xs font-bold text-red-600">Rp <?php echo e(number_format($siswa->tunggakan ?? 0,0,',','.')); ?></span>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\admin\keuangan\index.blade.php ENDPATH**/ ?>