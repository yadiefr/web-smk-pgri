...
<div class="container mx-auto px-4 py-8">
    ...
    <form action="<?php echo e(route('admin.keunggulan.store')); ?>" method="POST" class="bg-white shadow-md rounded-lg p-6">
        <?php echo csrf_field(); ?>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="ikon" id="ikon" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="<?php echo e(old('ikon')); ?>">
        </div>
        <div class="mb-4">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\admin\keunggulan\create.blade.php ENDPATH**/ ?>