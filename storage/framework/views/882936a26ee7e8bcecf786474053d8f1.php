...
<?php $__env->startSection('title', 'Edit Tugas - SMK PGRI CIKAMPEK'); ?>
...
<div class="px-3 py-4">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        <form action="<?php echo e(route('guru.materi.update-tugas', $tugas->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                ...
                <div class="grid lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="judul" name="judul" value="<?php echo e(old('judul', $tugas->judul)); ?>" required
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__currentLoopData = $kelasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($kelas->id); ?>" <?php echo e((old('kelas_id', $tugas->kelas_id) == $kelas->id) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__currentLoopData = $mapelList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mapel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($mapel->id); ?>" <?php echo e((old('mapel_id', $tugas->mapel_id) == $mapel->id) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="date" id="tanggal_deadline" name="tanggal_deadline" 
                                   value="<?php echo e(old('tanggal_deadline', $tugas->tanggal_deadline ? $tugas->tanggal_deadline->format('Y-m-d') : '')); ?>" required
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="bg-orange-50 border border-orange-200 rounded-lg p-4">
                            ...
                            <div class="flex items-center justify-between">
                                <span class="text-sm text-orange-700"><?php echo e($tugas->file_name ?? basename($tugas->file_path)); ?></span>
                        ...
                        <div>
                            <label for="file" class="block text-sm font-medium text-gray-700 mb-2">
                                <?php echo e($tugas->file_path ? 'Ganti File Soal (Opsional)' : 'File Soal (Opsional)'); ?>
...
4. Upload jawaban dalam format PDF"><?php echo e(old('deskripsi', $tugas->deskripsi)); ?></textarea>
...
<?php echo $__env->make('layouts.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\website-smk3\resources\views\guru\materi\edit-tugas.blade.php ENDPATH**/ ?>