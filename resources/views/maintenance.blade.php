...
<body>
    <div class="maintenance-container">
        ...
        <h2 class="maintenance-subtitle">{{ $nama_sekolah }}</h2>
        ...
        @if($isAuthenticated)
            ...
            <div style="margin-bottom: 1rem;">
                <span style="background: rgba(255, 255, 255, 0.1); padding: 0.5rem 1rem; border-radius: 20px; display: inline-block;">
                    <i class="fas fa-user"></i> Status Login : {{ $roleText }}
                </span>
            </div>
        ...
        <div class="social-links">
            ...
            @if(setting('youtube_url'))
                <a href="{{ setting('youtube_url') }}" class="social-link" target="_blank">
                    <i class="fab fa-youtube"></i>
                </a>
            @endif
            
            @if(setting('whatsapp_number'))
                <a href="https://wa.me/{{ setting('whatsapp_number') }}" class="social-link" target="_blank">
