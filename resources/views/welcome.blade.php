...
<head>
    ...
    <script>
        ...
        window.isProduction = @json($isProduction);
        window.currentDomain = @json($currentDomain);
        window.whatsappNumber = @json(setting('whatsapp_number', '08123456789'));
        window.schoolName = @json(setting('nama_sekolah', 'sekolah'));
    </script>
    ...
    <section class="programs py-20 relative" id="programs">
        ...
        <div class="mobile-consistent-padding relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 items-stretch">
                ...
                <div class="program-card-modern" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                    <div class="glass">
                        <!-- Program Image/Icon -->
                        <div class="program-image-container relative">
                            @if(file_exists(public_path('images/jurusan/'.$jur->kode_jurusan.'.jpg')))
                                <img src="{{ asset('images/jurusan/'.$jur->kode_jurusan.'.jpg') }}" class="program-image-modern" alt="{{ $jur->nama_jurusan }}">
                            ...
                            <div class="program-overlay">
                                <span class="program-code">{{ $jur->kode_jurusan }}</span>
                            </div>
                        </div>
    ...
    <section class="news py-20 relative" id="news">
        ...
        <div class="mobile-consistent-padding relative z-10">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
                ...
                <div class="news-card-modern" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}" data-category="pengumuman">
                    <div class="glass card-3d overflow-hidden h-full">
                        <!-- News Image -->
                        <div class="news-image-container relative">
                            @if($p->lampiran)
                                <img src="{{ asset('storage/' . $p->lampiran) }}" alt="{{ $p->judul }}" class="news-image-modern">
                                <div class="absolute inset-0 bg-gradient-to-t from-dark-bg/90 via-transparent to-transparent"></div>
                            @else
                ...
                @foreach($berita as $b)
                <div class="news-card-modern" data-aos="fade-up" data-aos-delay="{{ ($loop->index + count($pengumuman)) * 100 }}" data-category="berita">
                    <div class="glass card-3d overflow-hidden h-full">
                        <!-- News Image -->
                        <div class="news-image-container relative">
                            @if($b->foto)
                                <img src="{{ asset('storage/' . $b->foto) }}" alt="{{ $b->judul }}" class="news-image-modern">
                                <div class="absolute inset-0 bg-gradient-to-t from-dark-bg/90 via-transparent to-transparent"></div>
                            @else
                                <div class="news-placeholder">
            ...
            <div class="text-center" data-aos="fade-up">
                <a href="{{ route('berita.index') }}" class="cta-button-modern group">
    ...
    <section class="gallery py-20 relative" id="gallery">
        ...
        <div class="mobile-consistent-padding relative z-10">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-3 mb-8" data-aos="fade-up">
                ...
                <div class="gallery-item-modern" data-category="{{ $item->kategori }}">
            ...
            <div class="text-center" data-aos="fade-up">
                <a href="{{ route('galeri.index') }}" class="cta-button-modern group">
                    <div class="flex items-center">
                        <div class="cta-icon-modern">
                        ...
                        <div class="cta-content-modern">
                            ...
                            <div class="cta-subtitle-modern">{{ $galeri->count() }} koleksi foto tersedia</div>
                        </div>
                        <div class="cta-arrow-modern">
                            <i class="fas fa-arrow-right transition-transform group-hover:translate-x-2"></i>
                        </div>
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6" id="hubungi-kami-grid">
                ...
                <div class="info-card-modern" data-aos="fade-up" data-aos-delay="400">
                    <div class="glass card-3d p-4 lg:p-6 text-center h-full flex flex-col justify-center">
                        ...
                        <a href="{{ route('ppdb.register') }}" class="register-btn-modern text-xs lg:text-sm px-3 lg:px-6 py-1 lg:py-2">
                            Daftar
                        </a>
                    </div>
                </div>
            ...
            <div class="footer-main-modern py-8" data-aos="fade-up">
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="footer-info-modern lg:col-span-2">
                        <a href="{{ url('/') }}" class="footer-logo-modern mb-4 inline-flex items-center">
                            <img src="{{ setting('logo_sekolah') ? asset('storage/' . setting('logo_sekolah')) : asset('images/default-logo.png') }}" alt="Logo" class="h-12 w-12 mr-3">
                            <span class="footer-logo-text">{{ setting('nama_sekolah', 'SMK PGRI CIKAMPEK') }}</span>
                        </a>
                        
                        <p class="footer-description-modern">
                            {{ setting('site_description', 'Mempersiapkan generasi muda untuk menjadi talenta digital berkualitas yang siap menghadapi tantangan industri teknologi masa depan.') }}
                        </p>
                ...
                <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div class="footer-social-modern" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="social-links-modern">
                            ...
                            <a href="{{ setting('facebook_url') }}" class="social-link-modern facebook" target="_blank" aria-label="Facebook">
                                <i class="fab fa-facebook-f"></i>
                            </a>
                            @endif
                            
                            @if(setting('instagram_url'))
                            <a href="{{ setting('instagram_url') }}" class="social-link-modern instagram" target="_blank" aria-label="Instagram">
                                <i class="fab fa-instagram"></i>
                            </a>
                            @endif
                            
                            @if(setting('youtube_url'))
                            <a href="{{ setting('youtube_url') }}" class="social-link-modern youtube" target="_blank" aria-label="YouTube">
                                <i class="fab fa-youtube"></i>
                            </a>
                            @endif
                            
                            @if(setting('whatsapp_number'))
                            <a href="https://wa.me/{{ setting('whatsapp_number') }}" class="social-link-modern whatsapp" target="_blank" aria-label="WhatsApp">
                    ...
                    <div class="footer-copyright-modern text-center md:text-right" data-aos="fade-up" data-aos-delay="200">
                        <div class="copyright-text">
                            &copy; {{ date('Y') }} {{ setting('nama_sekolah', 'SMK PGRI CIKAMPEK') }}
                        </div>
                        <div class="made-with">
