...
<head>
    ...
    <title>@yield('title', 'Sistem Ujian - SMK PGRI CIKAMPEK')</title>
                ...
                <div class="overflow-y-auto h-full lg:h-full scrollbar-thin scrollbar-thumb-blue-200 scrollbar-track-gray-50">
                    <nav class="p-3 pt-2">
                        <ul class="space-y-0.5">
                            <li>
                                <a href="{{ route('admin.ujian.bank-soal.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.ujian.bank-soal.*') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium shadow-sm' : 'hover:bg-gray-50 transition-all duration-300 group' }}">
                                    <i class="fas fa-book {{ request()->routeIs('admin.ujian.bank-soal.*') ? '' : 'text-gray-600 group-hover:text-blue-600' }}"></i>
                                    <span>Bank Soal</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.ujian.jadwal.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.ujian.jadwal.*') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium shadow-sm' : 'hover:bg-gray-50 transition-all duration-300 group' }}">
                                    <i class="fas fa-calendar-check {{ request()->routeIs('admin.ujian.jadwal.*') ? '' : 'text-gray-600 group-hover:text-blue-600' }}"></i>
                                    <span>Jadwal Ujian</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.ujian.pengawas.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.ujian.pengawas.*') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium shadow-sm' : 'hover:bg-gray-50 transition-all duration-300 group' }}">
                                    <i class="fas fa-user-shield {{ request()->routeIs('admin.ujian.pengawas.*') ? '' : 'text-gray-600 group-hover:text-orange-600' }}"></i>
                                    <span>Jadwal Pengawas</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.ujian.monitoring') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.ujian.monitoring') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium shadow-sm' : 'hover:bg-gray-50 transition-all duration-300 group' }}">
                                    <i class="fas fa-desktop {{ request()->routeIs('admin.ujian.monitoring') ? '' : 'text-gray-600 group-hover:text-blue-600' }}"></i>
                            ...
                            <li>
                                <a href="{{ route('admin.ujian.hasil.kelas') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.ujian.hasil.*') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium shadow-sm' : 'hover:bg-gray-50 transition-all duration-300 group' }}">
                                    <i class="fas fa-file-alt {{ request()->routeIs('admin.ujian.hasil.*') ? '' : 'text-gray-600 group-hover:text-blue-600' }}"></i>
                                    <span>Hasil Ujian</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.ujian.analisis.tingkat-kesulitan') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.ujian.analisis.*') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium shadow-sm' : 'hover:bg-gray-50 transition-all duration-300 group' }}">
                                    <i class="fas fa-chart-line {{ request()->routeIs('admin.ujian.analisis.*') ? '' : 'text-gray-600 group-hover:text-blue-600' }}"></i>
                            ...
                            <li>
                                <a href="{{ route('admin.ujian.pengaturan.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.ujian.pengaturan.index') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium shadow-sm' : 'hover:bg-gray-50 transition-all duration-300 group' }}">
                                    <i class="fas fa-cog {{ request()->routeIs('admin.ujian.pengaturan.index') ? '' : 'text-gray-600 group-hover:text-blue-600' }}"></i>
                                    <span>Pengaturan Ujian</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.ujian.pengaturan.jenis-ujian.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.ujian.pengaturan.jenis-ujian.*') ? 'bg-gradient-to-r from-purple-500 to-purple-600 text-white font-medium shadow-sm' : 'hover:bg-gray-50 transition-all duration-300 group' }}">
                                    <i class="fas fa-list-alt {{ request()->routeIs('admin.ujian.pengaturan.jenis-ujian.*') ? '' : 'text-gray-600 group-hover:text-purple-600' }}"></i>
                                    <span>Jenis Ujian</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.ujian.pengaturan.ruangan.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.ujian.pengaturan.ruangan.*') ? 'bg-gradient-to-r from-green-500 to-green-600 text-white font-medium shadow-sm' : 'hover:bg-gray-50 transition-all duration-300 group' }}">
                                    <i class="fas fa-door-open {{ request()->routeIs('admin.ujian.pengaturan.ruangan.*') ? '' : 'text-gray-600 group-hover:text-green-600' }}"></i>
                                    <span>Kelola Ruangan</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-50 transition-all duration-300 group" data-no-spa="true">
