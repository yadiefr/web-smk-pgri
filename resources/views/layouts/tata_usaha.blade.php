...
<head>
    ...
    <title>@yield('title', 'Tata Usaha - SMK PGRI CIKAMPEK')</title>
                ...
                <div class="overflow-y-auto h-full lg:h-full scrollbar-thin scrollbar-thumb-green-200 scrollbar-track-gray-50">
                    <nav class="p-3 pt-2">
                        <ul class="space-y-0.5">
                            <li>
                                <a href="{{ route('tata-usaha.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('tata-usaha.index') ? 'bg-gradient-to-r from-green-500 to-green-600 text-white font-medium shadow-sm' : 'hover:bg-gray-50 transition-all duration-300 group' }}">
                                    <i class="fas fa-home {{ request()->routeIs('tata-usaha.index') ? '' : 'text-gray-600 group-hover:text-green-600' }}"></i>
                                    <span>Dashboard</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="{{ route('tata-usaha.siswa.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('tata-usaha.siswa.*') ? 'bg-gradient-to-r from-green-500 to-green-600 text-white font-medium shadow-sm' : 'hover:bg-gray-50 transition-all duration-300 group' }}">
                                    <i class="fas fa-users {{ request()->routeIs('tata-usaha.siswa.*') ? '' : 'text-gray-600 group-hover:text-green-600' }}"></i>
                                    <span>Data Siswa</span>
                                </a>
                            </li>
                            
                            <li>
                                <a href="{{ route('tata-usaha.siswa.create') }}" class="flex items-center space-x-3 p-3 rounded-lg ml-6 hover:bg-gray-50 transition-all duration-300 group">
                            ...
                            <li>
                                <a href="{{ route('tata-usaha.siswa.mutasi') }}" class="flex items-center space-x-3 p-3 rounded-lg ml-6 hover:bg-gray-50 transition-all duration-300 group">
                            ...
                            <li>
                                <a href="{{ route('tata-usaha.keuangan.pembayaran') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('tata-usaha.keuangan.pembayaran') ? 'bg-gradient-to-r from-green-500 to-green-600 text-white font-medium shadow-sm' : 'hover:bg-gray-50 transition-all duration-300 group' }}">
                                    <i class="fas fa-credit-card {{ request()->routeIs('tata-usaha.keuangan.pembayaran') ? '' : 'text-gray-600 group-hover:text-green-600' }}"></i>
                                    <span>Pembayaran</span>
                                </a>
                            </li>
                            
                            <li>
                                <a href="{{ route('tata-usaha.keuangan.tagihan') }}" class="flex items-center space-x-3 p-3 rounded-lg ml-6 hover:bg-gray-50 transition-all duration-300 group">
                            ...
                            <li>
                                <a href="{{ route('tata-usaha.keuangan.tunggakan') }}" class="flex items-center space-x-3 p-3 rounded-lg ml-6 hover:bg-gray-50 transition-all duration-300 group">
                            ...
                            <li>
                                <a href="{{ route('tata-usaha.laporan') }}" class="flex items-center space-x-3 p-3 rounded-lg ml-6 {{ request()->routeIs('tata-usaha.laporan') ? 'bg-gradient-to-r from-green-500 to-green-600 text-white font-medium shadow-sm' : 'hover:bg-gray-50 transition-all duration-300 group' }}">
                                    <i class="fas fa-chart-bar {{ request()->routeIs('tata-usaha.laporan') ? '' : 'text-gray-500 group-hover:text-green-600' }}"></i>
                            ...
                            <li>
                                <a href="{{ route('tata-usaha.administrasi.surat') }}" class="flex items-center space-x-3 p-3 rounded-lg ml-6 hover:bg-gray-50 transition-all duration-300 group">
                            ...
                            <li>
                                <a href="{{ route('tata-usaha.administrasi.dokumen') }}" class="flex items-center space-x-3 p-3 rounded-lg ml-6 hover:bg-gray-50 transition-all duration-300 group">
                            ...
                            <li>
                                <a href="{{ route('tata-usaha.administrasi.arsip') }}" class="flex items-center space-x-3 p-3 rounded-lg ml-6 hover:bg-gray-50 transition-all duration-300 group">
                            ...
                            <li>
                                <a href="{{ route('tata-usaha.inventaris.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('tata-usaha.inventaris.*') ? 'bg-gradient-to-r from-green-500 to-green-600 text-white font-medium shadow-sm' : 'hover:bg-gray-50 transition-all duration-300 group' }}">
                                    <i class="fas fa-boxes {{ request()->routeIs('tata-usaha.inventaris.*') ? '' : 'text-gray-600 group-hover:text-green-600' }}"></i>
                                    <span>Inventaris</span>
                                </a>
                            </li>
                            
                            <li>
                                <a href="{{ route('tata-usaha.guru.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('tata-usaha.guru.*') ? 'bg-gradient-to-r from-green-500 to-green-600 text-white font-medium shadow-sm' : 'hover:bg-gray-50 transition-all duration-300 group' }}">
                                    <i class="fas fa-chalkboard-teacher {{ request()->routeIs('tata-usaha.guru.*') ? '' : 'text-gray-600 group-hover:text-green-600' }}"></i>
                                    <span>Data Guru</span>
                                </a>
                            </li>
                            
                            <li>
                                <a href="{{ route('tata-usaha.master.kelas') }}" class="flex items-center space-x-3 p-3 rounded-lg ml-6 hover:bg-gray-50 transition-all duration-300 group">
                            ...
                            <li>
                                <a href="{{ route('tata-usaha.master.jurusan') }}" class="flex items-center space-x-3 p-3 rounded-lg ml-6 hover:bg-gray-50 transition-all duration-300 group">
                            ...
                            <li>
                                <a href="{{ route('tata-usaha.master.tahun-ajaran') }}" class="flex items-center space-x-3 p-3 rounded-lg ml-6 hover:bg-gray-50 transition-all duration-300 group">
                            ...
                            <li>
                                <a href="{{ route('tata-usaha.settings') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('tata-usaha.settings') ? 'bg-gradient-to-r from-green-500 to-green-600 text-white font-medium shadow-sm' : 'hover:bg-gray-50 transition-all duration-300 group' }}">
                                    <i class="fas fa-cog {{ request()->routeIs('tata-usaha.settings') ? '' : 'text-gray-600 group-hover:text-green-600' }}"></i>
                                    <span>Pengaturan</span>
                                </a>
                            </li>
                            
                            <li>
                                <a href="{{ route('tata-usaha.help') }}" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-50 transition-all duration-300 group">
                        ...
                        <div class="mt-6 p-4 bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl border border-green-100 hover:shadow-md transition-all">
                            ...
                            <a href="{{ route('tata-usaha.help') }}" class="block w-full mt-2 bg-gradient-to-r from-green-500 to-green-600 border border-green-200 rounded-lg py-2 text-center text-sm text-white hover:shadow-lg hover:from-green-600 hover:to-green-700 transition-all duration-300">
                                Bantuan
                            </a>
                        </div>
                    </nav>
                ...
                <div class="px-6 py-3 flex justify-between items-center h-full">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="hidden sm:flex items-center text-sm px-3 py-1.5 bg-gray-50 rounded-lg">
                            <a href="{{ route('tata-usaha.index') }}" class="text-green-600 font-medium">Dashboard</a>
                            @if(!request()->routeIs('tata-usaha.index'))
                        ...
                        <div x-data="{ open: false }" class="relative">
                            <button @click="open = !open" class="flex items-center space-x-2 focus:outline-none" id="user-menu-button">
                                <div class="hidden sm:block">
                                    <div class="flex flex-col items-end">
                                        <span class="text-sm font-medium text-gray-800">{{ Auth::user()->name ?? 'Tata Usaha' }}</span>
                                ...
                                <div class="h-10 w-10 rounded-full ring-2 ring-green-500 p-0.5 bg-white overflow-hidden">
                                    <img src="https://ui-avatars.com/api/?name={{ Auth::user()->name ?? 'Tata Usaha' }}&background=22c55e&color=ffffff" 
                            ...
                            <div x-show="open" 
                                ...
                                <div class="px-4 py-3 border-b border-gray-100">
                                    ...
                                    <p class="text-sm font-semibold text-gray-800">{{ Auth::user()->name ?? 'Tata Usaha' }}</p>
                                </div>
                                <a href="{{ route('tata-usaha.settings') }}" class="block px-4 py-2.5 text-sm text-gray-700 hover:bg-green-50 group">
                                ...
                                <a href="{{ route('tata-usaha.help') }}" class="block px-4 py-2.5 text-sm text-gray-700 hover:bg-green-50 group">
