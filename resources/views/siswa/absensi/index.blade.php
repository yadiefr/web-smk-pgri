                ...
                <div class="bg-green-50 rounded-lg p-3">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-xl font-bold text-green-800">{{ $absensi->where('status', 'hadir')->count() }}</p>
                        </div>
                    </div>
                </div>
                <div class="bg-blue-50 rounded-lg p-3">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-xl font-bold text-blue-800">{{ $absensi->where('status', 'izin')->count() }}</p>
                        </div>
                    </div>
                </div>
                <div class="bg-yellow-50 rounded-lg p-3">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-xl font-bold text-yellow-800">{{ $absensi->where('status', 'sakit')->count() }}</p>
                        </div>
                    </div>
                </div>
                <div class="bg-red-50 rounded-lg p-3">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-xl font-bold text-red-800">{{ $absensi->where('status', 'alpha')->count() }}</p>
                        </div>
                    </div>
                </div>
                <div class="bg-gray-50 rounded-lg p-3">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-xl font-bold text-gray-800">{{ $statistik['total_hari_ini'] ?? 0 }}</p>
                        </div>
                    </div>
                </div>
                <div class="bg-indigo-50 rounded-lg p-3">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-xl font-bold text-indigo-800">{{ $statistik['total_minggu_ini'] ?? 0 }}</p>
                        </div>
                    </div>
                </div>
                <div class="bg-purple-50 rounded-lg p-3">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-xl font-bold text-purple-800">{{ $statistik['total_bulan_ini'] ?? 0 }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200" id="absensiTable">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-900">
                                {{ $data->mapel->nama ?? 'Mata Pelajaran Tidak Ditemukan' }}
                            </td>
                            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-900">
                                {{ $data->guru->nama ?? 'Guru Tidak Ditemukan' }}
                            </td>
                            ...
                            <td class="px-4 py-3 whitespace-nowrap text-sm">
                                <a href="{{ route('siswa.absensi.show', $data->id) }}" 
...
function exportAbsensi() {
    ...
    let url = '{{ route("siswa.absensi") }}?export=excel';
...
function printAbsensi() {
    ...
    printWindow.document.write(`
        <html>
            <head>
                <title>Absensi - {{ Auth::guard('siswa')->user()->nama_lengkap }}</title>
                ${styles}
            </head>
            <body>
                <h2>Absensi</h2>
                <p><strong>Nama:</strong> {{ Auth::guard('siswa')->user()->nama_lengkap }}</p>
                <p><strong>Kelas:</strong> {{ Auth::guard('siswa')->user()->kelas->nama_kelas ?? 'Tidak ada kelas' }}</p>
