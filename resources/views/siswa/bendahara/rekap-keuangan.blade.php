    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600">{{ $kelas->nama_kelas }} - {{ DateTime::createFromFormat('!m', $bulan)->format('F') }} {{ $tahun }}</p>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-3 sm:p-4 lg:p-6 hover:shadow-md transition-shadow">
            <div class="flex flex-col lg:flex-row lg:items-center">
                ...
                <div class="lg:ml-4 text-center lg:text-left">
                    ...
                    <p class="text-sm sm:text-lg lg:text-xl font-bold text-gray-800">Rp {{ number_format($totalTagihanKeseluruhan, 0, ',', '.') }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-3 sm:p-4 lg:p-6 hover:shadow-md transition-shadow">
            <div class="flex flex-col lg:flex-row lg:items-center">
                ...
                <div class="lg:ml-4 text-center lg:text-left">
                    ...
                    <p class="text-sm sm:text-lg lg:text-xl font-bold text-gray-800">Rp {{ number_format($totalDibayarKeseluruhan, 0, ',', '.') }}</p>
                    <p class="text-xs text-gray-400">{{ $totalTagihanKeseluruhan > 0 ? number_format(($totalDibayarKeseluruhan / $totalTagihanKeseluruhan) * 100, 1) : 0 }}%</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-3 sm:p-4 lg:p-6 hover:shadow-md transition-shadow">
            <div class="flex flex-col lg:flex-row lg:items-center">
                ...
                <div class="lg:ml-4 text-center lg:text-left">
                    ...
                    <p class="text-sm sm:text-lg lg:text-xl font-bold text-gray-800">Rp {{ number_format($totalPembayaranBulan, 0, ',', '.') }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-3 sm:p-4 lg:p-6 hover:shadow-md transition-shadow">
            <div class="flex flex-col lg:flex-row lg:items-center">
                ...
                <div class="lg:ml-4 text-center lg:text-left">
                    ...
                    <p class="text-sm sm:text-lg lg:text-xl font-bold text-gray-800">{{ $siswaLunas }}</p>
                    <p class="text-xs text-gray-400">dari {{ $siswaLunas + $siswaBelumLunas }} siswa</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach($detailKeuangan as $index => $data)
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $index + 1 }}</td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900">{{ $data['siswa']['nama'] }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $data['siswa']['nis'] }}</td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium {{ $data['tunggakan'] > 0 ? 'text-red-600' : 'text-green-600' }}">
                            Rp {{ number_format($data['tunggakan'], 0, ',', '.') }}
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium text-blue-600">
                            Rp {{ number_format($data['pembayaran_bulan'], 0, ',', '.') }}
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <a href="{{ route('siswa.bendahara.detail-siswa', $data['siswa']['id']) }}" 
        ...
        <div class="mt-4 pt-4 border-t border-gray-200">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
                <div class="text-center">
                    ...
                    <p class="text-lg font-bold text-blue-600">Rp {{ number_format($totalTagihanKeseluruhan, 0, ',', '.') }}</p>
                </div>
                <div class="text-center">
                    <p class="font-medium text-gray-700">Total Terbayar</p>
                    <p class="text-lg font-bold text-green-600">Rp {{ number_format($totalDibayarKeseluruhan, 0, ',', '.') }}</p>
                </div>
                <div class="text-center">
                    <p class="font-medium text-gray-700">Total Tunggakan</p>
                    <p class="text-lg font-bold text-red-600">Rp {{ number_format($totalTunggakanKeseluruhan, 0, ',', '.') }}</p>
                </div>
                <div class="text-center">
                    <p class="font-medium text-gray-700">Pembayaran Bulan Ini</p>
                    <p class="text-lg font-bold text-purple-600">Rp {{ number_format($totalPembayaranBulan, 0, ',', '.') }}</p>
                </div>
            </div>
        </div>
    </div>
