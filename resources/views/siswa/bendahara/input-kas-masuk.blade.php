...
@section('title', 'Input Kas Masuk - Bendahara')
...
<div class="h-full bg-gray-50 p-3 sm:p-4 lg:p-6">
    ...
    <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
            ...
            <div class="bg-white rounded p-3 border border-green-300">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        @endphp
                        <p class="text-xs text-gray-500 mt-1">{{ Str::limit($keterangan, 30) }}</p>
                    </div>
        ...
        <div class="mt-3 pt-3 border-t border-green-300">
            <p class="text-green-800 font-bold">
                Total Kas Masuk: Rp {{ number_format($transaksiHariIni->sum('nominal'), 0, ',', '.') }}
            </p>
        </div>
    </div>
    @endif
    ...
    <form action="{{ route('siswa.bendahara.simpan-kas-masuk') }}" method="POST" id="kasMasukForm">
        @csrf
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                ...
                <div class="border border-gray-200 rounded-lg p-4 bg-white">
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="flex-1">
                            <p class="font-medium text-gray-900">{{ $siswaItem->nama_lengkap }}</p>
                    ...
                    <div class="mt-3">
                        <div class="relative">
                            ...
                            <input type="number" 
                                   ...
                                   onchange="updateSiswaStatus({{ $siswaItem->id }})">
                        </div>
                    </div>
                </div>
                @endforeach
