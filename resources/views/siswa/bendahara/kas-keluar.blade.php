...
@section('title', 'Input Kas Keluar - Bendahara')
...
<div class="h-full bg-gray-50 p-3 sm:p-4 lg:p-6">
    ...
    <div class="bg-white shadow-lg rounded-lg p-4 sm:p-6">
        <form action="{{ route('siswa.bendahara.simpan-kas-keluar') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-6 p-3 sm:p-4 bg-red-50 rounded-lg">
                ...
                <div class="space-y-1">
                    <p class="text-sm sm:text-base text-red-700">
                        <span class="font-medium">Kelas:</span> {{ $siswa->kelas->nama_kelas }} ({{ $siswa->kelas->jurusan->nama_jurusan }})
                    </p>
                    <p class="text-sm sm:text-base text-red-700">
                        <span class="font-medium">Saldo Saat Ini:</span>
                        <span class="font-bold">Rp {{ number_format($saldoKas, 0, ',', '.') }}</span>
                    </p>
                </div>
            </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select id="kategori" 
                            ...
                            <option value="acara_kelas" {{ old('kategori') == 'acara_kelas' ? 'selected' : '' }}>
                                Acara/Event Kelas
                            </option>
                            <option value="pembelian_alat" {{ old('kategori') == 'pembelian_alat' ? 'selected' : '' }}>
                            ...
                            <option value="transportasi" {{ old('kategori') == 'transportasi' ? 'selected' : '' }}>
                                Transportasi
                            </option>
                            <option value="hadiah" {{ old('kategori') == 'hadiah' ? 'selected' : '' }}>
                                Hadiah/Apresiasi
                            </option>
                            <option value="kegiatan_belajar" {{ old('kategori') == 'kegiatan_belajar' ? 'selected' : '' }}>
                                Kegiatan Belajar
                            </option>
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500">
                            Maksimal: Rp {{ number_format($saldoKas, 0, ',', '.') }}
                        </p>
                        @error('nominal')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
            ...
            <div class="mt-8 flex justify-end space-x-4">
                <a href="{{ route('siswa.bendahara.kas-keluar') }}" 
