...
<div class="w-full px-6 py-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    <div class="bg-gray-50 rounded-lg p-4">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <p class="font-medium text-gray-800">{{ $nilai->mataPelajaran->nama ?? 'Mata Pelajaran' }}</p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500 uppercase tracking-wide mb-1">Jenis Penilaian</p>
                                <p class="font-medium text-gray-800">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                        {{ ucfirst($nilai->jenis_nilai ?? 'Penilaian') }}
                                    </span>
                                </p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p class="font-medium text-gray-800">{{ $nilai->tahun_ajaran ?? '-' }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-r-lg">
                            <p class="text-gray-800">{{ $nilai->deskripsi }}</p>
                        </div>
                    </div>
                    @endif
                </div>
            ...
            <div class="space-y-4">
                <!-- Breakdown Nilai -->
                @if($nilai->nilai_tugas || $nilai->nilai_uts || $nilai->nilai_uas || $nilai->nilai_praktik)
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-medium text-gray-800">{{ $nilai->nilai_tugas }}</span>
                        </div>
                        @endif
                        @if($nilai->nilai_uts)
                        <div class="flex justify-between items-center">
                            <span class="text-sm text-gray-600">UTS</span>
                            <span class="font-medium text-gray-800">{{ $nilai->nilai_uts }}</span>
                        </div>
                        @endif
                        @if($nilai->nilai_uas)
                        <div class="flex justify-between items-center">
                            <span class="text-sm text-gray-600">UAS</span>
                            <span class="font-medium text-gray-800">{{ $nilai->nilai_uas }}</span>
                        </div>
                        @endif
                        @if($nilai->nilai_praktik)
                        <div class="flex justify-between items-center">
                            <span class="text-sm text-gray-600">Praktik</span>
                            <span class="font-medium text-gray-800">{{ $nilai->nilai_praktik }}</span>
                        </div>
                        @endif
                    </div>
                </div>
