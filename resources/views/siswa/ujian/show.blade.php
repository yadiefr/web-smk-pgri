    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('siswa.ujian.index') }}" class="text-gray-500 hover:text-blue-600">Ujian</a>
                    </div>
                </li>
                <li aria-current="page">
                    <div class="flex items-center">
                        <i class="fas fa-chevron-right text-gray-400 mx-2"></i>
                        <span class="text-gray-900 font-medium">{{ $ujian->nama_ujian }}</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-blue-100">
                <h1 class="text-2xl font-bold text-gray-900">{{ $ujian->nama_ujian }}</h1>
                <p class="text-blue-700 mt-1">{{ $ujian->mataPelajaran->nama_mata_pelajaran }}</p>
            </div>
                        ...
                        <div class="space-y-3">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-900">{{ $ujian->guru->nama }}</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-900">{{ $ujian->tanggal->format('d F Y') }}</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-900">{{ $ujian->durasi }} menit</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-900">{{ $ujian->kelas->nama_kelas }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        @if($hasilUjian)
                            ...
                            <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                                ...
                                <p class="text-sm text-green-700 mb-3">{{ $hasilUjian->catatan }}</p>
                                <div class="text-center">
                                    <div class="text-3xl font-bold {{ $hasilUjian->nilai >= 70 ? 'text-green-600' : 'text-red-600' }} mb-1">
                                        {{ number_format($hasilUjian->nilai, 1) }}
                                    </div>
                                    <div class="text-sm text-gray-600">
                                        {{ $hasilUjian->nilai >= 70 ? 'Lulus' : 'Tidak Lulus' }}
                                    </div>
                                </div>
                            </div>
                        @elseif($canTakeExam)
                            ...
                            @if($isBeforeStart)
                                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                                    ...
                                    <p class="text-sm text-yellow-700">
                                        Ujian akan dimulai pada {{ $ujian->waktu_mulai->format('d F Y, H:i') }}
                                    </p>
                                </div>
                            @elseif($isAfterEnd)
                                <div class="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-4">
                                    ...
                                    <p class="text-sm text-gray-700">
                                        Ujian berakhir pada {{ $ujian->waktu_selesai->format('d F Y, H:i') }}
                                    </p>
                                </div>
                            @endif
                        @endif
