                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all">
                    <div class="p-6">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <h2 class="text-lg font-semibold text-gray-800">
                                        <a href="{{ route('siswa.pengumuman.show', $p->id) }}" class="hover:text-blue-600">
                                            {{ $p->judul }}
                                        </a>
                                    </h2>
                        ...
                        <div class="text-right">
                            <a href="{{ route('siswa.pengumuman.show', $p->id) }}" class="inline-flex items-center text-sm font-medium text-blue-600 hover:text-blue-700">
                                Baca selengkapnya
