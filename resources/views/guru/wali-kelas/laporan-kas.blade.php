...
@section('title', 'Laporan Kas - Wali Kelas')
    ...
    <div class="bg-white shadow rounded-lg p-6 mb-6">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center">
            ...
            <div class="mt-4 sm:mt-0">
                <form method="GET" action="{{ route('guru.wali-kelas.bendahara.laporan-kas') }}" class="flex flex-wrap gap-2">
        ...
        <div class="mt-4 text-sm text-gray-600">
            ...
            {{ $tanggalAwal->locale('id')->format('d F Y') }} - {{ $tanggalAkhir->locale('id')->format('d F Y') }}
        </div>
    </div>
        ...
        <div class="bg-green-50 rounded-lg p-4 sm:p-6">
            <div class="flex items-center">
                ...
                <div class="ml-3 sm:ml-4 min-w-0 flex-1">
                    ...
                    <p class="text-xs text-green-600">{{ $kasMasuk->count() }} transaksi</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-red-50 rounded-lg p-4 sm:p-6">
            <div class="flex items-center">
                ...
                <div class="ml-3 sm:ml-4 min-w-0 flex-1">
                    ...
                    <p class="text-xs text-red-600">{{ $kasKeluar->count() }} transaksi</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                <div class="min-w-0 flex-1 mr-3">
                                    <p class="font-medium text-gray-900 truncate">{{ $data['kategori'] }}</p>
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                ...
                                <span class="font-semibold text-gray-900">Rp {{ number_format($saldoAwal, 0, ',', '.') }}</span>
                            </div>
                            <div class="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                                <span class="font-medium text-green-700">Total Kas Masuk</span>
                                <span class="font-semibold text-green-900">Rp {{ number_format($totalKasMasuk, 0, ',', '.') }}</span>
                            </div>
                            <div class="flex justify-between items-center p-3 bg-red-50 rounded-lg">
                                <span class="font-medium text-red-700">Total Kas Keluar</span>
                                <span class="font-semibold text-red-900">Rp {{ number_format($totalKasKeluar, 0, ',', '.') }}</span>
                            </div>
                            <div class="flex justify-between items-center p-3 bg-blue-50 rounded-lg border-t-2 border-blue-200">
                                ...
                                <span class="font-semibold {{ $saldoPeriode >= 0 ? 'text-green-900' : 'text-red-900' }}">
