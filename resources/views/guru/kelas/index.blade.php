...
@section('title', 'Daftar Kelas - SMK PGRI CIKAMPEK')
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="mt-4 sm:mt-0 flex items-center space-x-3">
                <div class="flex items-center px-3 py-2 bg-blue-50 rounded-lg">
                    ...
                    <span class="text-sm font-medium text-blue-700">{{ $kelasDiajar->count() }} Kelas Diajar</span>
                </div>
                ...
                <div class="flex items-center px-3 py-2 bg-green-50 rounded-lg">
                    ...
                    <span class="text-sm font-medium text-green-700">{{ $kelasWali->count() }} Wali Kelas</span>
                </div>
                @endif
            </div>
        </div>
            ...
            <div class="kelas-card wali-kelas bg-white rounded-xl shadow-sm p-6">
                <div class="flex items-start justify-between mb-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1">{{ $kelas->jurusan->nama_jurusan ?? 'Jurusan tidak ditemukan' }}</p>
                    </div>
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div class="text-center p-3 bg-white bg-opacity-50 rounded-lg">
                        <div class="text-2xl font-bold text-gray-900">{{ $kelas->siswa->count() }}</div>
                ...
                <div class="flex space-x-2">
                    ...
                    <a href="{{ route('guru.wali-kelas.dashboard') }}" 
            ...
            <div class="kelas-card mengajar bg-white rounded-xl shadow-sm p-6">
                <div class="flex items-start justify-between mb-4">
                    ...
                    <div class="flex flex-col items-end space-y-1">
                        ...
                        @if(isset($statistikKelas[$kelas->id]) && $statistikKelas[$kelas->id]['is_wali'])
                ...
                <div class="grid grid-cols-3 gap-3 mb-4">
                    <div class="text-center p-3 bg-white bg-opacity-50 rounded-lg">
                        <div class="text-xl font-bold text-gray-900">{{ $statistikKelas[$kelas->id]['total_siswa'] ?? 0 }}</div>
                        <div class="text-xs text-gray-600">Siswa</div>
                    </div>
                    <div class="text-center p-3 bg-white bg-opacity-50 rounded-lg">
                        <div class="text-xl font-bold text-gray-900">{{ $statistikKelas[$kelas->id]['total_jadwal'] ?? 0 }}</div>
                        <div class="text-xs text-gray-600">Jadwal</div>
                    </div>
                    <div class="text-center p-3 bg-white bg-opacity-50 rounded-lg">
                        <div class="text-xl font-bold text-gray-900">{{ $kelas->tingkat }}</div>
                        <div class="text-xs text-gray-600">Tingkat</div>
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <a href="{{ route('guru.nilai.show', $kelas->id) }}" 
