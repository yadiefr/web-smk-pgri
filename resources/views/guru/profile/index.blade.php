            ...
            <div class="grid lg:grid-cols-4 gap-6">
                ...
                <div class="lg:col-span-1">
                    <div class="text-center">
                        ...
                        @endif
                        <h2 class="mt-4 text-xl font-semibold text-gray-900">{{ $user->nama }}</h2>
                        ...
                        <div class="mt-6 space-y-3">
                            <div class="bg-gray-50 p-4 rounded-lg">
                                <div class="text-2xl font-bold text-blue-600">{{ $totalKelas ?? 0 }}</div>
                                <div class="text-sm text-gray-600">Kelas Diampu</div>
                            </div>
                            <div class="bg-gray-50 p-4 rounded-lg">
                                <div class="text-2xl font-bold text-green-600">{{ $totalMapel ?? 0 }}</div>
                                    ...
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <p class="text-gray-900 font-medium">
                                            @if($user->tempat_lahir || $user->tanggal_lahir)
                                                {{ $user->tempat_lahir ?? '' }}@if($user->tempat_lahir && $user->tanggal_lahir), @endif{{ $user->tanggal_lahir ? $user->tanggal_lahir->format('d F Y') : '' }}
                                            @else
                                                -
                                            @endif
                                        </p>
                            ...
                            <div>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <p class="text-gray-900 font-medium">{{ $user->telepon ?? '-' }}</p>
                                    </div>
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        <label class="block text-sm font-medium text-gray-600 mb-1">Alamat</label>
                                        <p class="text-gray-900 font-medium">{{ $user->alamat ?? '-' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-4">
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <p class="text-gray-900 font-medium">{{ ucfirst($user->status ?? 'aktif') }}</p>
                                    </div>
                                    <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div>
                                ...
                                <div class="bg-gray-50 p-4 rounded-lg">
                                    <div class="text-center py-4">
                                        ...
                                        <a href="{{ route('guru.jadwal.index') }}" class="inline-flex items-center mt-2 text-sm text-blue-600 hover:text-blue-700">
