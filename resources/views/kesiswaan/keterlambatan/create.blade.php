...
<div class="p-1 sm:p-6">
    ...
    <div class="bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-100 p-2 sm:p-6 mx-1 sm:mx-0">
        <form action="{{ route('kesiswaan.keterlambatan.store') }}" method="POST" id="keterlambatanForm">
            @csrf
            ...
            <div class="space-y-3 sm:space-y-6">
                        ...
                        <div id="siswa-list">
                            @if($siswa && $siswa->count() > 0)
                                ...
                                <div class="flex items-center p-2 sm:p-3 border-b border-gray-100 hover:bg-blue-50 transition-colors cursor-pointer" 
                                     ...
                                     data-siswa-kelas="{{ $s['kelas_nama'] }}"
                                     data-siswa-kelas-id="{{ $s['kelas_id'] ?? '' }}">
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center justify-between">
                                            <div class="flex-1 min-w-0">
                                                <div class="text-sm font-medium text-gray-900 truncate">{{ $s['nama'] }}</div>
                                            ...
                                            <div class="ml-3 flex-shrink-0">
                                                <button type="button" class="select-btn px-3 py-1 text-xs font-medium rounded-full transition-colors bg-green-100 text-green-700 hover:bg-green-200" onclick="selectStudent({{ json_encode($s) }}, this)">
                                                    Pilih
                                                </button>
                                            </div>
                                        </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                        ...
                        <select name="status" 
                                ...
                                required>
                            <option value="belum_ditindak" {{ old('status', 'belum_ditindak') == 'belum_ditindak' ? 'selected' : '' }}>
                                Belum Ditindak
                            </option>
                            <option value="sudah_ditindak" {{ old('status') == 'sudah_ditindak' ? 'selected' : '' }}>
                                Sudah Ditindak
                            </option>
                        </select>
                    ...
                    <div>
                        ...
                        <textarea name="sanksi" 
                                  ...
                                  placeholder="Sanksi yang sama untuk semua siswa (opsional)...">{{ old('sanksi') }}</textarea>
                        @error('sanksi')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div>
                    ...
                    <textarea name="catatan_petugas" 
                              ...
                              placeholder="Catatan tambahan petugas (opsional)...">{{ old('catatan_petugas') }}</textarea>
