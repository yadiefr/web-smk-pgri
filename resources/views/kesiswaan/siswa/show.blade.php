...
<div class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
            ...
            <div class="flex items-center space-x-3">
                <div class="flex items-center space-x-2">
                    ...
                    @elseif($siswa->status_siswa == 'nonaktif')
        ...
        <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-8 text-white">
            <div class="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6">
                ...
                <div class="text-center md:text-left flex-1">
                    <h1 class="text-3xl font-bold mb-2">{{ $siswa->nama_lengkap }}</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p class="text-gray-900 bg-gray-50 px-3 py-2 rounded-lg">{{ $siswa->nama_lengkap ?? '-' }}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-gray-900 bg-gray-50 px-3 py-2 rounded-lg">{{ $siswa->tempat_lahir ?? '-' }}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-gray-900 bg-gray-50 px-3 py-2 rounded-lg">{{ $siswa->agama ?? '-' }}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-gray-900 bg-gray-50 px-3 py-2 rounded-lg">
                                @if($siswa->no_hp)
                                    <a href="tel:{{ $siswa->no_hp }}" class="text-blue-600 hover:text-blue-800">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <p class="text-gray-900 bg-gray-50 px-3 py-2 rounded-lg">{{ $siswa->alamat ?? '-' }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p class="text-gray-900 bg-gray-50 px-3 py-2 rounded-lg">{{ $siswa->nis ?? '-' }}</p>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">NISN</label>
                            <p class="text-gray-900 bg-gray-50 px-3 py-2 rounded-lg">{{ $siswa->nisn ?? '-' }}</p>
                        </div>
                        
                        @if($siswa->kelas)
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Kelas</label>
                            <p class="text-gray-900 bg-gray-50 px-3 py-2 rounded-lg">{{ $siswa->kelas->nama_kelas }}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-gray-900 bg-gray-50 px-3 py-2 rounded-lg">{{ $siswa->tahun_masuk ?? '-' }}</p>
                        </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p class="text-gray-900 bg-gray-50 px-3 py-2 rounded-lg">{{ $siswa->nama_ayah ?? '-' }}</p>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Pekerjaan Ayah</label>
                            <p class="text-gray-900 bg-gray-50 px-3 py-2 rounded-lg">{{ $siswa->pekerjaan_ayah ?? '-' }}</p>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Nama Ibu</label>
                            <p class="text-gray-900 bg-gray-50 px-3 py-2 rounded-lg">{{ $siswa->nama_ibu ?? '-' }}</p>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Pekerjaan Ibu</label>
                            <p class="text-gray-900 bg-gray-50 px-3 py-2 rounded-lg">{{ $siswa->pekerjaan_ibu ?? '-' }}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-gray-900 bg-gray-50 px-3 py-2 rounded-lg">
                                @if($siswa->no_hp_wali)
                                    <a href="tel:{{ $siswa->no_hp_wali }}" class="text-blue-600 hover:text-blue-800">
                                        <i class="fas fa-phone mr-1"></i>
                                        {{ $siswa->no_hp_wali }}
                                    </a>
                                @else
        ...
        <div class="space-y-6">
                    ...
                    <div class="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                        ...
                        <span class="text-sm font-bold text-blue-600">
                            @if($siswa->tahun_masuk)
                                {{ date('Y') - $siswa->tahun_masuk }} tahun
                            @else
                                -
                            @endif
                        </span>
            ...
            <!-- Recent Attendance -->
            @if($siswa->absensi && $siswa->absensi->count() > 0)
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div class="bg-gray-50 px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-900 flex items-center">
