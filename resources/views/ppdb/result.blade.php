...
@section('title', 'Hasil Status Pendaftaran - SMK PGRI CIKAMPEK')
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    <div class="p-3 bg-light rounded border-start border-primary border-4">
                        ...
                        <div class="fs-5 fw-semibold">{{ $pendaftaran->tanggal_pendaftaran->format('d M Y H:i') }}</div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column">
                        ...
                        <span class="fs-6">{{ $pendaftaran->nama_lengkap }}</span>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column">
                        ...
                        <span class="fs-6">{{ $pendaftaran->nisn }}</span>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column">
                        ...
                        <span class="fs-6">{{ $pendaftaran->asal_sekolah }}</span>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column">
                        ...
                        <span class="fs-6">{{ $pendaftaran->tahun_ajaran }}</span>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="d-flex flex-column">
                        ...
                        <span class="fs-6">{{ $pendaftaran->jurusanPertama?->nama_jurusan ?? '-' }}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="mt-4">
                <div class="card border-0 bg-light">
                    <div class="card-body">
                        ...
                        <p class="card-text">{{ $pendaftaran->keterangan }}</p>
                    </div>
                </div>
            </div>
            @endif
