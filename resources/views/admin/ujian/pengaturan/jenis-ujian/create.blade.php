...
<div class="p-6">
    ...
    <div class="bg-white rounded-lg shadow-md">
        ...
        <form action="{{ route('admin.ujian.pengaturan.jenis-ujian.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="deskripsi" 
                              ...
                              placeholder="Deskripsi singkat tentang jenis ujian ini...">{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
