        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-6 p-6">
                ...
                <div class="lg:col-span-4">
                    <form action="{{ route('admin.ujian.pengaturan.ruangan.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mt-6">
                            ...
                            <textarea class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors @error('deskripsi') border-red-500 @enderror" 
                                      id="deskripsi" 
                                      name="deskripsi" 
                                      rows="3"
                                      placeholder="Deskripsi tambahan tentang ruangan...">{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex justify-between items-center pt-6 border-t border-gray-200 mt-8">
                            <a href="{{ route('admin.ujian.pengaturan.ruangan.index') }}" class="px-6 py-3 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition-colors">
