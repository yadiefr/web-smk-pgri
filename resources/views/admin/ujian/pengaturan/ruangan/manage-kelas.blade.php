...
@section('title', 'Kelola Kelas - ' . $ruangan->nama_ruangan)
    ...
    <div class="max-w-full mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-3">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-xl font-bold text-gray-900 mb-1">Kelola Kelas: {{ $ruangan->nama_ruangan }}</h1>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-6 p-6">
                ...
                <div class="lg:col-span-4">
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                        ...
                        <form action="{{ route('admin.ujian.pengaturan.ruangan.assign-kelas', $ruangan) }}" method="POST">
                            @csrf
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div class="md:col-span-2">
                                    <label for="kelas_id" class="block text-sm font-medium text-gray-700 mb-2">Pilih Kelas</label>
                                    <select class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors @error('kelas_id') border-red-500 @enderror" 
                                            id="kelas_id" 
                                            name="kelas_id"
                                            required>
                                ...
                                <div>
                                    ...
                                    <input type="number" 
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors @error('kapasitas_maksimal') border-red-500 @enderror" 
                                           id="kapasitas_maksimal" 
                                           name="kapasitas_maksimal" 
                                           value="{{ old('kapasitas_maksimal') }}"
                                           min="1" 
                                           max="{{ $ruangan->kapasitas }}"
                                           placeholder="{{ $ruangan->kapasitas }}">
                                    @error('kapasitas_maksimal')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                    <p class="mt-1 text-xs text-gray-500">
                                        <i class="fas fa-info-circle mr-1"></i>
                                        Kosongkan untuk menggunakan kapasitas ruangan ({{ $ruangan->kapasitas }})
                                    </p>
                                </div>
                            </div>
                            <div class="mt-4">
                            ...
                            <div class="overflow-x-auto">
                                <table class="w-full">
                                    ...
                                    <tbody class="divide-y divide-gray-200">
                                        @foreach($ruangan->kelas as $index => $kelas)
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            <td class="px-4 py-4 text-center">
                                                <span class="inline-flex items-center justify-center w-6 h-6 bg-blue-100 text-blue-800 text-xs font-medium rounded-full">{{ $index + 1 }}</span>
                                            </td>
                                            <td class="px-4 py-4">
                                                <div class="flex items-center">
                                            ...
                                            <td class="px-4 py-4">
                                                <form action="{{ route('admin.ujian.pengaturan.ruangan.update-kelas', [$ruangan, $kelas]) }}" 
                                                      method="POST" 
                                                    ...
                                                    <input type="number" 
                                                           ...
                                                           name="kapasitas_maksimal" 
                                                           value="{{ $kelas->pivot->kapasitas_maksimal }}"
                                                           min="1" 
                                                           max="{{ $ruangan->kapasitas }}">
                                                    <button type="submit" 
                                            ...
                                            <td class="px-4 py-4 text-center">
                                                <label class="relative inline-flex items-center cursor-pointer">
                                                    <input type="checkbox" 
                                                           ...
                                                           {{ $kelas->pivot->is_active ? 'checked' : '' }}>
                                                    <div class="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                                                </label>
                                            </td>
                                            <td class="px-4 py-4 text-center">
                                                <form action="{{ route('admin.ujian.pengaturan.ruangan.remove-kelas', [$ruangan, $kelas]) }}" 
                                                      method="POST" 
                        ...
                        <div class="bg-gray-50 px-6 py-4 border-t border-gray-200">
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-gray-600">
                                    <i class="fas fa-info-circle mr-1"></i>
                                    Total: <strong>{{ $ruangan->kelas->count() }}</strong> kelas ditugaskan
                                </span>
                                <div class="flex space-x-2">
                                    <a href="{{ route('admin.ujian.pengaturan.ruangan.show', $ruangan) }}" class="px-3 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors text-sm">
                                        <i class="fas fa-arrow-left mr-1"></i>Kembali
                                    </a>
                                    <a href="{{ route('admin.ujian.pengaturan.ruangan.index') }}" class="px-3 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm">
                ...
                <div class="lg:col-span-1">
                    <div class="sticky top-6 space-y-4">
                        ...
                        <div class="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-4 shadow-sm">
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between items-center py-2 border-b border-blue-200">
                                    ...
                                    <span class="text-sm bg-white px-2 py-1 rounded border border-gray-200">{{ $ruangan->kode_ruangan }}</span>
                                </div>
                                <div class="flex justify-between items-center py-2 border-b border-blue-200">
                                    <span class="text-sm text-gray-700 font-medium">
                                        <i class="fas fa-home mr-1"></i>Nama Ruangan
                                    </span>
                                    <span class="text-sm font-semibold text-gray-900">{{ $ruangan->nama_ruangan }}</span>
                                </div>
                                <div class="flex justify-between items-center py-2 border-b border-blue-200">
                                    <span class="text-sm text-gray-700 font-medium">
                                        <i class="fas fa-users mr-1"></i>Kapasitas Total
                                    </span>
                                    <span class="text-sm font-bold text-gray-900">{{ $ruangan->formatted_kapasitas ?? $ruangan->kapasitas . ' orang' }}</span>
                                </div>
                                <div class="flex justify-between items-center py-2 border-b border-blue-200">
                                    <span class="text-sm text-gray-700 font-medium">
                                        <i class="fas fa-map-marker-alt mr-1"></i>Lokasi
                                    </span>
                                    <span class="text-sm text-gray-900">{{ $ruangan->lokasi ?? 'Belum ditentukan' }}</span>
                                </div>
                                <div class="flex justify-between items-center py-2">
                                    ...
                                    @elseif($ruangan->status == 'terpakai')
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-lg p-4 shadow-sm">
                            ...
                            <div class="grid grid-cols-2 gap-3 mb-4">
                                <div class="bg-white rounded-lg p-3 text-center border border-green-100">
                                    <div class="text-2xl font-bold text-gray-900 mb-1">{{ $ruangan->kelas->count() }}</div>
                                    <div class="text-xs text-gray-600">Total Kelas</div>
                                </div>
                                <div class="bg-white rounded-lg p-3 text-center border border-green-100">
                                    <div class="text-2xl font-bold text-green-600 mb-1">{{ $ruangan->kelas->where('pivot.is_active', true)->count() }}</div>
                                ...
                                <div class="bg-white rounded-lg p-3 border border-green-100">
                                    ...
                                    <div class="flex justify-between text-xs">
                                        <span class="text-gray-600">
                                            <i class="fas fa-users mr-1"></i>Terisi: {{ $totalCapacity }} siswa
                                        </span>
                                        <span class="text-gray-600">
                                            <i class="fas fa-chair mr-1"></i>Total: {{ $ruangan->kapasitas }} kursi
                                        </span>
                                    </div>
                                    <div class="text-center mt-2">
                                        <span class="text-xs font-semibold text-gray-700">{{ number_format($usage, 1) }}%</span>
                                    </div>
                                </div>
                            @else
                                <div class="bg-white rounded-lg p-3 text-center border border-green-100">
                        ...
                        <!-- Status Information -->
                        @if($availableKelas->count() == 0 && $ruangan->kelas->count() > 0)
                            ...
                            <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-green-800">Terdapat <strong>{{ $availableKelas->count() }}</strong> kelas yang dapat ditugaskan ke ruangan ini.</p>
                                    </div>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
                            ...
                            <div class="p-4 space-y-2">
                                <a href="{{ route('admin.ujian.pengaturan.ruangan.show', $ruangan) }}" 
