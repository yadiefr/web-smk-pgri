...
@section('title', 'Kelola Ruangan Ujian')
            ...
            <nav class="flex mt-8 lg:mt-0" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3 bg-gray-100 rounded-lg px-4 py-2">
                    <li class="inline-flex items-center">
                        <a href="{{ route('admin.dashboard') }}" class="text-gray-600 hover:text-gray-900 font-medium transition-colors">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('admin.ujian.dashboard') }}" class="text-gray-600 hover:text-gray-900 font-medium transition-colors">
                                Ujian
                            </a>
                        </div>
                    </li>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">
                        {{ $ruangan->where('is_active', true)->count() }}
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">
                        {{ $ruangan->where('status', 'tersedia')->count() }}
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                ...
                <div class="mt-4 md:mt-0">
                    <a href="{{ route('admin.ujian.pengaturan.ruangan.create') }}" 
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-200" x-data="{ isToggling: false }">
                            ...
                            <td class="px-6 py-4">
                                <div>
                                    ...
                                    @if($room->deskripsi)
                                        <div class="text-sm text-gray-500">{{ Str::limit($room->deskripsi, 40) }}</div>
                                    @endif
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <button 
                                    @click="toggleStatus({{ $room->id }}, $event)"
                                    :disabled="isToggling"
                                    data-room-id="{{ $room->id }}"
                                    data-active="{{ $room->is_active ? 'true' : 'false' }}"
                                    class="relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 {{ $room->is_active ? 'bg-indigo-600' : 'bg-gray-200' }}">
                                    <span 
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center space-x-2">
                                    <a href="{{ route('admin.ujian.pengaturan.ruangan.show', $room) }}" 
                                    ...
                                    <a href="{{ route('admin.ujian.pengaturan.ruangan.edit', $room) }}" 
                                    ...
                                    <a href="{{ route('admin.ujian.pengaturan.ruangan.manage-kelas', $room) }}" 
                                    ...
                                    <button @click="deleteRoom({{ $room->id }}, '{{ $room->nama_ruangan }}')" 
