            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                <div class="flex flex-col items-center">
                    <div class="w-32 h-32 rounded-full overflow-hidden mb-4 border-4 border-blue-100">
                        <img src="{{ $user->photo ? asset('storage/'.$user->photo) : asset('assets/images/faces/1.jpg') }}" 
                             alt="Profile Photo"
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="border-t border-gray-100 px-6 py-4">
                    <p class="text-sm text-gray-500">
                        ...
                        Login terakhir: {{ Auth::user()->last_login ? Auth::user()->last_login->diffForHumans() : 'Belum pernah login' }}
                    </p>
                </div>
            </div>
        </div>
