...
<div class="w-full px-3 py-4">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 mb-6 border border-blue-100">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('admin.guru.download-template') }}" class="bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white px-4 py-2 rounded-lg flex items-center shadow-sm transition-all hover:shadow">
                    <i class="fas fa-download mr-2"></i> Template Excel
                </a>
                
                <a href="{{ route('admin.guru.create') }}" class="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-4 py-2 rounded-lg flex items-center shadow-sm transition-all hover:shadow">
            ...
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 border border-blue-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-gray-800">{{ $guru->count() }}</h3>
                    </div>
            ...
            <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-4 border border-green-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-gray-800">{{ $guru->where('is_wali_kelas', true)->count() }}</h3>
                    </div>
                    <div class="bg-white p-3 rounded-lg shadow-sm">
            ...
            <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-4 border border-purple-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-gray-800">{{ $guru->where('is_active', true)->count() }}</h3>
                    </div>
                    <div class="bg-white p-3 rounded-lg shadow-sm">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 mb-6 border border-gray-100">
        ...
        <form action="{{ route('admin.guru.index') }}" method="GET" class="flex flex-wrap gap-4">
            ...
            <div class="w-[200px]">
                ...
                <select name="is_wali_kelas" id="is_wali_kelas" 
                    class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                    <option value="">Semua</option>
                    <option value="1" {{ request('is_wali_kelas') == '1' ? 'selected' : '' }}>Wali Kelas</option>
                    <option value="0" {{ request('is_wali_kelas') == '0' ? 'selected' : '' }}>Bukan Wali Kelas</option>
                </select>
            </div>
            <div class="flex items-end space-x-2">
                ...
                <a href="{{ route('admin.guru.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-lg transition-colors">
    ...
    <div class="mb-6">
        ...
        @if($guru->isEmpty())
            <div class="bg-white rounded-xl p-8 shadow-sm text-center border border-gray-100">
                ...
                <a href="{{ route('admin.guru.create') }}" class="inline-flex items-center justify-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors">
                    ...
                    <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100 hover:shadow-md transition-all group">
                        ...
                        <div class="pt-14 px-6 pb-5">
                            <div class="flex items-center mb-1">
                                <h3 class="text-lg font-semibold text-gray-900">{{ $g->nama }}</h3>
                                @if($g->is_wali_kelas)
                            ...
                            <p class="text-sm text-gray-600 mb-2">NIP: {{ $g->nip ?: 'Belum diisi' }}</p>
                            
                            <!-- Kelas yang dipimpin (jika wali kelas) -->
                            @if($g->is_wali_kelas && $g->kelasWali)
                                <div class="mb-3 p-2 bg-blue-50 rounded-lg border border-blue-200">
                                    <div class="flex items-center text-blue-700">
                                        <i class="fas fa-school mr-2"></i>
                                        <span class="text-sm font-medium">Wali Kelas: {{ $g->kelasWali->nama_kelas }}</span>
                                    </div>
                                </div>
                            @elseif($g->is_wali_kelas && !$g->kelasWali)
                            ...
                            <div class="grid grid-cols-1 gap-2 mb-4 text-sm">
                                ...
                                <div class="flex items-center text-gray-700">
                                    ...
                                    <span>{{ $g->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan' }}</span>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center justify-between pt-3 border-t border-gray-100">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <form action="{{ route('admin.guru.destroy', $g) }}" method="POST" 
                                        onsubmit="return confirm('Apakah Anda yakin ingin menghapus {{ $g->nama }}?')">
                                        @csrf
                                        @method('DELETE')
