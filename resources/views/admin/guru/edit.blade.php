...
@section('title', 'Edit Guru - SMK PGRI CIKAMPEK')
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <div>
            <div class="flex items-center text-sm text-gray-600 mb-2">
                ...
                <a href="{{ route('admin.guru.index') }}" class="hover:text-blue-600">Data Guru</a>
                <i class="fas fa-chevron-right text-gray-400 mx-2 text-xs"></i>
                <span>Edit</span>
            </div>
            ...
            <p class="text-gray-600 mt-1">Edit informasi guru {{ $guru->nama }}</p>
        </div>
        <div class="flex items-center space-x-3">
            <a href="{{ route('admin.guru.show', $guru) }}" class="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-4 py-2 rounded-lg flex items-center shadow-sm transition-all">
                    ...
                    <div class="pt-20 text-center">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="file" name="foto" id="foto" 
                                class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 @error('foto') border-red-500 @enderror"
                                accept="image/*">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="jenis_kelamin" id="jenis_kelamin" 
                                    class="w-full h-11 px-3 py-2 rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 @error('jenis_kelamin') border-red-500 @enderror"
                                    required>
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="alamat" id="alamat" rows="3" 
                                ...
                                placeholder="Masukkan alamat guru (opsional)">{{ old('alamat', $guru->alamat) }}</textarea>
                            @error('alamat')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div id="kelas-selection" class="mt-4" style="display: {{ old('is_wali_kelas', $guru->is_wali_kelas ?? false) ? 'block' : 'none' }}">
                                        ...
                                        @if(isset($kelas) && $kelas->count() > 0)
                                            @foreach($kelas as $kelasItem)
                                                ...
                                                <option value="{{ $kelasItem->id }}" 
                                                    {{ old('wali_kelas_id', $guru->kelasWali->id ?? '') == $kelasItem->id ? 'selected' : '' }}
                                                    {{ $hasOtherWali ? 'disabled' : '' }}>
                                                    {{ $kelasItem->nama_kelas }}
                                                    @if($isCurrentGuruWali)
                                                        (Wali kelas saat ini)
                                                    @elseif($hasOtherWali)
                            ...
                            <div>
                                ...
                                <div class="flex items-center p-4 border border-gray-200 rounded-lg bg-green-50">
                                    <input type="checkbox" name="is_active" id="is_active" value="1" 
                                        ...
                                        {{ old('is_active', $guru->is_active ?? true) ? 'checked' : '' }}>
