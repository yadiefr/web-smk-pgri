...
<div class="w-full px-3 py-4">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        ...
        <div class="flex items-center space-x-3">
            <a href="{{ route('admin.guru.edit', $guru) }}" class="bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white px-4 py-2 rounded-lg flex items-center shadow-sm transition-all">
                <i class="fas fa-edit mr-2"></i> Edit
            </a>
            <a href="{{ route('admin.guru.index') }}" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-lg flex items-center transition-all">
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-blue-100">
            ...
            <div class="relative px-6 pb-6">
                ...
                <div class="pt-20 text-center">
                    ...
                    @if($guru->nip)
                        <p class="text-blue-600 font-medium mb-2">NIP: {{ $guru->nip }}</p>
                    @else
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-6">
                        <a href="mailto:{{ $guru->email }}" class="flex items-center justify-center py-2 px-3 bg-blue-50 rounded-lg text-blue-700 hover:bg-blue-100 transition-all">
                            <i class="fas fa-envelope mr-2"></i> Email
                        </a>
                        <a href="tel:{{ $guru->no_hp }}" class="flex items-center justify-center py-2 px-3 bg-green-50 rounded-lg text-green-700 hover:bg-green-100 transition-all">
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                <p class="font-medium text-gray-800">{{ $guru->nip ?: 'Belum diisi' }}</p>
                            </div>
                            <div class="mb-4">
                                <p class="text-sm text-gray-500">Email</p>
                                <p class="font-medium text-gray-800 break-all">{{ $guru->email }}</p>
                            </div>
                        </div>
                        <div>
                            <div class="mb-4">
                    ...
                    <div class="border-t border-gray-100 pt-4 mt-2">
                        ...
                        <p class="text-gray-800">{{ $guru->alamat ?: 'Tidak ada alamat yang tercatat.' }}</p>
                    </div>
                </div>
            </div>
                            ...
                            @if(!empty($walikelas))
                                <div class="bg-blue-50 rounded-lg p-4 border border-blue-200">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <h5 class="font-medium text-gray-800">{{ $walikelas->nama_kelas ?? 'Nama kelas tidak tersedia' }}</h5>
                                            <p class="text-sm text-gray-600">Jurusan: {{ $walikelas->jurusan->nama_jurusan ?? $walikelas->jurusan->nama ?? 'Jurusan tidak tersedia' }}</p>
                                            <p class="text-sm text-gray-600">Tahun Ajaran: {{ $walikelas->tahun_ajaran ?? 'Tidak diketahui' }}</p>
                                        </div>
                                    </div>
                                </div>
                            @else
                    ...
                    <div>
                        ...
                        @if($mapels->count() > 0)
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                @foreach($mapels as $mapelId => $jadwalGroup)
                                    @php
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-3 border border-gray-200">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <h5 class="font-medium text-gray-800">{{ $mapel->nama ?? 'Mata pelajaran tidak tersedia' }}</h5>
                                                <p class="text-xs text-gray-600">Kelas: {{ $kelasNames }}</p>
                                                <p class="text-xs text-gray-500">{{ $jadwalGroup->count() }} jadwal</p>
                                            </div>
                                        </div>
                                    </div>
                                    @endif
                        ...
                        <div class="mt-4 flex justify-end">
                            <a href="{{ route('admin.guru.assign-subjects', $guru) }}" 
