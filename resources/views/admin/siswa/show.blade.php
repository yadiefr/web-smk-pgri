...
@section('title', 'Detail Siswa - SMK PGRI CIKAMPEK')
            ...
            <div class="relative z-10">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
                    ...
                    <div class="mt-4 md:mt-0 flex space-x-3">
                        <a href="{{ route('admin.siswa.edit', $siswa->id) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white px-5 py-2.5 rounded-lg shadow-sm hover:shadow-md transition-all flex items-center">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-500 text-center">{{ $siswa->nama_lengkap }}</p>
                        ...
                        <div class="border-t pt-4 mt-4">
                            <div class="space-y-3">
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-3 text-gray-600">NIS: {{ $siswa->nis ?? 'Belum ditentukan' }}</span>
                                </div>
                                <div class="flex items-center">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-3 text-gray-600">{{ $siswa->telepon ?? 'Belum ditentukan' }}</span>
                                </div>
                                <div class="flex items-center">
                                    <i class="fas fa-graduation-cap text-gray-500 w-6"></i>
                                    <span class="ml-3 text-gray-600">{{ $siswa->jurusan->nama_jurusan ?? 'Belum ditentukan' }}</span>
                                </div>

                                <div class="flex items-center">
                                    <i class="fas fa-school text-gray-500 w-6"></i>
                                    <span class="ml-3 text-gray-600">{{ $siswa->kelas->nama_kelas ?? 'Belum ditentukan' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mt-6">
                    ...
                    <div class="p-4">
                        <div class="space-y-3">
                            <a href="{{ route('admin.nilai.index', ['siswa' => 1]) }}" class="flex items-center p-2 rounded-md hover:bg-blue-50 transition-all group">
                            ...
                            <a href="{{ route('admin.absensi.index', ['siswa' => 1]) }}" class="flex items-center p-2 rounded-md hover:bg-blue-50 transition-all group">
                            ...
                            <a href="{{ route('admin.jadwal.index', ['kelas' => 3]) }}" class="flex items-center p-2 rounded-md hover:bg-blue-50 transition-all group">
                                    ...
                                    <div>
                                        <dl>
                                            <div class="bg-gray-50 px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 rounded-lg mb-2">
                                                ...
                                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $siswa->nama_lengkap }}</dd>
                                            </div>
                                            <div class="bg-white px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 rounded-lg mb-2">
                                                ...
                                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $siswa->tempat_lahir }}</dd>
                                            </div>
                                            <div class="bg-gray-50 px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 rounded-lg mb-2">
                                            ...
                                            <div class="bg-white px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 rounded-lg mb-2">
                                                ...
                                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $siswa->jenis_kelamin }}</dd>
                                            </div>
                                            <div class="bg-gray-50 px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 rounded-lg mb-2">
                                                <dt class="text-sm font-medium text-gray-500">Agama</dt>
                                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $siswa->agama }}</dd>
                                            </div>
                                        </dl>
                                    </div>
                                    ...
                                    <div>
                                        <dl>
                                            ...
                                            <div class="bg-white px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 rounded-lg mb-2">
                                                ...
                                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $siswa->nisn }}</dd>
                                            </div>
                                            <div class="bg-gray-50 px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 rounded-lg mb-2">
                                                <dt class="text-sm font-medium text-gray-500">Email</dt>
                                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $siswa->email }}</dd>
                                            </div>
                                            <div class="bg-white px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 rounded-lg mb-2">
                                                <dt class="text-sm font-medium text-gray-500">No. Telepon</dt>
                                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $siswa->telepon }}</dd>
                                            </div>
                                            <div class="bg-gray-50 px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 rounded-lg mb-2">
                            ...
                            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p class="text-base text-gray-900">{{ $siswa->kelas->nama_kelas ?? 'Belum ditentukan' }}</p>
                                    </div>
                                    <div>
                                        <p class="text-sm font-medium text-gray-500">Jurusan</p>
                                        <p class="text-base text-gray-900">{{ $siswa->jurusan->nama_jurusan ?? 'Belum ditentukan' }}</p>
                                    </div>
                                    <div>
                                        <p class="text-sm font-medium text-gray-500">Tahun Masuk</p>
                                        <p class="text-base text-gray-900">{{ $siswa->tahun_masuk ?? 'Belum ditentukan' }}</p>
                                    </div>
                                    <div>
                                        <p class="text-sm font-medium text-gray-500">Status</p>
                                        <p class="text-base text-gray-900">{{ $siswa->status ?? 'Aktif' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <p class="text-base text-gray-900">{{ $siswa->nama_ayah ?? '' }}</p>
                                        </div>
                                        <div>
                                            <p class="text-sm font-medium text-gray-500">Pekerjaan Ayah</p>
                                            <p class="text-base text-gray-900">{{ $siswa->pekerjaan_ayah ?? '' }}</p>
                                        </div>
                                        <div>
                                            <p class="text-sm font-medium text-gray-500">No. Telepon Ayah</p>
                                            <p class="text-base text-gray-900">{{ $siswa->no_telp_ayah ?? '' }}</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Data Ibu -->
                                <div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <p class="text-base text-gray-900">{{ $siswa->nama_ibu ?? '' }}</p>
                                        </div>
                                        <div>
                                            <p class="text-sm font-medium text-gray-500">Pekerjaan Ibu</p>
                                            <p class="text-base text-gray-900">{{ $siswa->pekerjaan_ibu ?? '' }}</p>
                                        </div>
                                        <div>
                                            <p class="text-sm font-medium text-gray-500">No. Telepon Ibu</p>
                                            <p class="text-base text-gray-900">{{ $siswa->no_telp_ibu ?? '' }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="bg-purple-50 p-3 sm:p-4 rounded-lg border border-purple-200">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-2">
                                                    ...
                                                    <p class="text-base sm:text-xl font-bold text-purple-900 mt-0.5">Rp {{ number_format($siswa->total_tagihan ?? 0,0,',','.') }}</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="bg-green-50 p-3 sm:p-4 rounded-lg border border-green-200">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-2">
                                                    ...
                                                    <p class="text-base sm:text-xl font-bold text-green-900 mt-0.5">Rp {{ number_format($siswa->total_telah_dibayar ?? $siswa->pembayaran->sum('jumlah'),0,',','.') }}</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="bg-red-50 p-3 sm:p-4 rounded-lg border border-red-200">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-2">
                                                    ...
                                                    <p class="text-base sm:text-xl font-bold text-red-900 mt-0.5">Rp {{ number_format($siswa->tunggakan ?? 0,0,',','.') }}</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="bg-blue-50 p-3 sm:p-4 rounded-lg border border-blue-200">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-2">
                                                    ...
                                                    <p class="text-base sm:text-xl font-bold text-blue-900 mt-0.5">{{ $siswa->status_keuangan ?? 'Belum Lunas' }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div id="content-galeri" class="hidden">
                            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                                <div class="flex justify-between items-center mb-4">
                                    ...
                                    <a href="{{ route('admin.galeri.index') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium shadow-sm transition-all flex items-center">
                                        <i class="fas fa-images mr-2"></i> Kelola Galeri Utama
                                    </a>
                                </div>
                                @if(isset($siswa->galeri) && count($siswa->galeri) > 0)
                                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                        @foreach($siswa->galeri as $foto)
                                            <div class="relative group border rounded-lg overflow-hidden bg-gray-50">
                                                <img src="{{ asset('storage/' . $foto->path) }}" alt="Foto Galeri" class="w-full h-40 object-cover">
                                                <div class="absolute inset-0 bg-black bg-opacity-30 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity">
                                                    <a href="{{ asset('storage/' . $foto->path) }}" target="_blank" class="text-white bg-blue-600 px-3 py-1 rounded shadow hover:bg-blue-700 text-xs font-medium mr-2"><i class="fas fa-search"></i> Lihat</a>
