...
@section('title', 'Detail Kelas - SMK PGRI CIKAMPEK')

@section('main-content')
<div class="w-full px-3 py-4">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800 mb-3                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        {{ $jadwal->mapel->nama ?? 'Tidak ada' }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        {{ $jadwal->guru->nama ?? 'Belum ditentukan' }}
                                    </td>il Kelas {{ $kelas->nama_kelas }}</h1>
                ...
                <div class="p-6">
                    <div class="flex flex-col space-y-4">
                        <div class="flex flex-col space-y-1">
                            ...
                            <span class="text-lg font-semibold">{{ $kelas->nama_kelas }}</span>
                        </div>
                        
                        <div class="flex flex-col space-y-1">
                            <span class="text-sm text-gray-500">Jurusan</span>
                            <span class="font-medium">{{ $kelas->jurusan->nama_jurusan ?? 'Belum ditentukan' }}</span>
                        </div>
                          <div class="flex flex-col space-y-1">
                            <span class="text-sm text-gray-500">Tingkat</span>
                            <span class="font-medium">
                                @if($kelas->tingkat == 1 || $kelas->tingkat == 10)
                                    Kelas X (Sepuluh)
                                @elseif($kelas->tingkat == 2 || $kelas->tingkat == 11)
                                    Kelas XI (Sebelas)
                                @elseif($kelas->tingkat == 3 || $kelas->tingkat == 12)
                                    Kelas XII (Dua Belas)
                                @else
                                    -
                                @endif
                        ...
                        <div class="flex flex-col space-y-1">
                            ...
                            <span class="font-medium">{{ $kelas->wali->nama ?? 'Belum ditentukan' }}</span>
                        </div>
                        
                        <div class="flex flex-col space-y-1">
                            <span class="text-sm text-gray-500">Tahun Ajaran</span>
                            <span class="font-medium">{{ $kelas->tahun_ajaran }}</span>
                        </div>
                    ...
                    <div class="mt-6 flex justify-between">
                        <a href="{{ route('admin.kelas.edit', $kelas->id) }}" class="inline-flex items-center px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white text-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                        <div class="bg-blue-50 rounded-lg p-4 text-center">
                            <span class="text-2xl font-bold text-blue-600">{{ $totalSiswa }}</span>
                            <p class="text-sm text-gray-600">Total Siswa</p>
                        </div>
                        
                        <div class="bg-blue-50 rounded-lg p-4 text-center">
                            <span class="text-2xl font-bold text-blue-600">{{ $siswaLaki }}</span>
                            <p class="text-sm text-gray-600">Laki-laki</p>
                        </div>
                        
                        <div class="bg-blue-50 rounded-lg p-4 text-center">
                            <span class="text-2xl font-bold text-blue-600">{{ $siswaPerempuan }}</span>
        ...
        <div class="lg:w-2/3 w-full">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="p-4 border-b border-gray-100 bg-blue-500 text-white flex justify-between items-center">
                    ...
                    <a href="{{ route('admin.siswa.create', ['kelas_id' => $kelas->id]) }}" class="bg-white text-blue-500 hover:bg-gray-100 text-sm px-3 py-1 rounded-md">
                ...
                <div class="p-4">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm">
                                        <a href="{{ route('admin.siswa.show', $siswa->id) }}" class="text-blue-500 hover:text-blue-700 mr-3">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.siswa.edit', $siswa->id) }}" class="text-yellow-500 hover:text-yellow-700">
                    ...
                    <div class="text-center py-6">
                        ...
                        <div class="mt-6">
                            <a href="{{ route('admin.siswa.create', ['kelas_id' => $kelas->id]) }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mt-6">
                <div class="p-4 border-b border-gray-100 bg-blue-500 text-white flex justify-between items-center">
                    ...
                    <a href="{{ route('admin.jadwal.create', ['kelas_id' => $kelas->id]) }}" class="bg-white text-blue-500 hover:bg-gray-100 text-sm px-3 py-1 rounded-md">
                ...
                <div class="p-4">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($kelas->jadwal->sortBy('hari')->sortBy('jam_mulai') as $jadwal)
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">                                        {{ $jadwal->hari }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    ...
                    <div class="text-center py-6">
                        ...
                        <div class="mt-6">
                            <a href="{{ route('admin.jadwal.create', ['kelas_id' => $kelas->id]) }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                <i class="fas fa-plus-circle mr-2"></i>
                                Tambah Jadwal Baru
                            </a>
                        </div>
