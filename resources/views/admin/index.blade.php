                    ...
                    <div class="bg-white p-5 rounded-xl shadow-sm border-l-4 border-purple-500 hover:shadow-md transition-all group overflow-hidden relative">
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-purple-700 mt-3">{{ $totalKelas }}</p>
                                @php
                                ...
                                @endphp
                                <p class="text-{{ $classGrowth >= 0 ? 'purple' : 'red' }}-600 text-xs flex items-center mt-2 font-semibold">
                                    <i class="fas fa-arrow-{{ $classGrowth >= 0 ? 'up' : 'down' }} mr-1"></i> 
                                    {{ number_format(abs($classGrowth), 1) }}% dari tahun lalu
                                </p>
                            </div>
                            <div class="flex items-end h-full self-end">
                    ...
                    <div class="bg-white p-5 rounded-xl shadow-sm border-l-4 border-teal-500 hover:shadow-md transition-all group overflow-hidden relative">
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                @endphp
                                <p class="text-3xl font-bold text-teal-700 mt-3">{{ $totalJadwalAktif }}</p>
                                <p class="text-{{ $jadwalGrowth >= 0 ? 'teal' : 'red' }}-600 text-xs flex items-center mt-2 font-semibold">
                                    <i class="fas fa-arrow-{{ $jadwalGrowth >= 0 ? 'up' : 'down' }} mr-1"></i> 
                                    {{ number_format(abs($jadwalGrowth), 1) }}% dari semester lalu
                                </p>
                            </div>
                            <div class="flex items-end h-full self-end">
                                <div class="space-y-1 flex h-16 items-end space-x-1">
                    ...
                    <div class="relative z-10 admin-card-body">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start space-x-3 p-3.5 hover:bg-gray-50 rounded-xl transition-colors border border-transparent hover:border-gray-200 group">
                                <div class="h-14 w-14 bg-gradient-to-br from-{{ $item['color'] }}-100 to-{{ $item['color'] }}-200 rounded-xl flex items-center justify-center text-{{ $item['color'] }}-600 flex-shrink-0 group-hover:scale-110 transition-transform shadow-sm">
                                    <i class="fas fa-{{ $item['icon'] }} text-lg"></i>
                                </div>
                                <div class="flex-1">
                                    <div class="flex justify-between items-start">
                                        <p class="font-medium text-gray-800">{{ $item['title'] }}</p>
                                        <span class="text-xs text-white px-2 py-1 bg-gradient-to-r from-{{ $item['color'] }}-500 to-{{ $item['color'] }}-600 rounded-full shadow-sm">{{ $item['time'] }}</span>
                                    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        <div class="p-6 border-b border-gray-200">
            <div class="flex justify-between items-center">
                ...
                <a href="{{ route('admin.agenda.index') }}" class="text-sm text-blue-600 hover:text-blue-500 flex items-center">
                    Lihat Semua
        ...
        <div class="bg-white divide-y divide-gray-200">
            ...
            <div class="p-6 hover:bg-gray-50 transition-colors">
                <div class="flex items-center justify-between">
                    ...
                    <div class="ml-4">
                        <a href="{{ route('admin.agenda.edit', $item->id) }}" class="text-gray-400 hover:text-blue-500">
            ...
            <div class="p-6 text-center text-gray-500">
                ...
                <a href="{{ route('admin.agenda.create') }}" class="inline-flex items-center mt-2 text-sm text-blue-600 hover:text-blue-500">
