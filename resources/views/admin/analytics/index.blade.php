...
@section('title', 'Analytics - SMK PGRI CIKAMPEK')
            ...
            <div class="relative z-10">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold mt-1">{{ $stats['total_classes'] }}</h3>
                        <div class="flex items-center mt-2 text-xs text-emerald-100">
                            <i class="fas fa-users mr-1"></i>
                            <span>{{ round($stats['total_students'] / ($stats['total_classes'] ?: 1)) }} siswa/kelas rata-rata</span>
                        </div>
                    </div>
            ...
            <div class="relative z-10">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold mt-1">{{ $stats['total_announcements'] }}</h3>
            ...
            <div class="relative z-10">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold mt-1">{{ $attendanceData['today']['attendance_rate'] }}%</h3>
                        <div class="flex items-center mt-2 text-xs text-amber-100">
                            <i class="fas fa-user-check mr-1"></i>
                            <span>{{ $attendanceData['today']['hadir'] }} hadir hari ini</span>
                        </div>
                    </div>
                    <div class="bg-white/20 p-2 rounded-lg">
                    ...
                    <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex justify-between font-medium text-sm">
                                ...
                                <span class="text-blue-600">{{ $attendanceData['today']['total'] }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-4">
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between text-sm items-center">
                                <span class="text-gray-600">Hadir</span>
                                <span class="font-medium px-2 py-0.5 bg-green-100 text-green-700 rounded">
                                    {{ $attendanceData['week']['hadir'] }}
                                </span>
                            </div>
                            <div class="flex justify-between text-sm items-center">
                                <span class="text-gray-600">Izin</span>
                                <span class="font-medium px-2 py-0.5 bg-blue-100 text-blue-700 rounded">
                                    {{ $attendanceData['week']['izin'] }}
                                </span>
                            </div>
                            <div class="flex justify-between text-sm items-center">
                                <span class="text-gray-600">Sakit</span>
                                <span class="font-medium px-2 py-0.5 bg-yellow-100 text-yellow-700 rounded">
                                    {{ $attendanceData['week']['sakit'] }}
                                </span>
                            </div>
                            <div class="flex justify-between text-sm items-center">
                                <span class="text-gray-600">Alpha</span>
                                <span class="font-medium px-2 py-0.5 bg-red-100 text-red-700 rounded">
                                    {{ $attendanceData['week']['alpha'] }}
                                </span>
                            </div>
                            <div class="h-px bg-green-100 my-2"></div>
                            <div class="flex justify-between font-medium text-sm">
                                <span class="text-gray-800">Total Minggu Ini</span>
                                <span class="text-emerald-600">{{ $attendanceData['week']['total'] }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-gray-800">{{ $stats['attendance_today'] }} siswa</p>
                        </div>
                    </div>
                    <div class="text-right">
                        <p class="text-sm text-gray-500">Persentase</p>
                        <p class="font-semibold text-green-600">{{ $stats['attendance_rate'] }}%</p>
                    </div>
                </div>
    ...
    new Chart(monthlyTrendsCtx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: @json($monthlyTrends['registrations']),
                borderColor: '#3b82f6',
                ...
                label: 'Pengumuman',
                data: @json($monthlyTrends['announcements']),
                borderColor: '#8b5cf6',
