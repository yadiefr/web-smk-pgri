        ...
        <div class="text-sm breadcrumbs">
            <ul class="flex items-center space-x-2 text-gray-500">
                ...
                <li class="flex items-center space-x-2">
                    ...
                    <a href="{{ route('admin.absensi.index') }}" class="hover:text-blue-600">Kehadiran</a>
                </li>
                <li class="flex items-center space-x-2">
                    <span class="text-gray-400">/</span>
                    <span>Detail</span>
                ...
                <div>
                    ...
                    <dl class="space-y-2">
                        <div class="flex">
                            ...
                            <dd class="flex-1 text-gray-900">{{ $absensi->first()->siswa->kelas->nama_kelas }}</dd>
                        </div>
                        <div class="flex">
                            <dt class="w-32 text-gray-500">Mata Pelajaran</dt>
                            <dd class="flex-1 text-gray-900">{{ $absensi->first()->mapel ? $absensi->first()->mapel->nama : '-' }}</dd>
                        </div>
                        <div class="flex">
                            <dt class="w-32 text-gray-500">Guru</dt>
                            <dd class="flex-1 text-gray-900">{{ $absensi->first()->guru->name }}</dd>
                        </div>
                    </dl>
                </div>
                <div>
                    ...
                    <dl class="space-y-2">
                        <div class="flex">
                            ...
                            <dd class="flex-1 text-gray-900">{{ $absensi->first()->tanggal->format('d F Y') }}</dd>
                        </div>
                        <div class="flex">
                            <dt class="w-32 text-gray-500">Jumlah Siswa</dt>
                            <dd class="flex-1 text-gray-900">{{ $absensi->count() }} Siswa</dd>
                        </div>
                    </dl>
                </div>
            </div>
                ...
                <div class="bg-green-50 rounded-lg p-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-green-800">{{ $stats['hadir'] }}</p>
                        </div>
                    </div>
                </div>
                <div class="bg-yellow-50 rounded-lg p-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-yellow-800">{{ $stats['izin'] }}</p>
                        </div>
                    </div>
                </div>
                <div class="bg-orange-50 rounded-lg p-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-orange-800">{{ $stats['sakit'] }}</p>
                        </div>
                    </div>
                </div>
                <div class="bg-red-50 rounded-lg p-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-red-800">{{ $stats['alpha'] }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{ $data->siswa->name }}</div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm">
                            <a href="{{ route('admin.absensi.edit', $data->id) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">
